...
<?php if ($m_smp_delete->createby->Visible) { // createby ?>
		<th class="<?php echo $m_smp_delete->createby->headerCellClass() ?>"><span id="elh_m_smp_createby" class="m_smp_createby"><?php echo $m_smp_delete->createby->caption() ?></span></th>
<?php } ?>
...
<?php if ($m_smp_delete->createby->Visible) { // createby ?>
		<td <?php echo $m_smp_delete->createby->cellAttributes() ?>>
<span id="el<?php echo $m_smp_delete->RowCount ?>_m_smp_createby" class="m_smp_createby">
<span<?php echo $m_smp_delete->createby->viewAttributes() ?>><?php echo $m_smp_delete->createby->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($m_smp_delete->tahun->Visible) { // tahun ?>
