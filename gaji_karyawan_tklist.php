...
<?php if ($gaji_karyawan_tk_list->pegawai->Visible) { // pegawai ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_tk_list->jenjang_id->Visible) { // jenjang_id ?>
	<?php if ($gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->jenjang_id) == "") { ?>
		<th data-name="jenjang_id" class="<?php echo $gaji_karyawan_tk_list->jenjang_id->headerCellClass() ?>"><div id="elh_gaji_karyawan_tk_jenjang_id" class="gaji_karyawan_tk_jenjang_id"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->jenjang_id->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jenjang_id" class="<?php echo $gaji_karyawan_tk_list->jenjang_id->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->jenjang_id) ?>', 1);"><div id="elh_gaji_karyawan_tk_jenjang_id" class="gaji_karyawan_tk_jenjang_id">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->jenjang_id->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_tk_list->jenjang_id->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_tk_list->jenjang_id->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_tk_list->jabatan_id->Visible) { // jabatan_id ?>
	<?php if ($gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->jabatan_id) == "") { ?>
		<th data-name="jabatan_id" class="<?php echo $gaji_karyawan_tk_list->jabatan_id->headerCellClass() ?>"><div id="elh_gaji_karyawan_tk_jabatan_id" class="gaji_karyawan_tk_jabatan_id"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->jabatan_id->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jabatan_id" class="<?php echo $gaji_karyawan_tk_list->jabatan_id->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->jabatan_id) ?>', 1);"><div id="elh_gaji_karyawan_tk_jabatan_id" class="gaji_karyawan_tk_jabatan_id">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->jabatan_id->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_tk_list->jabatan_id->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_tk_list->jabatan_id->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_tk_list->kehadiran->Visible) { // kehadiran ?>
	<?php if ($gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->kehadiran) == "") { ?>
		<th data-name="kehadiran" class="<?php echo $gaji_karyawan_tk_list->kehadiran->headerCellClass() ?>"><div id="elh_gaji_karyawan_tk_kehadiran" class="gaji_karyawan_tk_kehadiran"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->kehadiran->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="kehadiran" class="<?php echo $gaji_karyawan_tk_list->kehadiran->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->kehadiran) ?>', 1);"><div id="elh_gaji_karyawan_tk_kehadiran" class="gaji_karyawan_tk_kehadiran">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->kehadiran->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_tk_list->kehadiran->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_tk_list->kehadiran->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_tk_list->gapok->Visible) { // gapok ?>
	<?php if ($gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->gapok) == "") { ?>
		<th data-name="gapok" class="<?php echo $gaji_karyawan_tk_list->gapok->headerCellClass() ?>"><div id="elh_gaji_karyawan_tk_gapok" class="gaji_karyawan_tk_gapok"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->gapok->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="gapok" class="<?php echo $gaji_karyawan_tk_list->gapok->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->gapok) ?>', 1);"><div id="elh_gaji_karyawan_tk_gapok" class="gaji_karyawan_tk_gapok">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->gapok->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_tk_list->gapok->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_tk_list->gapok->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_tk_list->value_reward->Visible) { // value_reward ?>
	<?php if ($gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->value_reward) == "") { ?>
		<th data-name="value_reward" class="<?php echo $gaji_karyawan_tk_list->value_reward->headerCellClass() ?>"><div id="elh_gaji_karyawan_tk_value_reward" class="gaji_karyawan_tk_value_reward"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->value_reward->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="value_reward" class="<?php echo $gaji_karyawan_tk_list->value_reward->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->value_reward) ?>', 1);"><div id="elh_gaji_karyawan_tk_value_reward" class="gaji_karyawan_tk_value_reward">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->value_reward->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_tk_list->value_reward->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_tk_list->value_reward->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_tk_list->value_inval->Visible) { // value_inval ?>
	<?php if ($gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->value_inval) == "") { ?>
		<th data-name="value_inval" class="<?php echo $gaji_karyawan_tk_list->value_inval->headerCellClass() ?>"><div id="elh_gaji_karyawan_tk_value_inval" class="gaji_karyawan_tk_value_inval"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->value_inval->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="value_inval" class="<?php echo $gaji_karyawan_tk_list->value_inval->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->value_inval) ?>', 1);"><div id="elh_gaji_karyawan_tk_value_inval" class="gaji_karyawan_tk_value_inval">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->value_inval->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_tk_list->value_inval->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_tk_list->value_inval->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($gaji_karyawan_tk_list->total->Visible) { // total ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_tk_list->jp->Visible) { // jp ?>
	<?php if ($gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->jp) == "") { ?>
		<th data-name="jp" class="<?php echo $gaji_karyawan_tk_list->jp->headerCellClass() ?>"><div id="elh_gaji_karyawan_tk_jp" class="gaji_karyawan_tk_jp"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->jp->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jp" class="<?php echo $gaji_karyawan_tk_list->jp->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $gaji_karyawan_tk_list->SortUrl($gaji_karyawan_tk_list->jp) ?>', 1);"><div id="elh_gaji_karyawan_tk_jp" class="gaji_karyawan_tk_jp">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_tk_list->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_tk_list->jp->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_tk_list->jp->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php
...
<span<?php echo $gaji_karyawan_tk_list->pegawai->viewAttributes() ?>><?php echo $gaji_karyawan_tk_list->pegawai->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gaji_karyawan_tk_list->jenjang_id->Visible) { // jenjang_id ?>
		<td data-name="jenjang_id" <?php echo $gaji_karyawan_tk_list->jenjang_id->cellAttributes() ?>>
<span id="el<?php echo $gaji_karyawan_tk_list->RowCount ?>_gaji_karyawan_tk_jenjang_id">
<span<?php echo $gaji_karyawan_tk_list->jenjang_id->viewAttributes() ?>><?php echo $gaji_karyawan_tk_list->jenjang_id->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_tk_list->jabatan_id->Visible) { // jabatan_id ?>
		<td data-name="jabatan_id" <?php echo $gaji_karyawan_tk_list->jabatan_id->cellAttributes() ?>>
<span id="el<?php echo $gaji_karyawan_tk_list->RowCount ?>_gaji_karyawan_tk_jabatan_id">
<span<?php echo $gaji_karyawan_tk_list->jabatan_id->viewAttributes() ?>><?php echo $gaji_karyawan_tk_list->jabatan_id->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_tk_list->kehadiran->Visible) { // kehadiran ?>
		<td data-name="kehadiran" <?php echo $gaji_karyawan_tk_list->kehadiran->cellAttributes() ?>>
<span id="el<?php echo $gaji_karyawan_tk_list->RowCount ?>_gaji_karyawan_tk_kehadiran">
<span<?php echo $gaji_karyawan_tk_list->kehadiran->viewAttributes() ?>><?php echo $gaji_karyawan_tk_list->kehadiran->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_tk_list->gapok->Visible) { // gapok ?>
		<td data-name="gapok" <?php echo $gaji_karyawan_tk_list->gapok->cellAttributes() ?>>
<span id="el<?php echo $gaji_karyawan_tk_list->RowCount ?>_gaji_karyawan_tk_gapok">
<span<?php echo $gaji_karyawan_tk_list->gapok->viewAttributes() ?>><?php echo $gaji_karyawan_tk_list->gapok->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_tk_list->value_reward->Visible) { // value_reward ?>
		<td data-name="value_reward" <?php echo $gaji_karyawan_tk_list->value_reward->cellAttributes() ?>>
<span id="el<?php echo $gaji_karyawan_tk_list->RowCount ?>_gaji_karyawan_tk_value_reward">
<span<?php echo $gaji_karyawan_tk_list->value_reward->viewAttributes() ?>><?php echo $gaji_karyawan_tk_list->value_reward->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_tk_list->value_inval->Visible) { // value_inval ?>
		<td data-name="value_inval" <?php echo $gaji_karyawan_tk_list->value_inval->cellAttributes() ?>>
<span id="el<?php echo $gaji_karyawan_tk_list->RowCount ?>_gaji_karyawan_tk_value_inval">
<span<?php echo $gaji_karyawan_tk_list->value_inval->viewAttributes() ?>><?php echo $gaji_karyawan_tk_list->value_inval->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_tk_list->sub_total->Visible) { // sub_total ?>
...
<span<?php echo $gaji_karyawan_tk_list->total->viewAttributes() ?>><?php echo $gaji_karyawan_tk_list->total->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($gaji_karyawan_tk_list->jp->Visible) { // jp ?>
		<td data-name="jp" <?php echo $gaji_karyawan_tk_list->jp->cellAttributes() ?>>
<span id="el<?php echo $gaji_karyawan_tk_list->RowCount ?>_gaji_karyawan_tk_jp">
<span<?php echo $gaji_karyawan_tk_list->jp->viewAttributes() ?>><?php echo $gaji_karyawan_tk_list->jp->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
<?php
