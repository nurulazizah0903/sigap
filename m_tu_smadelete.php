...
<?php if ($m_tu_sma_delete->createby->Visible) { // createby ?>
		<th class="<?php echo $m_tu_sma_delete->createby->headerCellClass() ?>"><span id="elh_m_tu_sma_createby" class="m_tu_sma_createby"><?php echo $m_tu_sma_delete->createby->caption() ?></span></th>
<?php } ?>
...
<?php if ($m_tu_sma_delete->createby->Visible) { // createby ?>
		<td <?php echo $m_tu_sma_delete->createby->cellAttributes() ?>>
<span id="el<?php echo $m_tu_sma_delete->RowCount ?>_m_tu_sma_createby" class="m_tu_sma_createby">
<span<?php echo $m_tu_sma_delete->createby->viewAttributes() ?>><?php echo $m_tu_sma_delete->createby->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($m_tu_sma_delete->tahun->Visible) { // tahun ?>
