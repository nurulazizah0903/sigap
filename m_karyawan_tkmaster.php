...
<table id="tbl_m_karyawan_tkmaster" class="table ew-view-table ew-master-table ew-vertical">
	<tbody>
<?php if ($m_karyawan_tk->createby->Visible) { // createby ?>
		<tr id="r_createby">
			<td class="<?php echo $m_karyawan_tk->TableLeftColumnClass ?>"><?php echo $m_karyawan_tk->createby->caption() ?></td>
			<td <?php echo $m_karyawan_tk->createby->cellAttributes() ?>>
<span id="el_m_karyawan_tk_createby">
<span<?php echo $m_karyawan_tk->createby->viewAttributes() ?>><?php echo $m_karyawan_tk->createby->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
