		...
		if (($master = Get(Config("TABLE_SHOW_MASTER"), Get(Config("TABLE_MASTER")))) !== NULL) {
			...
			if ($masterTblVar == "berita") {
				...
				if (($parm = Get("fk_id", Get("pid"))) !== NULL) {
					$GLOBALS["berita"]->id->setQueryStringValue($parm);
					$this->pid->setQueryStringValue($GLOBALS["berita"]->id->QueryStringValue);
					$this->pid->setSessionValue($this->pid->QueryStringValue);
					if (!is_numeric($GLOBALS["berita"]->id->QueryStringValue))
						$validMaster = FALSE;
				} else {
					$validMaster = FALSE;
				}
			...
			if ($masterTblVar == "berita") {
				...
				if (($parm = Post("fk_id", Post("pid"))) !== NULL) {
					$GLOBALS["berita"]->id->setFormValue($parm);
					$this->pid->setFormValue($GLOBALS["berita"]->id->FormValue);
					$this->pid->setSessionValue($this->pid->FormValue);
					if (!is_numeric($GLOBALS["berita"]->id->FormValue))
						$validMaster = FALSE;
				} else {
					$validMaster = FALSE;
				}
