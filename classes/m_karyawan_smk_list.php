...
class m_karyawan_smk_list extends m_karyawan_smk
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_karyawan_smk')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_karyawan_smklist.php?" . Config("TABLE_SHOW_MASTER") . "=m_karyawan_smk&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_karyawan_smk_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_karyawan_smk')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_karyawan_smk");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_karyawan_smk";
			}
			if ($GLOBALS["gaji_karyawan_smk_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_karyawan_smk')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_karyawan_smk");
				...
				if ($detailCopyTblVar != "")
					$detailCopyTblVar .= ",";
				$detailCopyTblVar .= "gaji_karyawan_smk";
			}
			if ($links != "") {
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_karyawan_smk");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_karyawan_smk");
		if (!isset($GLOBALS["gaji_karyawan_smk"]))
			$GLOBALS["gaji_karyawan_smk"] = new gaji_karyawan_smk();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_karyawan_smk"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_karyawan_smk"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_karyawan_smk') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_karyawan_smk"] && $this->DetailPages["gaji_karyawan_smk"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_karyawan_smk')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_karyawan_smklist.php?" . Config("TABLE_SHOW_MASTER") . "=m_karyawan_smk&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
