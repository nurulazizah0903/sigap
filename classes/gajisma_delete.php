 ...
 * Page class
 */
class gajisma_delete extends gajisma
{
	...
	// Page object name
	public $PageObjName = "gajisma_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajismalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajismalist.php"); // Return to list
			}
		}
	}
