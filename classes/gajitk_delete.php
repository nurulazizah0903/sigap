 ...
 * Page class
 */
class gajitk_delete extends gajitk
{
	...
	// Page object name
	public $PageObjName = "gajitk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajitklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajitklist.php"); // Return to list
			}
		}
	}
