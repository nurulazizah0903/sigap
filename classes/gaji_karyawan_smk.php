...
class gaji_karyawan_smk extends DbTable
{
	...
	public function __construct()
	{
		...
		// datetime
		$this->datetime = new DbField('gaji_karyawan_smk', 'gaji_karyawan_smk', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// by
		$this->by = new DbField('gaji_karyawan_smk', 'gaji_karyawan_smk', 'x_by', 'by', '`by`', '`by`', 3, 11, -1, FALSE, '`by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// month
		$this->month = new DbField('gaji_karyawan_smk', 'gaji_karyawan_smk', 'x_month', 'month', '`month`', CastDateFieldForLike("`month`", 0, "DB"), 133, 10, 0, FALSE, '`month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jp
		$this->jp = new DbField('gaji_karyawan_smk', 'gaji_karyawan_smk', 'x_jp', 'jp', '`jp`', '`jp`', 3, 11, -1, FALSE, '`jp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function Row_Rendering() {
		...
		// Enter your code here
	//if (CurrentPage()->IsGridEdit() && $this-><Dropdown-Field>->CurrentValue !== "conditional value"){
	//$this-><text-field>->EditAttrs["disabled"] = "disabled";
