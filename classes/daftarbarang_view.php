 ...
 * Page class
 */
class daftarbarang_view extends daftarbarang
{
	...
	// Page object name
	public $PageObjName = "daftarbarang_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "daftarbaranglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "daftarbaranglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "daftarbaranglist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
