 ...
 * Page class
 */
class penempatan_view extends penempatan
{
	...
	// Page object name
	public $PageObjName = "penempatan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "penempatanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "penempatanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "penempatanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
