 ...
 * Page class
 */
class jenis_barang_view extends jenis_barang
{
	...
	// Page object name
	public $PageObjName = "jenis_barang_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("jenis_baranglist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "jenis_baranglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "jenis_baranglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "jenis_baranglist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jenis_baranglist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
