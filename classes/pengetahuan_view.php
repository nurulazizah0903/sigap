 ...
 * Page class
 */
class pengetahuan_view extends pengetahuan
{
	...
	// Page object name
	public $PageObjName = "pengetahuan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "pengetahuanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "pengetahuanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "pengetahuanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
