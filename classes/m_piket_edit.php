 ...
 * Page class
 */
class m_piket_edit extends m_piket
{
	...
	// Page object name
	public $PageObjName = "m_piket_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// jenis_sertif
			$this->jenis_sertif->setDbValueDef($rsnew, $this->jenis_sertif->CurrentValue, NULL, $this->jenis_sertif->ReadOnly);
