...
class m_tu_sd_delete extends m_tu_sd
{
	...
	protected function deleteRows()
	{
		...
		// Check if records exist for detail table 'gaji_tu_sd'
		if (!isset($GLOBALS["gaji_tu_sd"]))
			$GLOBALS["gaji_tu_sd"] = new gaji_tu_sd();
		foreach ($rows as $row) {
			$rsdetail = $GLOBALS["gaji_tu_sd"]->loadRs("`pid` = " . QuotedValue($row['id'], DATATYPE_NUMBER, 'DB'));
			if ($rsdetail && !$rsdetail->EOF) {
				$relatedRecordMsg = str_replace("%t", "gaji_tu_sd", $Language->phrase("RelatedRecordExists"));
