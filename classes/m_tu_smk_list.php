...
class m_tu_smk_list extends m_tu_smk
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_tu_smk')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_tu_smklist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tu_smk&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_tu_smk_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_tu_smk')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_smk");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_tu_smk";
			}
			if ($GLOBALS["gaji_tu_smk_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_tu_smk')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_smk");
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_tu_smk");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_smk");
		if (!isset($GLOBALS["gaji_tu_smk"]))
			$GLOBALS["gaji_tu_smk"] = new gaji_tu_smk();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_tu_smk"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_tu_smk"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_tu_smk') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_tu_smk"] && $this->DetailPages["gaji_tu_smk"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_tu_smk')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_tu_smklist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tu_smk&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
