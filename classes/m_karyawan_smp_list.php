...
class m_karyawan_smp_list extends m_karyawan_smp
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_karyawan_smp')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_karyawan_smplist.php?" . Config("TABLE_SHOW_MASTER") . "=m_karyawan_smp&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_karyawan_smp_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_karyawan_smp')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_karyawan_smp");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_karyawan_smp";
			}
			if ($GLOBALS["gaji_karyawan_smp_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_karyawan_smp')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_karyawan_smp");
				...
				if ($detailCopyTblVar != "")
					$detailCopyTblVar .= ",";
				$detailCopyTblVar .= "gaji_karyawan_smp";
			}
			if ($links != "") {
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_karyawan_smp");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_karyawan_smp");
		if (!isset($GLOBALS["gaji_karyawan_smp"]))
			$GLOBALS["gaji_karyawan_smp"] = new gaji_karyawan_smp();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_karyawan_smp"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_karyawan_smp"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_karyawan_smp') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_karyawan_smp"] && $this->DetailPages["gaji_karyawan_smp"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_karyawan_smp')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_karyawan_smplist.php?" . Config("TABLE_SHOW_MASTER") . "=m_karyawan_smp&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
