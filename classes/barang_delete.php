 ...
 * Page class
 */
class barang_delete extends barang
{
	...
	// Page object name
	public $PageObjName = "barang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("baranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("baranglist.php"); // Return to list
			}
		}
	}
