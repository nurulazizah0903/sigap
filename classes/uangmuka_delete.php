 ...
 * Page class
 */
class uangmuka_delete extends uangmuka
{
	...
	// Page object name
	public $PageObjName = "uangmuka_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("uangmukalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("uangmukalist.php"); // Return to list
			}
		}
	}
