 ...
 * Page class
 */
class barang_view extends barang
{
	...
	// Page object name
	public $PageObjName = "barang_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("Kode_Barang") !== NULL) {
				...
				$returnUrl = "baranglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "baranglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "baranglist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
