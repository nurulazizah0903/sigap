 ...
 * Page class
 */
class gajismp_delete extends gajismp
{
	...
	// Page object name
	public $PageObjName = "gajismp_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajismplist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajismplist.php"); // Return to list
			}
		}
	}
