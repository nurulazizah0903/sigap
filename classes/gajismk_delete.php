 ...
 * Page class
 */
class gajismk_delete extends gajismk
{
	...
	// Page object name
	public $PageObjName = "gajismk_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajismklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajismklist.php"); // Return to list
			}
		}
	}
