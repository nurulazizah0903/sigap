 ...
 * Page class
 */
class tambahan_tugas_view extends tambahan_tugas
{
	...
	// Page object name
	public $PageObjName = "tambahan_tugas_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("tambahan_tugaslist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tambahan_tugaslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tambahan_tugaslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tambahan_tugaslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("tambahan_tugaslist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
