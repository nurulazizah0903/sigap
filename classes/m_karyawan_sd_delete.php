...
class m_karyawan_sd_delete extends m_karyawan_sd
{
	...
	protected function deleteRows()
	{
		...
		// Check if records exist for detail table 'gaji_karyawan_sd'
		if (!isset($GLOBALS["gaji_karyawan_sd"]))
			$GLOBALS["gaji_karyawan_sd"] = new gaji_karyawan_sd();
		foreach ($rows as $row) {
			$rsdetail = $GLOBALS["gaji_karyawan_sd"]->loadRs("`pid` = " . QuotedValue($row['id'], DATATYPE_NUMBER, 'DB'));
			if ($rsdetail && !$rsdetail->EOF) {
				$relatedRecordMsg = str_replace("%t", "gaji_karyawan_sd", $Language->phrase("RelatedRecordExists"));
