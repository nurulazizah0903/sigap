...
class m_smp_list extends m_smp
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_smp')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_smplist.php?" . Config("TABLE_SHOW_MASTER") . "=m_smp&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_smp_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_smp')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_smp");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_smp";
			}
			if ($GLOBALS["gaji_smp_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_smp')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_smp");
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_smp");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_smp");
		if (!isset($GLOBALS["gaji_smp"]))
			$GLOBALS["gaji_smp"] = new gaji_smp();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_smp"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_smp"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_smp') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_smp"] && $this->DetailPages["gaji_smp"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_smp')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_smplist.php?" . Config("TABLE_SHOW_MASTER") . "=m_smp&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
