 ...
 * Page class
 */
class dinasluar_view extends dinasluar
{
	...
	// Page object name
	public $PageObjName = "dinasluar_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "dinasluarlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "dinasluarlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "dinasluarlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
