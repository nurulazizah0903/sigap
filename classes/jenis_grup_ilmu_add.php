 ...
 * Page class
 */
class jenis_grup_ilmu_add extends jenis_grup_ilmu
{
	...
	// Page object name
	public $PageObjName = "jenis_grup_ilmu_add";
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("jenis_grup_ilmulist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "jenis_grup_ilmulist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "jenis_grup_ilmuview.php")
