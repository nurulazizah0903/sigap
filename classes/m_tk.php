...
class m_tk extends DbTable
{
	...
	public function __construct()
	{
		...
		// tahun
		$this->tahun = new DbField('m_tk', 'm_tk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 2, 5, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function update(&$rs, $where = "", $rsold = NULL, $curfilter = TRUE)
	{
		...
		if ($cascadeUpdate) {
			...
			$rswrk = $GLOBALS["gaji_tk"]->loadRs("`pid` = " . QuotedValue($rsold['id'], DATATYPE_NUMBER, 'DB'));
