...
class m_tu_sma_list extends m_tu_sma
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_tu_sma')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_tu_smalist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tu_sma&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_tu_sma_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_tu_sma')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_sma");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_tu_sma";
			}
			if ($GLOBALS["gaji_tu_sma_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_tu_sma')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_sma");
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_tu_sma");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_sma");
		if (!isset($GLOBALS["gaji_tu_sma"]))
			$GLOBALS["gaji_tu_sma"] = new gaji_tu_sma();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_tu_sma"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_tu_sma"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_tu_sma') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_tu_sma"] && $this->DetailPages["gaji_tu_sma"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_tu_sma')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_tu_smalist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tu_sma&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
