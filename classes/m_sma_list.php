...
class m_sma_list extends m_sma
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_sma')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_smalist.php?" . Config("TABLE_SHOW_MASTER") . "=m_sma&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_sma_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_sma')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_sma");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_sma";
			}
			if ($GLOBALS["gaji_sma_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_sma')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_sma");
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_sma");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_sma");
		if (!isset($GLOBALS["gaji_sma"]))
			$GLOBALS["gaji_sma"] = new gaji_sma();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_sma"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_sma"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_sma') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_sma"] && $this->DetailPages["gaji_sma"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_sma')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_smalist.php?" . Config("TABLE_SHOW_MASTER") . "=m_sma&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
