 ...
 * Page class
 */
class tpendidikan_view extends tpendidikan
{
	...
	// Page object name
	public $PageObjName = "tpendidikan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tpendidikanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tpendidikanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tpendidikanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
