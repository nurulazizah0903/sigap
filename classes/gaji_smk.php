...
class gaji_smk extends DbTable
{
	...
	public function __construct()
	{
		...
		// by
		$this->by = new DbField('gaji_smk', 'gaji_smk', 'x_by', 'by', '`by`', '`by`', 3, 11, -1, FALSE, '`by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$querypotongan = ExecuteRow("SELECT * FROM potongan_smk ORDER BY id DESC");
									...
									$kehadiran= ExecuteRow("Select * from m_kehadiran where jenjang='4' AND jenis_jabatan='1' AND sertif='1'");	
													...
													if ($this->tambahan->CurrentValue == '2'){
														$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='5' AND kualifikasi='2'");
													}else if ($this->tambahan->CurrentValue == '3'){
														$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='5' AND kualifikasi='3'");		
													}else if ($this->tambahan->CurrentValue == '4'){
														$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='5' AND kualifikasi='4'");	
													}else if ($this->tambahan->CurrentValue == '5'){
														$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='5' AND kualifikasi='5'");	
													}else if ($this->tambahan->CurrentValue == '6'){
														$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='5' AND kualifikasi='6'");
													}
													if($this->jabatan_id->CurrentValue == '5'){
														if ($this->periode->CurrentValue == '1'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='1'");
														}else if ($this->periode->CurrentValue == '2'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='2'");		
														}else if ($this->periode->CurrentValue == '3'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='3'");	
														}else if ($this->periode->CurrentValue == '4'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='4'");	
														}else if ($this->periode->CurrentValue == '5'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='5'");
														}else if ($this->periode->CurrentValue == '6'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='6'");
														}else if ($this->periode->CurrentValue == '7'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='7'");
														}else if ($this->periode->CurrentValue == '8'){
															$tunjanagan_tambahan=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='8'");
														}else if ($this->periode->CurrentValue == '9'){
															$tunjanagan_tambahan=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='9'");
														}else if ($this->periode->CurrentValue == '10'){
															$tunjanagan_tambahan=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='5' AND lama='10'");
														}
														}else if($this->jabatan_id->CurrentValue == '15'){
															if ($this->periode->CurrentValue == '1'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='1'");
														}else if ($this->periode->CurrentValue == '2'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='2'");		
														}else if ($this->periode->CurrentValue == '3'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='3'");	
														}else if ($this->periode->CurrentValue == '4'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='4'");	
														}else if ($this->periode->CurrentValue == '5'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='5'");
														}else if ($this->periode->CurrentValue == '6'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='6'");
														}else if ($this->periode->CurrentValue == '7'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='7'");
														}else if ($this->periode->CurrentValue == '8'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='8'");
														}else if ($this->periode->CurrentValue == '9'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='9'");
														}else if ($this->periode->CurrentValue == '10'){
															$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='5' AND kualifikasi ='15' AND lama='10'");
														}   
														}  
															if ($this->lama_kerja->CurrentValue >= '0' || $this->periode->CurrentValue <= '1'){
															$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='1500'");
															}else if ($this->lama_kerja->CurrentValue >= '2' || $this->periode->CurrentValue <= '4'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='2500'");		
															}else if ($this->lama_kerja->CurrentValue >= '5' || $this->periode->CurrentValue <= '7'){
															$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='3000'");	
															}else if ($this->lama_kerja->CurrentValue >= '8' || $this->periode->CurrentValue <= '10'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='3500'");	
																...
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='4500'");
															}else if ($this->lama_kerja->CurrentValue >= '17' || $this->periode->CurrentValue <= '19'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='5000'");
															}else if ($this->lama_kerja->CurrentValue >= '20' || $this->periode->CurrentValue <= '22'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='5500'");
															}else if ($this->lama_kerja->CurrentValue >= '23' || $this->periode->CurrentValue <= '25'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='6000'");
															}else if ($this->lama_kerja->CurrentValue >= '26' || $this->periode->CurrentValue <= '28'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='6500'");
															}else if ($this->lama_kerja->CurrentValue >= '29' || $this->periode->CurrentValue <= '31'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='7000'");
															}else if ($this->lama_kerja->CurrentValue >= '32' || $this->periode->CurrentValue <= '34'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='7500'");
															}else if ($this->lama_kerja->CurrentValue >= '35' || $this->periode->CurrentValue <= '37'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='8000'");
															}else if ($this->lama_kerja->CurrentValue >= '38' || $this->periode->CurrentValue <= '40'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='8500'");
															}else if ($this->lama_kerja->CurrentValue >= '41' || $this->periode->CurrentValue <= '43'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='9000'");
															}else if ($this->lama_kerja->CurrentValue >= '44' || $this->periode->CurrentValue <= '46'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='9500'");
															}else if ($this->lama_kerja->CurrentValue >= '47' || $this->periode->CurrentValue <= '49'){
																$gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='5' AND value='10000'");
													...
													$rsnew["tugastambahan"] = $tunjanagan_tambahan["value"];
													   ...
													   $piket= ExecuteRow("select * from m_piket where jenjang='5' and jenis_sertif ='2'");	
													   $kehadiran= ExecuteRow("Select * from m_kehadiran where jenjang='5' AND jenis_jabatan='1' AND sertif='2'");	
													   $query2 = ExecuteRow("SELECT * FROM jabatan JOIN gajitunjangan ON jabatan.id = gajitunjangan.pidjabatan where gajitunjangan.pidjabatan='9'");
													   if ($this->tambahan->CurrentValue == '2'){
														   $tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='5' AND kualifikasi='2'");
													   }else if ($this->tambahan->CurrentValue == '3'){
													   ...
													   if($this->jabatan_id->CurrentValue == '5'){
														   if ($this->periode->CurrentValue == '1'){
															   ...
															   if ($this->lama_kerja->CurrentValue >= '0' || $this->periode->CurrentValue <= '1'){
															   $gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='4' AND value='1500'");
															   }else if ($this->lama_kerja->CurrentValue >= '2' || $this->periode->CurrentValue <= '4'){
																   $gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='4' AND value='2500'");		
															   }else if ($this->lama_kerja->CurrentValue >= '5' || $this->periode->CurrentValue <= '7'){
															   $gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='4' AND value='3000'");	
															   }else if ($this->lama_kerja->CurrentValue >= '8' || $this->periode->CurrentValue <= '10'){
																   $gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='4' AND value='3500'");	
															   }else if ($this->lama_kerja->CurrentValue >= '11' || $this->periode->CurrentValue <= '13'){
																   $gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE value='4000'");
															   }else if ($this->lama_kerja->CurrentValue >= '14' || $this->periode->CurrentValue <= '16'){
																   ...
																   $gaji_pokok=ExecuteRow("SELECT * FROM gaji_pokok WHERE jenjang_id='4' AND value='7500'");
															   }else if ($this->lama_kerja->CurrentValue >= '35' || $this->periode->CurrentValue <= '37'){
	...
	function Row_Rendering() {
		...
		if (CurrentPageID() == "add") {
				...
				$id_user = ExecuteRows("SELECT * FROM pegawai where jenjang_id ='5' AND `type`= '1'");
