 ...
 * Page class
 */
class gender_view extends gender
{
	...
	// Page object name
	public $PageObjName = "gender_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "genderlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "genderlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "genderlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
