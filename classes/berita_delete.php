 ...
 * Page class
 */
class berita_delete extends berita
{
	...
	// Page object name
	public $PageObjName = "berita_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("beritalist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("beritalist.php"); // Return to list
			}
		}
	}
