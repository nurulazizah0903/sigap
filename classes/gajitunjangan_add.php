 ...
 * Page class
 */
class gajitunjangan_add extends gajitunjangan
{
	...
	// Page object name
	public $PageObjName = "gajitunjangan_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "gajitunjanganview.php")
	...
	protected function validateForm()
	{
		...
		if (!CheckInteger($this->pidjabatan->FormValue)) {
			AddMessage($FormError, $this->pidjabatan->errorMessage());
		}
