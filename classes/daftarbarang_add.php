 ...
 * Page class
 */
class daftarbarang_add extends daftarbarang
{
	...
	// Page object name
	public $PageObjName = "daftarbarang_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "daftarbarangview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->pemegang->CurrentValue = NULL;
		$this->pemegang->OldValue = $this->pemegang->CurrentValue;
		$this->nama->CurrentValue = NULL;
		$this->nama->OldValue = $this->nama->CurrentValue;
		$this->jenis->CurrentValue = NULL;
		$this->jenis->OldValue = $this->jenis->CurrentValue;
		$this->sepsifikasi->CurrentValue = NULL;
		$this->sepsifikasi->OldValue = $this->sepsifikasi->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['pemegang'] = $this->pemegang->CurrentValue;
		$row['nama'] = $this->nama->CurrentValue;
		$row['jenis'] = $this->jenis->CurrentValue;
		$row['sepsifikasi'] = $this->sepsifikasi->CurrentValue;
		$row['tgl_terima'] = $this->tgl_terima->CurrentValue;
		$row['tgl_beli'] = $this->tgl_beli->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// pemegang
		$this->pemegang->setDbValueDef($rsnew, $this->pemegang->CurrentValue, NULL, FALSE);
		...
		// sepsifikasi
		$this->sepsifikasi->setDbValueDef($rsnew, $this->sepsifikasi->CurrentValue, NULL, FALSE);

		// tgl_terima
		$this->tgl_terima->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_terima->CurrentValue, 0), NULL, FALSE);

		// tgl_beli
		$this->tgl_beli->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_beli->CurrentValue, 0), NULL, FALSE);
