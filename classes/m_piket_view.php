 ...
 * Page class
 */
class m_piket_view extends m_piket
{
	...
	// Page object name
	public $PageObjName = "m_piket_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_piketlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_piketlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_piketlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
