...
class m_sd_list extends m_sd
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gajilist.php?" . Config("TABLE_SHOW_MASTER") . "=m_sd&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_sd')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji";
			}
			if ($GLOBALS["gaji_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_sd')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji");
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji");
		if (!isset($GLOBALS["gaji"]))
			$GLOBALS["gaji"] = new gaji();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_sd') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji"] && $this->DetailPages["gaji"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_sd')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gajilist.php?" . Config("TABLE_SHOW_MASTER") . "=m_sd&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
