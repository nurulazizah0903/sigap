...
class gaji_tu_tk extends DbTable
{
	...
	public function __construct()
	{
		...
		// by
		$this->by = new DbField('gaji_tu_tk', 'gaji_tu_tk', 'x_by', 'by', '`by`', '`by`', 3, 11, -1, FALSE, '`by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
	...
	function Row_Rendering() {
		...
		// Enter your code here
				...
				$id_user = ExecuteRows("SELECT * FROM pegawai where jenjang_id ='1' AND `type`= '2'");
