...
class gaji_tu_smk extends DbTable
{
	...
	public function __construct()
	{
		...
		// by
		$this->by = new DbField('gaji_tu_smk', 'gaji_tu_smk', 'x_by', 'by', '`by`', '`by`', 3, 11, -1, FALSE, '`by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jp
		$this->jp = new DbField('gaji_tu_smk', 'gaji_tu_smk', 'x_jp', 'jp', '`jp`', '`jp`', 3, 11, -1, FALSE, '`jp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function Row_Rendering() {
		...
		// Enter your code here
				...
				$id_user = ExecuteRows("SELECT * FROM pegawai where jenjang_id ='5' AND `type`= '2'");
