 ...
 * Page class
 */
class m_kehadiran_delete extends m_kehadiran
{
	...
	// Page object name
	public $PageObjName = "m_kehadiran_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_kehadiranlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_kehadiranlist.php"); // Return to list
			}
		}
	}
