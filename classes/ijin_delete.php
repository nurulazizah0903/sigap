 ...
 * Page class
 */
class ijin_delete extends ijin
{
	...
	// Page object name
	public $PageObjName = "ijin_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ijinlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("ijinlist.php"); // Return to list
			}
		}
	}
