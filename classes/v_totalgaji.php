...
class v_totalgaji extends DbTable
{
	...
	public function __construct()
	{
		...
		// tahun
		$this->tahun = new DbField('v_totalgaji', 'v_totalgaji', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 2, 5, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// total
		$this->total = new DbField('v_totalgaji', 'v_totalgaji', 'x_total', 'total', '`total`', '`total`', 20, 20, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
