...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_ijin") && $CurrentForm->hasValue("o_ijin") && $this->ijin->CurrentValue != $this->ijin->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_cuti") && $CurrentForm->hasValue("o_cuti") && $this->cuti->CurrentValue != $this->cuti->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_dinas_luar") && $CurrentForm->hasValue("o_dinas_luar") && $this->dinas_luar->CurrentValue != $this->dinas_luar->OldValue)
			return FALSE;
