 ...
 * Page class
 */
class jenis_grup_berita_view extends jenis_grup_berita
{
	...
	// Page object name
	public $PageObjName = "jenis_grup_berita_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("jenis_grup_beritalist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "jenis_grup_beritalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "jenis_grup_beritalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "jenis_grup_beritalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jenis_grup_beritalist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
