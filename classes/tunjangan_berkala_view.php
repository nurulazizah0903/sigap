 ...
 * Page class
 */
class tunjangan_berkala_view extends tunjangan_berkala
{
	...
	// Page object name
	public $PageObjName = "tunjangan_berkala_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tunjangan_berkalalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tunjangan_berkalalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tunjangan_berkalalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
