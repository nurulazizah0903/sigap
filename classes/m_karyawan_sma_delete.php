...
class m_karyawan_sma_delete extends m_karyawan_sma
{
	...
	protected function deleteRows()
	{
		...
		// Check if records exist for detail table 'gaji_karyawan_sma'
		if (!isset($GLOBALS["gaji_karyawan_sma"]))
			$GLOBALS["gaji_karyawan_sma"] = new gaji_karyawan_sma();
		foreach ($rows as $row) {
			$rsdetail = $GLOBALS["gaji_karyawan_sma"]->loadRs("`pid` = " . QuotedValue($row['id'], DATATYPE_NUMBER, 'DB'));
			if ($rsdetail && !$rsdetail->EOF) {
				$relatedRecordMsg = str_replace("%t", "gaji_karyawan_sma", $Language->phrase("RelatedRecordExists"));
