 ...
 * Page class
 */
class proyek_view extends proyek
{
	...
	// Page object name
	public $PageObjName = "proyek_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "proyeklist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "proyeklist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "proyeklist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
