 ...
 * Page class
 */
class jenis_jabatan_view extends jenis_jabatan
{
	...
	// Page object name
	public $PageObjName = "jenis_jabatan_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("jenis_jabatanlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "jenis_jabatanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "jenis_jabatanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "jenis_jabatanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jenis_jabatanlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
