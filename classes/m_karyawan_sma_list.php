...
class m_karyawan_sma_list extends m_karyawan_sma
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_karyawan_sma')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_karyawan_smalist.php?" . Config("TABLE_SHOW_MASTER") . "=m_karyawan_sma&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_karyawan_sma_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_karyawan_sma')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_karyawan_sma");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_karyawan_sma";
			}
			if ($GLOBALS["gaji_karyawan_sma_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_karyawan_sma')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_karyawan_sma");
				...
				if ($detailCopyTblVar != "")
					$detailCopyTblVar .= ",";
				$detailCopyTblVar .= "gaji_karyawan_sma";
			}
			if ($links != "") {
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_karyawan_sma");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_karyawan_sma");
		if (!isset($GLOBALS["gaji_karyawan_sma"]))
			$GLOBALS["gaji_karyawan_sma"] = new gaji_karyawan_sma();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_karyawan_sma"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_karyawan_sma"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_karyawan_sma') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_karyawan_sma"] && $this->DetailPages["gaji_karyawan_sma"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_karyawan_sma')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_karyawan_smalist.php?" . Config("TABLE_SHOW_MASTER") . "=m_karyawan_sma&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
