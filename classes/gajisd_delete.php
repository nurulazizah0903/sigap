 ...
 * Page class
 */
class gajisd_delete extends gajisd
{
	...
	// Page object name
	public $PageObjName = "gajisd_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajisdlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajisdlist.php"); // Return to list
			}
		}
	}
