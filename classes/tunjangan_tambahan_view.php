 ...
 * Page class
 */
class tunjangan_tambahan_view extends tunjangan_tambahan
{
	...
	// Page object name
	public $PageObjName = "tunjangan_tambahan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "tunjangan_tambahanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "tunjangan_tambahanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "tunjangan_tambahanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
