 ...
 */
class jenis_ijin extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('jenis_ijin', 'jenis_ijin', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nama
		$this->nama = new DbField('jenis_ijin', 'jenis_ijin', 'x_nama', 'nama', '`nama`', '`nama`', 200, 255, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->nama->Sortable = TRUE; // Allow sort
		$this->fields['nama'] = &$this->nama;

		// aktif
		$this->aktif = new DbField('jenis_ijin', 'jenis_ijin', 'x_aktif', 'aktif', '`aktif`', '`aktif`', 200, 255, -1, FALSE, '`aktif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->aktif->Sortable = TRUE; // Allow sort
		$this->fields['aktif'] = &$this->aktif;

		// value
		$this->value = new DbField('jenis_ijin', 'jenis_ijin', 'x_value', 'value', '`value`', '`value`', 20, 20, -1, FALSE, '`value`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// valueperjam
		$this->valueperjam = new DbField('jenis_ijin', 'jenis_ijin', 'x_valueperjam', 'valueperjam', '`valueperjam`', '`valueperjam`', 20, 20, -1, FALSE, '`valueperjam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->valueperjam->Sortable = TRUE; // Allow sort
		$this->valueperjam->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
		$this->fields['valueperjam'] = &$this->valueperjam;

		// jabatan_id
		$this->jabatan_id = new DbField('jenis_ijin', 'jenis_ijin', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 11, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jenjang_id
		$this->jenjang_id = new DbField('jenis_ijin', 'jenis_ijin', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 11, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		global $Language;
		if ($pageName == "jenis_ijinview.php")
			return $Language->phrase("View");
		elseif ($pageName == "jenis_ijinedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "jenis_ijinadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("jenis_ijinview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("jenis_ijinview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "jenis_ijinadd.php?" . $this->getUrlParm($parm);
		else
			$url = "jenis_ijinadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("jenis_ijinedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("jenis_ijinadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("jenis_ijindelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->valueperjam->setDbValue($rs->fields('valueperjam'));
	...
	public function renderEditRow()
	{
		...
		// valueperjam
		$this->valueperjam->EditAttrs["class"] = "form-control";
