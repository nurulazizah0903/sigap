...
class ijin extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('ijin', 'ijin', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// pegawai
		$this->pegawai = new DbField('ijin', 'ijin', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 3, 11, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl
		$this->tgl = new DbField('ijin', 'ijin', 'x_tgl', 'tgl', '`tgl`', CastDateFieldForLike("`tgl`", 0, "DB"), 135, 19, 0, FALSE, '`tgl`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_ijin_awal
		$this->tgl_ijin_awal = new DbField('ijin', 'ijin', 'x_tgl_ijin_awal', 'tgl_ijin_awal', '`tgl_ijin_awal`', CastDateFieldForLike("`tgl_ijin_awal`", 0, "DB"), 133, 10, 0, FALSE, '`tgl_ijin_awal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tgl_ijin_awal->Sortable = TRUE; // Allow sort
		...
		// tgl_ijin_akhir
		$this->tgl_ijin_akhir = new DbField('ijin', 'ijin', 'x_tgl_ijin_akhir', 'tgl_ijin_akhir', '`tgl_ijin_akhir`', CastDateFieldForLike("`tgl_ijin_akhir`", 0, "DB"), 133, 10, 0, FALSE, '`tgl_ijin_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->tgl_ijin_akhir->Sortable = TRUE; // Allow sort
		...
		// jenis
		$this->jenis = new DbField('ijin', 'ijin', 'x_jenis', 'jenis', '`jenis`', '`jenis`', 200, 255, -1, FALSE, '`jenis`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->jenis->Sortable = TRUE; // Allow sort
		$this->fields['jenis'] = &$this->jenis;

		// keterangan
		$this->keterangan = new DbField('ijin', 'ijin', 'x_keterangan', 'keterangan', '`keterangan`', '`keterangan`', 200, 255, -1, FALSE, '`keterangan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->keterangan->Sortable = TRUE; // Allow sort
		$this->fields['keterangan'] = &$this->keterangan;

		// disetujui
		$this->disetujui = new DbField('ijin', 'ijin', 'x_disetujui', 'disetujui', '`disetujui`', '`disetujui`', 200, 5, -1, FALSE, '`disetujui`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		...
		// dokumen
		$this->dokumen = new DbField('ijin', 'ijin', 'x_dokumen', 'dokumen', '`dokumen`', '`dokumen`', 200, 255, -1, TRUE, '`dokumen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "ijinedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "ijinadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("ijinview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("ijinview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "ijinadd.php?" . $this->getUrlParm($parm);
		else
			$url = "ijinadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ijinedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("ijinadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("ijindelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->tgl_ijin_awal->setDbValue($rs->fields('tgl_ijin_awal'));
		$this->tgl_ijin_akhir->setDbValue($rs->fields('tgl_ijin_akhir'));
	...
	public function renderEditRow()
	{
		...
		$this->tgl_ijin_awal->EditValue = FormatDateTime($this->tgl_ijin_awal->CurrentValue, 8);
		...
		$this->tgl_ijin_akhir->EditValue = FormatDateTime($this->tgl_ijin_akhir->CurrentValue, 8);
