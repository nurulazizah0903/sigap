 ...
 * Page class
 */
class dinasluar_delete extends dinasluar
{
	...
	// Page object name
	public $PageObjName = "dinasluar_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("dinasluarlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("dinasluarlist.php"); // Return to list
			}
		}
	}
