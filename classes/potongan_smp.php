...
class potongan_smp extends DbTable
{
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		// To cancel, set return value to FALSE
								...
								$tidakhadir = ExecuteRow("SELECT * from m_tidakhadir where jenjang_id='3' AND jabatan_id='1'");
								...
								$terlambat = ExecuteRow("SELECT * from terlambat where jabatan_id ='1' AND jenjang_id ='3'");
								$pulcep = ExecuteRow("SELECT * from m_pulangcepat where jenjang_id ='3' AND jabatan_id ='1'");
								$sakit = ExecuteRow("SELECT * from m_sakit where jenjang_id ='3' AND jabatan_id ='1'"); 
