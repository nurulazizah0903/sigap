 ...
 * Page class
 */
class dinasluar_add extends dinasluar
{
	...
	// Page object name
	public $PageObjName = "dinasluar_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "dinasluarview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->tgl_dl_awal->CurrentValue = NULL;
		$this->tgl_dl_awal->OldValue = $this->tgl_dl_awal->CurrentValue;
		$this->tgl_dl_akhir->CurrentValue = NULL;
		$this->tgl_dl_akhir->OldValue = $this->tgl_dl_akhir->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['tgl_dl_awal'] = $this->tgl_dl_awal->CurrentValue;
		$row['tgl_dl_akhir'] = $this->tgl_dl_akhir->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// tgl_dl_awal
		$this->tgl_dl_awal->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_dl_awal->CurrentValue, 0), NULL, FALSE);

		// tgl_dl_akhir
		$this->tgl_dl_akhir->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_dl_akhir->CurrentValue, 0), NULL, FALSE);
