 ...
 * Page class
 */
class bulan_view extends bulan
{
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "bulanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "bulanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "bulanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
