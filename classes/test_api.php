...
class test_api
{
	...
	// Table name
	public $TableName = 'test_api.php';

	// Page object name
	public $PageObjName = "test_api";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'test_api.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "test_api", $url, "", "test_api", TRUE);
		$this->Heading = $Language->TablePhrase("test_api", "TblCaption"); 
	}
} // End class
?>