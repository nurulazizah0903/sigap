 ...
 * Page class
 */
class jenis_ijin_delete extends jenis_ijin
{
	...
	// Page object name
	public $PageObjName = "jenis_ijin_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("jenis_ijinlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("jenis_ijinlist.php"); // Return to list
			}
		}
	}
