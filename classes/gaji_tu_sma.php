...
class gaji_tu_sma extends DbTable
{
	...
	public function __construct()
	{
		...
		// by
		$this->by = new DbField('gaji_tu_sma', 'gaji_tu_sma', 'x_by', 'by', '`by`', '`by`', 3, 11, -1, FALSE, '`by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		$this->jenjang_id->Lookup = new Lookup('jenjang_id', 'tpendidikan', FALSE, 'nourut', ["id","","",""], [], [], [], [], [], [], '', '');
	...
	function Row_Rendering() {
		...
		// Enter your code here
				...
				$id_user = ExecuteRows("SELECT * FROM pegawai where jenjang_id ='4' AND `type`= '2'");
