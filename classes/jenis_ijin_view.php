 ...
 * Page class
 */
class jenis_ijin_view extends jenis_ijin
{
	...
	// Page object name
	public $PageObjName = "jenis_ijin_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "jenis_ijinlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "jenis_ijinlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "jenis_ijinlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
