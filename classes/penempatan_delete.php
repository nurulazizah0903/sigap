 ...
 * Page class
 */
class penempatan_delete extends penempatan
{
	...
	// Page object name
	public $PageObjName = "penempatan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("penempatanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("penempatanlist.php"); // Return to list
			}
		}
	}
