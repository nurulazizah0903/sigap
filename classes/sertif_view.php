 ...
 * Page class
 */
class sertif_view extends sertif
{
	...
	// Page object name
	public $PageObjName = "sertif_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("sertiflist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "sertiflist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "sertiflist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "sertiflist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("sertiflist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
