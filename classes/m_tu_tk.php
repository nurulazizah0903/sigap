...
class m_tu_tk extends DbTable
{
	...
	public function __construct()
	{
		...
		// tahun
		$this->tahun = new DbField('m_tu_tk', 'm_tu_tk', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 2, 5, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function update(&$rs, $where = "", $rsold = NULL, $curfilter = TRUE)
	{
		...
		if ($cascadeUpdate) {
			...
			$rswrk = $GLOBALS["gaji_tu_tk"]->loadRs("`pid` = " . QuotedValue($rsold['id'], DATATYPE_NUMBER, 'DB'));
