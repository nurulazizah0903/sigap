...
class proyek extends DbTable
{
	...
	public function __construct()
	{
		...
		// id
		$this->id = new DbField('proyek', 'proyek', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// klien
		$this->klien = new DbField('proyek', 'proyek', 'x_klien', 'klien', '`klien`', '`klien`', 200, 255, -1, FALSE, '`klien`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->klien->Sortable = TRUE; // Allow sort
		$this->fields['klien'] = &$this->klien;

		// proyek
		$this->proyek = new DbField('proyek', 'proyek', 'x_proyek', 'proyek', '`proyek`', '`proyek`', 200, 255, -1, FALSE, '`proyek`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->proyek->Sortable = TRUE; // Allow sort
		$this->fields['proyek'] = &$this->proyek;

		// tgl_awal
		$this->tgl_awal = new DbField('proyek', 'proyek', 'x_tgl_awal', 'tgl_awal', '`tgl_awal`', CastDateFieldForLike("`tgl_awal`", 0, "DB"), 133, 10, 0, FALSE, '`tgl_awal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tgl_akhir
		$this->tgl_akhir = new DbField('proyek', 'proyek', 'x_tgl_akhir', 'tgl_akhir', '`tgl_akhir`', CastDateFieldForLike("`tgl_akhir`", 0, "DB"), 133, 10, 0, FALSE, '`tgl_akhir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// file_proyek
		$this->file_proyek = new DbField('proyek', 'proyek', 'x_file_proyek', 'file_proyek', '`file_proyek`', '`file_proyek`', 200, 255, -1, TRUE, '`file_proyek`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'FILE');
		$this->file_proyek->Sortable = TRUE; // Allow sort
		$this->fields['file_proyek'] = &$this->file_proyek;

		// aktif
		$this->aktif = new DbField('proyek', 'proyek', 'x_aktif', 'aktif', '`aktif`', '`aktif`', 16, 4, -1, FALSE, '`aktif`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "proyekedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "proyekadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("proyekview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("proyekview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "proyekadd.php?" . $this->getUrlParm($parm);
		else
			$url = "proyekadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("proyekedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("proyekadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("proyekdelete.php", $this->getUrlParm());
	}
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->klien->setDbValue($rs->fields('klien'));
		...
		$this->file_proyek->Upload->DbValue = $rs->fields('file_proyek');
