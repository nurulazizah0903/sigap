 ...
 * Page class
 */
class gajitunjangan_delete extends gajitunjangan
{
	...
	// Page object name
	public $PageObjName = "gajitunjangan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gajitunjanganlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gajitunjanganlist.php"); // Return to list
			}
		}
	}
