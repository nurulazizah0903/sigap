 ...
 * Page class
 */
class pengetahuan_delete extends pengetahuan
{
	...
	// Page object name
	public $PageObjName = "pengetahuan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("pengetahuanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("pengetahuanlist.php"); // Return to list
			}
		}
	}
