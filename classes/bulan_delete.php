 ...
 * Page class
 */
class bulan_delete extends bulan
{
	...
	// Page object name
	public $PageObjName = "bulan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("bulanlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("bulanlist.php"); // Return to list
			}
		}
	}
