...
class gaji_sma extends DbTable
{
	...
	public function __construct()
	{
		...
		// pid
		$this->pid = new DbField('gaji_sma', 'gaji_sma', 'x_pid', 'pid', '`pid`', '`pid`', 3, 11, -1, FALSE, '`pid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// by
		$this->by = new DbField('gaji_sma', 'gaji_sma', 'x_by', 'by', '`by`', '`by`', 3, 11, -1, FALSE, '`by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// type
		$this->type = new DbField('gaji_sma', 'gaji_sma', 'x_type', 'type', '`type`', '`type`', 3, 11, -1, FALSE, '`type`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jp
		$this->jp = new DbField('gaji_sma', 'gaji_sma', 'x_jp', 'jp', '`jp`', '`jp`', 3, 11, -1, FALSE, '`jp`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// To cancel, set return value to FALSE
									   ...
									   if ($this->jenis_guru->CurrentValue == '1'){
										...
										if ($this->tambahan->CurrentValue == '2'){
											$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='4' AND kualifikasi='2'");
										}else if ($this->tambahan->CurrentValue == '3'){
											$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='4' AND kualifikasi='3'");		
										}else if ($this->tambahan->CurrentValue == '4'){
											$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='4' AND kualifikasi='4'");	
										}else if ($this->tambahan->CurrentValue == '5'){
											$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='4' AND kualifikasi='5'");	
										}else if ($this->tambahan->CurrentValue == '6'){
											$tunjanagan_tambahan=ExecuteRow("select * from tunjangan_tambahan where jenjang='4' AND kualifikasi='6'");
										}
										if($this->jabatan_id->CurrentValue == '5'){
											if ($this->periode->CurrentValue == '1'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='1'");
											}else if ($this->periode->CurrentValue == '2'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='2'");		
											}else if ($this->periode->CurrentValue == '3'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='3'");	
											}else if ($this->periode->CurrentValue == '4'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='4'");	
											}else if ($this->periode->CurrentValue == '5'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='5'");
											}else if ($this->periode->CurrentValue == '6'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='6'");
											}else if ($this->periode->CurrentValue == '7'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='7'");
											}else if ($this->periode->CurrentValue == '8'){
												$tunjanagan_tambahan=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='8'");
											}else if ($this->periode->CurrentValue == '9'){
												$tunjanagan_tambahan=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='9'");
											}else if ($this->periode->CurrentValue == '10'){
												$tunjanagan_tambahan=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='5' AND lama='10'");
											}
											}else if($this->jabatan_id->CurrentValue == '15'){
												if ($this->periode->CurrentValue == '1'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='1'");
											}else if ($this->periode->CurrentValue == '2'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='2'");		
											}else if ($this->periode->CurrentValue == '3'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='3'");	
											}else if ($this->periode->CurrentValue == '4'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='4'");	
											}else if ($this->periode->CurrentValue == '5'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='5'");
											}else if ($this->periode->CurrentValue == '6'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='6'");
											}else if ($this->periode->CurrentValue == '7'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='7'");
											}else if ($this->periode->CurrentValue == '8'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='8'");
											}else if ($this->periode->CurrentValue == '9'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='9'");
											}else if ($this->periode->CurrentValue == '10'){
												$tunjangan_berkala=ExecuteRow("SELECT * FROM tunjangan_berkala WHERE jenjang='4' AND kualifikasi ='15' AND lama='10'");
											}   
											}  
