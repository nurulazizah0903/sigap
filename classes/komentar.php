...
class komentar extends DbTable
{
	...
	// Master filter
	public function sqlMasterFilter_berita()
	{
		return "`id`=@id@";
	}

	// Detail filter
	public function sqlDetailFilter_berita()
	{
		return "`pid`=@pid@";
	}
	...
	{
		if ($this->getCurrentMasterTable() == "berita" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
