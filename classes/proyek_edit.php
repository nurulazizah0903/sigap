 ...
 * Page class
 */
class proyek_edit extends proyek
{
	...
	// Page object name
	public $PageObjName = "proyek_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// klien
			$this->klien->setDbValueDef($rsnew, $this->klien->CurrentValue, NULL, $this->klien->ReadOnly);
			...
			// file_proyek
			if ($this->file_proyek->Visible && !$this->file_proyek->ReadOnly && !$this->file_proyek->Upload->KeepFile) {
				$this->file_proyek->Upload->DbValue = $rsold['file_proyek']; // Get original value
			...
			if ($this->file_proyek->Visible && !$this->file_proyek->Upload->KeepFile) {
				...
				if (!EmptyValue($this->file_proyek->Upload->FileName)) {
					...
					$this->file_proyek->setDbValueDef($rsnew, $this->file_proyek->Upload->FileName, NULL, $this->file_proyek->ReadOnly);
				}
			}
