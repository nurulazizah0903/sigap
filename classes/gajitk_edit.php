 ...
 * Page class
 */
class gajitk_edit extends gajitk
{
	...
	// Page object name
	public $PageObjName = "gajitk_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gajitk_detil", $detailTblVar) && $GLOBALS["gajitk_detil"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gajitk_detil", $detailTblVar) && $GLOBALS["gajitk_detil"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gajitk_detil_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gajitk_detil", $detailTblVar)) {
				...
				if ($GLOBALS["gajitk_detil_grid"]->DetailEdit) {
					$GLOBALS["gajitk_detil_grid"]->CurrentMode = "edit";
					$GLOBALS["gajitk_detil_grid"]->CurrentAction = "gridedit";
