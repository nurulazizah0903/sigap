 ...
 * Page class
 */
class potongan_delete extends potongan
{
	...
	// Page object name
	public $PageObjName = "potongan_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("potonganlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("potonganlist.php"); // Return to list
			}
		}
	}
