 ...
 * Page class
 */
class berita_edit extends berita
{
	...
	// Page object name
	public $PageObjName = "berita_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("komentar", $detailTblVar) && $GLOBALS["komentar"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("komentar", $detailTblVar) && $GLOBALS["komentar"]->DetailEdit) {
						...
						$editRow = $GLOBALS["komentar_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("komentar", $detailTblVar)) {
				...
				if ($GLOBALS["komentar_grid"]->DetailEdit) {
					$GLOBALS["komentar_grid"]->CurrentMode = "edit";
					$GLOBALS["komentar_grid"]->CurrentAction = "gridedit";
