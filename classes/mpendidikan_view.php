 ...
 * Page class
 */
class mpendidikan_view extends mpendidikan
{
	...
	// Page object name
	public $PageObjName = "mpendidikan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "mpendidikanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "mpendidikanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "mpendidikanlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
