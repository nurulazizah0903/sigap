 ...
 * Page class
 */
class potongan_view extends potongan
{
	...
	// Page object name
	public $PageObjName = "potongan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "potonganlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "potonganlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "potonganlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
