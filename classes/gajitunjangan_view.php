 ...
 * Page class
 */
class gajitunjangan_view extends gajitunjangan
{
	...
	// Page object name
	public $PageObjName = "gajitunjangan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "gajitunjanganlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "gajitunjanganlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "gajitunjanganlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
