...
class potongan_smk extends DbTable
{
	...
	public function __construct()
	{
		...
		$this->nama->Lookup = new Lookup('nama', 'pegawai', FALSE, 'nip', ["nama","","",""], [], [], [], [], ["jabatan","jenjang_id"], ["x_jabatan_id","x_jenjang_id"], '', '');
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		$tidakhadir = ExecuteRow("SELECT * from m_tidakhadir where jenjang_id='5' AND jabatan_id='1'");
								...
								$terlambat = ExecuteRow("SELECT * from terlambat where jabatan_id ='1' AND jenjang_id ='5'");
								$pulcep = ExecuteRow("SELECT * from m_pulangcepat where jenjang_id ='5' AND jabatan_id ='1'");
								$sakit = ExecuteRow("SELECT * from m_sakit where jenjang_id ='5' AND jabatan_id ='1'"); 
