 ...
 * Page class
 */
class gaji_pokok_delete extends gaji_pokok
{
	...
	// Page object name
	public $PageObjName = "gaji_pokok_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("gaji_pokoklist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("gaji_pokoklist.php"); // Return to list
			}
		}
	}
