...
/**
 * Table class for bulan
 */
class bulan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'bulan';
		$this->TableName = 'bulan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`bulan`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('bulan', 'bulan', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// nourut
		$this->nourut = new DbField('bulan', 'bulan', 'x_nourut', 'nourut', '`nourut`', '`nourut`', 3, 11, -1, FALSE, '`nourut`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// bulan
		$this->bulan = new DbField('bulan', 'bulan', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 200, 50, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`bulan`";
	}
	...
	{
		global $Language;
		if ($pageName == "bulanview.php")
			return $Language->phrase("View");
		elseif ($pageName == "bulanedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "bulanadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("bulanview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("bulanview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "bulanadd.php?" . $this->getUrlParm($parm);
		else
			$url = "bulanadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("bulanedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("bulanadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("bulandelete.php", $this->getUrlParm());
	}
