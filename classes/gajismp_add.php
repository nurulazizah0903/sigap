 ...
 * Page class
 */
class gajismp_add extends gajismp
{
	...
	// Page object name
	public $PageObjName = "gajismp_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "gajismpview.php")
	...
	protected function validateForm()
	{
		...
		if (in_array("gajismp_detil", $detailTblVar) && $GLOBALS["gajismp_detil"]->DetailAdd) {
	...
	protected function addRow($rsold = NULL)
	{
		...
		if ($addRow) {
			$detailTblVar = explode(",", $this->getCurrentDetailTable());
			if (in_array("gajismp_detil", $detailTblVar) && $GLOBALS["gajismp_detil"]->DetailAdd) {
				$GLOBALS["gajismp_detil"]->pid->setSessionValue($this->id->CurrentValue); // Set master key
				if (!isset($GLOBALS["gajismp_detil_grid"]))
					$GLOBALS["gajismp_detil_grid"] = new gajismp_detil_grid(); // Get detail page object
				$Security->loadCurrentUserLevel($this->ProjectID . "gajismp_detil"); // Load user level of detail table
				$addRow = $GLOBALS["gajismp_detil_grid"]->gridInsert();
				$Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
				if (!$addRow) {
					$GLOBALS["gajismp_detil"]->pid->setSessionValue(""); // Clear master key if insert failed
				}
			}
		}
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gajismp_detil", $detailTblVar)) {
				...
				if ($GLOBALS["gajismp_detil_grid"]->DetailAdd) {
					if ($this->CopyRecord)
						$GLOBALS["gajismp_detil_grid"]->CurrentMode = "copy";
					else
						$GLOBALS["gajismp_detil_grid"]->CurrentMode = "add";
					$GLOBALS["gajismp_detil_grid"]->CurrentAction = "gridadd";
