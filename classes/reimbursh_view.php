 ...
 * Page class
 */
class reimbursh_view extends reimbursh
{
	...
	// Page object name
	public $PageObjName = "reimbursh_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "reimburshlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "reimburshlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "reimburshlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
