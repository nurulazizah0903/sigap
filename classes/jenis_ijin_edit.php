 ...
 * Page class
 */
class jenis_ijin_edit extends jenis_ijin
{
	...
	// Page object name
	public $PageObjName = "jenis_ijin_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// valueperjam
			$this->valueperjam->setDbValueDef($rsnew, $this->valueperjam->CurrentValue, NULL, $this->valueperjam->ReadOnly);
