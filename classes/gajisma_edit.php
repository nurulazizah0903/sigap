 ...
 * Page class
 */
class gajisma_edit extends gajisma
{
	...
	// Page object name
	public $PageObjName = "gajisma_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gajisma_detil", $detailTblVar) && $GLOBALS["gajisma_detil"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gajisma_detil", $detailTblVar) && $GLOBALS["gajisma_detil"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gajisma_detil_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gajisma_detil", $detailTblVar)) {
				...
				if ($GLOBALS["gajisma_detil_grid"]->DetailEdit) {
					$GLOBALS["gajisma_detil_grid"]->CurrentMode = "edit";
					$GLOBALS["gajisma_detil_grid"]->CurrentAction = "gridedit";
