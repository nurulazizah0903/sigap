...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_jp") && $CurrentForm->hasValue("o_jp") && $this->jp->CurrentValue != $this->jp->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ijasah") && $CurrentForm->hasValue("o_ijasah") && $this->ijasah->CurrentValue != $this->ijasah->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_tunjangan2") && $CurrentForm->hasValue("o_tunjangan2") && $this->tunjangan2->CurrentValue != $this->tunjangan2->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_tambahan") && $CurrentForm->hasValue("o_tambahan") && $this->tambahan->CurrentValue != $this->tambahan->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_type_jabatan") && $CurrentForm->hasValue("o_type_jabatan") && $this->type_jabatan->CurrentValue != $this->type_jabatan->OldValue)
			return FALSE;
		return TRUE;
	}
...
// Render list options (extended codes)
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_ijasah"))
			$this->ijasah->setOldValue($CurrentForm->getValue("o_ijasah"));
		...
		if ($CurrentForm->hasValue("o_tunjangan2"))
			$this->tunjangan2->setOldValue($CurrentForm->getValue("o_tunjangan2"));
		...
		if ($CurrentForm->hasValue("o_type_jabatan"))
			$this->type_jabatan->setOldValue($CurrentForm->getValue("o_type_jabatan"));
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->type_jabatan->ViewValue = FormatNumber($this->type_jabatan->ViewValue, 0, -2, -2, -2);
