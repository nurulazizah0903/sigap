...
class pegawai_view extends pegawai
{
	...
	protected function setupOtherOptions()
	{
		...
		// "detail_peg_skill"
		$item = &$option->add("detail_peg_skill");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("peg_skill", "TblCaption");
		...
		if ($GLOBALS["peg_skill_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'pegawai')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=peg_skill")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar != "")
				$detailViewTblVar .= ",";
		...
		if ($GLOBALS["peg_skill_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'pegawai')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=peg_skill")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar != "")
				$detailEditTblVar .= ",";
			$detailEditTblVar .= "peg_skill";
		}
		if ($GLOBALS["peg_skill_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'pegawai')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=peg_skill")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar != "")
				$detailCopyTblVar .= ",";
		...
		// "detail_peg_keluarga"
		$item = &$option->add("detail_peg_keluarga");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("peg_keluarga", "TblCaption");
		...
		if ($GLOBALS["peg_keluarga_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'pegawai')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=peg_keluarga")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar != "")
				$detailViewTblVar .= ",";
		...
		if ($GLOBALS["peg_keluarga_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'pegawai')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=peg_keluarga")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar != "")
				$detailEditTblVar .= ",";
		...
		if ($GLOBALS["peg_keluarga_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'pegawai')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=peg_keluarga")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar != "")
				$detailCopyTblVar .= ",";
		...
		// "detail_peg_dokumen"
		$item = &$option->add("detail_peg_dokumen");
		$body = $Language->phrase("ViewPageDetailLink") . $Language->TablePhrase("peg_dokumen", "TblCaption");
		...
		if ($GLOBALS["peg_dokumen_grid"]->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'pegawai')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=peg_dokumen")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailViewLink")) . "</a></li>";
			if ($detailViewTblVar != "")
				$detailViewTblVar .= ",";
		...
		if ($GLOBALS["peg_dokumen_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'pegawai')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=peg_dokumen")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailEditLink")) . "</a></li>";
			if ($detailEditTblVar != "")
				$detailEditTblVar .= ",";
		...
		if ($GLOBALS["peg_dokumen_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'pegawai')) {
			$links .= "<li><a class=\"ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode($this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=peg_dokumen")) . "\">" . HtmlImageAndText($Language->phrase("MasterDetailCopyLink")) . "</a></li>";
			if ($detailCopyTblVar != "")
				$detailCopyTblVar .= ",";
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("peg_skill", $detailTblVar)) {
				if (!isset($GLOBALS["peg_skill_grid"]))
					$GLOBALS["peg_skill_grid"] = new peg_skill_grid();
				if ($GLOBALS["peg_skill_grid"]->DetailView) {
					$GLOBALS["peg_skill_grid"]->CurrentMode = "view";
			...
			if (in_array("peg_keluarga", $detailTblVar)) {
				if (!isset($GLOBALS["peg_keluarga_grid"]))
					$GLOBALS["peg_keluarga_grid"] = new peg_keluarga_grid();
				if ($GLOBALS["peg_keluarga_grid"]->DetailView) {
					$GLOBALS["peg_keluarga_grid"]->CurrentMode = "view";
			...
			if (in_array("peg_dokumen", $detailTblVar)) {
				if (!isset($GLOBALS["peg_dokumen_grid"]))
					$GLOBALS["peg_dokumen_grid"] = new peg_dokumen_grid();
				if ($GLOBALS["peg_dokumen_grid"]->DetailView) {
					$GLOBALS["peg_dokumen_grid"]->CurrentMode = "view";
