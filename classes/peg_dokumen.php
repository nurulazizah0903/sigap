...
class peg_dokumen extends DbTable
{
	...
	public function __construct()
	{
		...
		// file_dokumen
		$this->file_dokumen = new DbField('peg_dokumen', 'peg_dokumen', 'x_file_dokumen', 'file_dokumen', '`file_dokumen`', '`file_dokumen`', 200, 255, -1, FALSE, '`file_dokumen`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	protected function loadDbValues(&$rs)
	{
		...
		$this->file_dokumen->DbValue = $row['file_dokumen'];
	...
	public function loadListRowValues(&$rs)
	{
		...
		$this->file_dokumen->setDbValue($rs->fields('file_dokumen'));
	...
	public function renderEditRow()
	{
		...
		$this->file_dokumen->EditValue = $this->file_dokumen->CurrentValue;
