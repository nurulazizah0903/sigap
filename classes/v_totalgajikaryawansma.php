...
/**
 * Table class for v_totalgajikaryawansma
 */
class v_totalgajikaryawansma extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'v_totalgajikaryawansma';
		$this->TableName = 'v_totalgajikaryawansma';
		$this->TableType = 'VIEW';

		// Update Table
		$this->UpdateTable = "`v_totalgajikaryawansma`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('v_totalgajikaryawansma', 'v_totalgajikaryawansma', 'x_id', 'id', '`id`', '`id`', 3, 10, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('v_totalgajikaryawansma', 'v_totalgajikaryawansma', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// bulan
		$this->bulan = new DbField('v_totalgajikaryawansma', 'v_totalgajikaryawansma', 'x_bulan', 'bulan', '`bulan`', '`bulan`', 3, 10, -1, FALSE, '`bulan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tahun
		$this->tahun = new DbField('v_totalgajikaryawansma', 'v_totalgajikaryawansma', 'x_tahun', 'tahun', '`tahun`', '`tahun`', 2, 5, -1, FALSE, '`tahun`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pegawai
		$this->pegawai = new DbField('v_totalgajikaryawansma', 'v_totalgajikaryawansma', 'x_pegawai', 'pegawai', '`pegawai`', '`pegawai`', 200, 50, -1, FALSE, '`pegawai`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// total
		$this->total = new DbField('v_totalgajikaryawansma', 'v_totalgajikaryawansma', 'x_total', 'total', '`total`', '`total`', 20, 19, -1, FALSE, '`total`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`v_totalgajikaryawansma`";
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] != "") {
			...
			return "v_totalgajikaryawansmalist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "v_totalgajikaryawansmaview.php")
			return $Language->phrase("View");
		elseif ($pageName == "v_totalgajikaryawansmaedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "v_totalgajikaryawansmaadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("v_totalgajikaryawansmaview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("v_totalgajikaryawansmaview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "v_totalgajikaryawansmaadd.php?" . $this->getUrlParm($parm);
		else
			$url = "v_totalgajikaryawansmaadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_totalgajikaryawansmaedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("v_totalgajikaryawansmaadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("v_totalgajikaryawansmadelete.php", $this->getUrlParm());
	}
