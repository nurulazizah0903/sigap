 ...
 * Page class
 */
class gajismk_edit extends gajismk
{
	...
	// Page object name
	public $PageObjName = "gajismk_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gajismk_detil", $detailTblVar) && $GLOBALS["gajismk_detil"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gajismk_detil", $detailTblVar) && $GLOBALS["gajismk_detil"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gajismk_detil_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gajismk_detil", $detailTblVar)) {
				...
				if ($GLOBALS["gajismk_detil_grid"]->DetailEdit) {
					$GLOBALS["gajismk_detil_grid"]->CurrentMode = "edit";
					$GLOBALS["gajismk_detil_grid"]->CurrentAction = "gridedit";
