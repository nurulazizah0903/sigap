 ...
 * Page class
 */
class jenis_dinasluar_view extends jenis_dinasluar
{
	...
	// Page object name
	public $PageObjName = "jenis_dinasluar_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("jenis_dinasluarlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "jenis_dinasluarlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "jenis_dinasluarlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "jenis_dinasluarlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jenis_dinasluarlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
