...
class m_tu_sd_list extends m_tu_sd
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_tu_sd')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_tu_sdlist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tu_sd&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_tu_sd_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_tu_sd')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_sd");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_tu_sd";
			}
			if ($GLOBALS["gaji_tu_sd_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_tu_sd')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_sd");
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_tu_sd");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_sd");
		if (!isset($GLOBALS["gaji_tu_sd"]))
			$GLOBALS["gaji_tu_sd"] = new gaji_tu_sd();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_tu_sd"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_tu_sd"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_tu_sd') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_tu_sd"] && $this->DetailPages["gaji_tu_sd"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_tu_sd')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_tu_sdlist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tu_sd&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
