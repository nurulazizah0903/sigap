 ...
 * Page class
 */
class jenis_guru_view extends jenis_guru
{
	...
	// Page object name
	public $PageObjName = "jenis_guru_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("jenis_gurulist.php"));
				else
		...
		if (!$Security->canView()) {
			...
			$this->terminate("jenis_gurulist.php");
			return;
		}
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "jenis_gurulist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "jenis_gurulist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "jenis_gurulist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("jenis_gurulist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
