...
class m_sd_delete extends m_sd
{
	...
	protected function deleteRows()
	{
		...
		// Check if records exist for detail table 'gaji'
		if (!isset($GLOBALS["gaji"]))
			$GLOBALS["gaji"] = new gaji();
		foreach ($rows as $row) {
			$rsdetail = $GLOBALS["gaji"]->loadRs("`pid` = " . QuotedValue($row['id'], DATATYPE_NUMBER, 'DB'));
			if ($rsdetail && !$rsdetail->EOF) {
				$relatedRecordMsg = str_replace("%t", "gaji", $Language->phrase("RelatedRecordExists"));
