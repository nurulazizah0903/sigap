...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_nama_dokumen") && $CurrentForm->hasValue("o_nama_dokumen") && $this->nama_dokumen->CurrentValue != $this->nama_dokumen->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_file_dokumen") && $CurrentForm->hasValue("o_file_dokumen") && $this->file_dokumen->CurrentValue != $this->file_dokumen->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_keterangan") && $CurrentForm->hasValue("o_keterangan") && $this->keterangan->CurrentValue != $this->keterangan->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_c_date") && $CurrentForm->hasValue("o_c_date") && $this->c_date->CurrentValue != $this->c_date->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_u_date") && $CurrentForm->hasValue("o_u_date") && $this->u_date->CurrentValue != $this->u_date->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_c_by") && $CurrentForm->hasValue("o_c_by") && $this->c_by->CurrentValue != $this->c_by->OldValue)
			return FALSE;
...
// Render list options (extended codes)
	...
	protected function loadDefaultValues()
	{
		...
		$this->file_dokumen->CurrentValue = NULL;
		$this->file_dokumen->OldValue = $this->file_dokumen->CurrentValue;
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_file_dokumen"))
			$this->file_dokumen->setOldValue($CurrentForm->getValue("o_file_dokumen"));
	...
	protected function newRow()
	{
		...
		$row['file_dokumen'] = $this->file_dokumen->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// file_dokumen
		$this->file_dokumen->setDbValueDef($rsnew, $this->file_dokumen->CurrentValue, NULL, FALSE);
