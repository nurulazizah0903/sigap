...
class m_tu_tk_delete extends m_tu_tk
{
	...
	protected function deleteRows()
	{
		...
		// Check if records exist for detail table 'gaji_tu_tk'
		if (!isset($GLOBALS["gaji_tu_tk"]))
			$GLOBALS["gaji_tu_tk"] = new gaji_tu_tk();
		foreach ($rows as $row) {
			$rsdetail = $GLOBALS["gaji_tu_tk"]->loadRs("`pid` = " . QuotedValue($row['id'], DATATYPE_NUMBER, 'DB'));
			if ($rsdetail && !$rsdetail->EOF) {
				$relatedRecordMsg = str_replace("%t", "gaji_tu_tk", $Language->phrase("RelatedRecordExists"));
