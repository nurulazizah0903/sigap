...
/**
 * Table class for potongan
 */
class potongan extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 'potongan';
		$this->TableName = 'potongan';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`potongan`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// id
		$this->id = new DbField('potongan', 'potongan', 'x_id', 'id', '`id`', '`id`', 3, 11, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// datetime
		$this->datetime = new DbField('potongan', 'potongan', 'x_datetime', 'datetime', '`datetime`', CastDateFieldForLike("`datetime`", 0, "DB"), 135, 19, 0, FALSE, '`datetime`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->datetime->Sortable = TRUE; // Allow sort
		$this->datetime->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
		$this->fields['datetime'] = &$this->datetime;

		// u_by
		$this->u_by = new DbField('potongan', 'potongan', 'x_u_by', 'u_by', '`u_by`', '`u_by`', 3, 11, -1, FALSE, '`u_by`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// month
		$this->month = new DbField('potongan', 'potongan', 'x_month', 'month', '`month`', CastDateFieldForLike("`month`", 0, "DB"), 133, 10, 0, FALSE, '`month`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// nama
		$this->nama = new DbField('potongan', 'potongan', 'x_nama', 'nama', '`nama`', '`nama`', 200, 50, -1, FALSE, '`nama`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		$this->nama->Lookup = new Lookup('nama', 'pegawai', FALSE, 'nip', ["nama","","",""], [], [], [], [], ["jenjang_id","jabatan"], ["x_jenjang_id","x_jabatan_id"], '', '');
		$this->fields['nama'] = &$this->nama;

		// jenjang_id
		$this->jenjang_id = new DbField('potongan', 'potongan', 'x_jenjang_id', 'jenjang_id', '`jenjang_id`', '`jenjang_id`', 3, 11, -1, FALSE, '`jenjang_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// jabatan_id
		$this->jabatan_id = new DbField('potongan', 'potongan', 'x_jabatan_id', 'jabatan_id', '`jabatan_id`', '`jabatan_id`', 3, 11, -1, FALSE, '`jabatan_id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// terlambat
		$this->terlambat = new DbField('potongan', 'potongan', 'x_terlambat', 'terlambat', '`terlambat`', '`terlambat`', 3, 11, -1, FALSE, '`terlambat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_terlambat
		$this->value_terlambat = new DbField('potongan', 'potongan', 'x_value_terlambat', 'value_terlambat', '`value_terlambat`', '`value_terlambat`', 20, 20, -1, FALSE, '`value_terlambat`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// izin
		$this->izin = new DbField('potongan', 'potongan', 'x_izin', 'izin', '`izin`', '`izin`', 3, 11, -1, FALSE, '`izin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_izin
		$this->value_izin = new DbField('potongan', 'potongan', 'x_value_izin', 'value_izin', '`value_izin`', '`value_izin`', 20, 20, -1, FALSE, '`value_izin`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sakit
		$this->sakit = new DbField('potongan', 'potongan', 'x_sakit', 'sakit', '`sakit`', '`sakit`', 3, 11, -1, FALSE, '`sakit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_sakit
		$this->value_sakit = new DbField('potongan', 'potongan', 'x_value_sakit', 'value_sakit', '`value_sakit`', '`value_sakit`', 20, 20, -1, FALSE, '`value_sakit`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tidakhadir
		$this->tidakhadir = new DbField('potongan', 'potongan', 'x_tidakhadir', 'tidakhadir', '`tidakhadir`', '`tidakhadir`', 3, 11, -1, FALSE, '`tidakhadir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_tidakhadir
		$this->value_tidakhadir = new DbField('potongan', 'potongan', 'x_value_tidakhadir', 'value_tidakhadir', '`value_tidakhadir`', '`value_tidakhadir`', 20, 20, -1, FALSE, '`value_tidakhadir`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// pulcep
		$this->pulcep = new DbField('potongan', 'potongan', 'x_pulcep', 'pulcep', '`pulcep`', '`pulcep`', 3, 11, -1, FALSE, '`pulcep`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// value_pulcep
		$this->value_pulcep = new DbField('potongan', 'potongan', 'x_value_pulcep', 'value_pulcep', '`value_pulcep`', '`value_pulcep`', 20, 20, -1, FALSE, '`value_pulcep`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tidakhadirjam
		$this->tidakhadirjam = new DbField('potongan', 'potongan', 'x_tidakhadirjam', 'tidakhadirjam', '`tidakhadirjam`', '`tidakhadirjam`', 3, 11, -1, FALSE, '`tidakhadirjam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// tidakhadirjamvalue
		$this->tidakhadirjamvalue = new DbField('potongan', 'potongan', 'x_tidakhadirjamvalue', 'tidakhadirjamvalue', '`tidakhadirjamvalue`', '`tidakhadirjamvalue`', 20, 20, -1, FALSE, '`tidakhadirjamvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sakitperjam
		$this->sakitperjam = new DbField('potongan', 'potongan', 'x_sakitperjam', 'sakitperjam', '`sakitperjam`', '`sakitperjam`', 3, 11, -1, FALSE, '`sakitperjam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// sakitperjamvalue
		$this->sakitperjamvalue = new DbField('potongan', 'potongan', 'x_sakitperjamvalue', 'sakitperjamvalue', '`sakitperjamvalue`', '`sakitperjamvalue`', 20, 20, -1, FALSE, '`sakitperjamvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// izinperjam
		$this->izinperjam = new DbField('potongan', 'potongan', 'x_izinperjam', 'izinperjam', '`izinperjam`', '`izinperjam`', 3, 11, -1, FALSE, '`izinperjam`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// izinperjamvalue
		$this->izinperjamvalue = new DbField('potongan', 'potongan', 'x_izinperjamvalue', 'izinperjamvalue', '`izinperjamvalue`', '`izinperjamvalue`', 20, 20, -1, FALSE, '`izinperjamvalue`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// totalpotongan
		$this->totalpotongan = new DbField('potongan', 'potongan', 'x_totalpotongan', 'totalpotongan', '`totalpotongan`', '`totalpotongan`', 20, 19, -1, FALSE, '`totalpotongan`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "`potongan`";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "potonganedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "potonganadd.php")
	...
	{
		if ($parm != "")
			$url = $this->keyUrl("potonganview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("potonganview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	{
		if ($parm != "")
			$url = "potonganadd.php?" . $this->getUrlParm($parm);
		else
			$url = "potonganadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("potonganedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("potonganadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("potongandelete.php", $this->getUrlParm());
	}
	...
	function Row_Inserting($rsold, &$rsnew) {
		...
		if ($this->jenjang_id->CurrentValue == '1')
									...
									$terlambat = ExecuteRow("SELECT * from terlambat where jabatan_id ='2' AND jenjang_id ='1'");
									$pulcep = ExecuteRow("SELECT * from m_pulangcepat where jenjang_id ='1' AND jabatan_id ='1'");
									$sakit = ExecuteRow("SELECT * from m_sakit where jenjang_id ='1' AND jabatan ='1'");    
									...
									$rsnew["totalpotongan"] = ($this->izin->CurrentValue * $tidakhadir["value"]) + ($this->sakit->CurrentValue * $sakit["perhari"]) + ($this->terlambat->CurrentValue * $terlambat["value"]) + ($this->tidakhadir->CurrentValue * $tidakhadir["value"]) + ($this->sakitperjam->CurrentValue * $sakit["perjam_value"]) + ($this->pulcep->CurrentValue * $pulcep["perhari"]) + ($this->izinperjam->CurrentValue * $tidakhadir["perjam_value"]) + ($this->tidakhadirjam->CurrentValue * $tidakhadir["perjam_value"]);

									/*} else if($this->jabatan_id->CurrentValue == '2'){
									$tidakhadir = ExecuteRow("SELECT * from m_tidakhadir where jenjang_id='1' AND jabatan_id='2'");
									//catatan untuk izin valuenya sama dengan tidak hadir
									//$ijin = ExecuteRow("SELECT * from jenis_ijin where jabatan_id ='2' AND jabatan_id ='1'");
									$terlambat = ExecuteRow("SELECT * from terlambat where jabatan_id ='2' AND jenjang_id ='1'");
									$pulcep = ExecuteRow("SELECT * from m_pulangcepat where jenjang_id ='1' AND jabatan_id ='2'");
									$sakit = ExecuteRow("SELECT * from m_sakit where jenjang_id ='1' AND jabatan ='2'");    
									$rsnew["value_izin"] = $tidakhadir["value"];
									$rsnew["value_sakit"] = $sakit["perhari"];
									$rsnew["sakitperjamvalue"] = $sakit["perjam"];
									$rsnew["tidakhadirjamvalue"] = $tidakhadir["perjam_value"];
