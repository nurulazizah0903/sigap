 ...
 * Page class
 */
class hapus_barang_view extends hapus_barang
{
	...
	// Page object name
	public $PageObjName = "hapus_barang_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID_Hapus") !== NULL) {
				...
				$returnUrl = "hapus_baranglist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "hapus_baranglist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "hapus_baranglist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
