 ...
 * Page class
 */
class uangmuka_view extends uangmuka
{
	...
	// Page object name
	public $PageObjName = "uangmuka_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "uangmukalist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "uangmukalist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "uangmukalist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
