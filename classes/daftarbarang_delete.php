 ...
 * Page class
 */
class daftarbarang_delete extends daftarbarang
{
	...
	// Page object name
	public $PageObjName = "daftarbarang_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("daftarbaranglist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("daftarbaranglist.php"); // Return to list
			}
		}
	}
