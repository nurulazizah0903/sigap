...
class m_tk_list extends m_tk
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_tk')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_tklist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tk&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_tk_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_tk')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tk");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_tk";
			}
			if ($GLOBALS["gaji_tk_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_tk')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tk");
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_tk");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tk");
		if (!isset($GLOBALS["gaji_tk"]))
			$GLOBALS["gaji_tk"] = new gaji_tk();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_tk"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_tk"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_tk') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_tk"] && $this->DetailPages["gaji_tk"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_tk')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_tklist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tk&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
