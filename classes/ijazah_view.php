 ...
 * Page class
 */
class ijazah_view extends ijazah
{
	...
	// Page object name
	public $PageObjName = "ijazah_view";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("ijazahlist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "ijazahlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "ijazahlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "ijazahlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ijazahlist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
