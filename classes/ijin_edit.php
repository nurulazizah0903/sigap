...
class ijin_edit extends ijin
{
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// tgl_ijin_awal
			$this->tgl_ijin_awal->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_ijin_awal->CurrentValue, 0), NULL, $this->tgl_ijin_awal->ReadOnly);

			// tgl_ijin_akhir
			$this->tgl_ijin_akhir->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_ijin_akhir->CurrentValue, 0), NULL, $this->tgl_ijin_akhir->ReadOnly);
