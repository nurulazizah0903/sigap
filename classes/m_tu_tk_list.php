...
class m_tu_tk_list extends m_tu_tk
{
	...
	public function renderListOptions()
	{
		...
		if ($Security->allowList(CurrentProjectID() . 'gaji_tu_tk')) {
			...
			$body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("gaji_tu_tklist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tu_tk&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "") . "\">" . $body . "</a>";
			$links = "";
			...
			if ($GLOBALS["gaji_tu_tk_grid"]->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'm_tu_tk')) {
				...
				$url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_tk");
				$links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . HtmlImageAndText($caption) . "</a></li>";
				if ($detailEditTblVar != "")
					$detailEditTblVar .= ",";
				$detailEditTblVar .= "gaji_tu_tk";
			}
			if ($GLOBALS["gaji_tu_tk_grid"]->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'm_tu_tk')) {
				$caption = $Language->phrase("MasterDetailCopyLink");
				$url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_tk");
	...
	protected function setupOtherOptions()
	{
		...
		$detailTableLink = "";
		$item = &$option->add("detailadd_gaji_tu_tk");
		$url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=gaji_tu_tk");
		if (!isset($GLOBALS["gaji_tu_tk"]))
			$GLOBALS["gaji_tu_tk"] = new gaji_tu_tk();
		$caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $GLOBALS["gaji_tu_tk"]->tableCaption();
		...
		$item->Visible = ($GLOBALS["gaji_tu_tk"]->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'm_tu_tk') && $Security->canAdd());
		if ($item->Visible) {
			if ($detailTableLink != "")
				$detailTableLink .= ",";
	...
	protected function renderListOptionsExt()
	{
		...
		if ($this->DetailPages && $this->DetailPages["gaji_tu_tk"] && $this->DetailPages["gaji_tu_tk"]->Visible) {
			...
			if ($Security->allowList(CurrentProjectID() . 'm_tu_tk')) {
				...
				$links .= $link;
				$detaillnk = JsEncodeAttribute("gaji_tu_tklist.php?" . Config("TABLE_SHOW_MASTER") . "=m_tu_tk&fk_id=" . urlencode(strval($this->id->CurrentValue)) . "");
