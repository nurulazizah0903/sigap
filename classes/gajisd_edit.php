 ...
 * Page class
 */
class gajisd_edit extends gajisd
{
	...
	// Page object name
	public $PageObjName = "gajisd_edit";
	...
	protected function validateForm()
	{
		...
		if (in_array("gajisd_detil", $detailTblVar) && $GLOBALS["gajisd_detil"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("gajisd_detil", $detailTblVar) && $GLOBALS["gajisd_detil"]->DetailEdit) {
						...
						$editRow = $GLOBALS["gajisd_detil_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("gajisd_detil", $detailTblVar)) {
				...
				if ($GLOBALS["gajisd_detil_grid"]->DetailEdit) {
					$GLOBALS["gajisd_detil_grid"]->CurrentMode = "edit";
					$GLOBALS["gajisd_detil_grid"]->CurrentAction = "gridedit";
