 ...
 * Page class
 */
class m_kehadiran_view extends m_kehadiran
{
	...
	// Page object name
	public $PageObjName = "m_kehadiran_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "m_kehadiranlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "m_kehadiranlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "m_kehadiranlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
