 ...
 * Page class
 */
class m_piket_delete extends m_piket
{
	...
	// Page object name
	public $PageObjName = "m_piket_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("m_piketlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("m_piketlist.php"); // Return to list
			}
		}
	}
