...
loadjs.ready("head", function() {
	...
	// Client script
	$("body").css("background-repeat","no-repeat"),$("body").css("background-size","cover"),$(".ew-login-card").css("margin-top","150px"),$(".ew-login-card").css("background-color","#ffffff94"),$("#btn-submit").css("color","#A5EAF4"),$("#btn-submit").css("font-weight","bolder"),$("#btn-submit").css("border-color","#ffdf4c"),$(".ew-login-card").css("margin-top","100px"),$(".login-box-msg").css("font-size","21px"),$(".login-box-msg").css("font-weight","bolder"),$(".login-box-msg").html('Sistem Informasi Gaji Pegawai <br> <img src="download.jpg" style="width: 200px;margin-bottom: 10px;">');
});
</script>
<script>
var flogin;
