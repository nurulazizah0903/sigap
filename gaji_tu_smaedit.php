...
loadjs.ready("head", function() {
	...
	fgaji_tu_smaedit.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			<?php if ($gaji_tu_sma_edit->value_inval->Required) { ?>
				elm = this.getElements("x" + infix + "_value_inval");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_sma_edit->value_inval->caption(), $gaji_tu_sma_edit->value_inval->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_value_inval");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_sma_edit->value_inval->errorMessage()) ?>");
			...
			<?php if ($gaji_tu_sma_edit->tj_jabatan->Required) { ?>
				elm = this.getElements("x" + infix + "_tj_jabatan");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_sma_edit->tj_jabatan->caption(), $gaji_tu_sma_edit->tj_jabatan->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_tj_jabatan");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_sma_edit->tj_jabatan->errorMessage()) ?>");
			<?php if ($gaji_tu_sma_edit->tunjangan2->Required) { ?>
				elm = this.getElements("x" + infix + "_tunjangan2");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_tu_sma_edit->tunjangan2->caption(), $gaji_tu_sma_edit->tunjangan2->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_tunjangan2");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_tu_sma_edit->tunjangan2->errorMessage()) ?>");
...
<?php if ($gaji_tu_sma_edit->pegawai->Visible) { // pegawai ?>
	<div id="r_pegawai" class="form-group row">
		<label id="elh_gaji_tu_sma_pegawai" for="x_pegawai" class="<?php echo $gaji_tu_sma_edit->LeftColumnClass ?>"><?php echo $gaji_tu_sma_edit->pegawai->caption() ?><?php echo $gaji_tu_sma_edit->pegawai->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="text" data-table="gaji_tu_sma" data-field="x_pegawai" name="x_pegawai" id="x_pegawai" size="30" maxlength="50" placeholder="<?php echo HtmlEncode($gaji_tu_sma_edit->pegawai->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_sma_edit->pegawai->EditValue ?>"<?php echo $gaji_tu_sma_edit->pegawai->editAttributes() ?>>
</span>
...
<?php if ($gaji_tu_sma_edit->ijasah->Visible) { // ijasah ?>
	<div id="r_ijasah" class="form-group row">
		<label id="elh_gaji_tu_sma_ijasah" for="x_ijasah" class="<?php echo $gaji_tu_sma_edit->LeftColumnClass ?>"><?php echo $gaji_tu_sma_edit->ijasah->caption() ?><?php echo $gaji_tu_sma_edit->ijasah->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="text" data-table="gaji_tu_sma" data-field="x_ijasah" name="x_ijasah" id="x_ijasah" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_tu_sma_edit->ijasah->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_sma_edit->ijasah->EditValue ?>"<?php echo $gaji_tu_sma_edit->ijasah->editAttributes() ?>>
</span>
...
<?php } ?>
<?php if ($gaji_tu_sma_edit->value_inval->Visible) { // value_inval ?>
	<div id="r_value_inval" class="form-group row">
		<label id="elh_gaji_tu_sma_value_inval" for="x_value_inval" class="<?php echo $gaji_tu_sma_edit->LeftColumnClass ?>"><?php echo $gaji_tu_sma_edit->value_inval->caption() ?><?php echo $gaji_tu_sma_edit->value_inval->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_sma_edit->RightColumnClass ?>"><div <?php echo $gaji_tu_sma_edit->value_inval->cellAttributes() ?>>
<span id="el_gaji_tu_sma_value_inval">
<input type="text" data-table="gaji_tu_sma" data-field="x_value_inval" name="x_value_inval" id="x_value_inval" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_tu_sma_edit->value_inval->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_sma_edit->value_inval->EditValue ?>"<?php echo $gaji_tu_sma_edit->value_inval->editAttributes() ?>>
</span>
<?php echo $gaji_tu_sma_edit->value_inval->CustomMsg ?></div></div>
	</div>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_tu_sma_edit->tj_jabatan->Visible) { // tj_jabatan ?>
	<div id="r_tj_jabatan" class="form-group row">
		<label id="elh_gaji_tu_sma_tj_jabatan" for="x_tj_jabatan" class="<?php echo $gaji_tu_sma_edit->LeftColumnClass ?>"><?php echo $gaji_tu_sma_edit->tj_jabatan->caption() ?><?php echo $gaji_tu_sma_edit->tj_jabatan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_sma_edit->RightColumnClass ?>"><div <?php echo $gaji_tu_sma_edit->tj_jabatan->cellAttributes() ?>>
<span id="el_gaji_tu_sma_tj_jabatan">
<input type="text" data-table="gaji_tu_sma" data-field="x_tj_jabatan" name="x_tj_jabatan" id="x_tj_jabatan" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_tu_sma_edit->tj_jabatan->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_sma_edit->tj_jabatan->EditValue ?>"<?php echo $gaji_tu_sma_edit->tj_jabatan->editAttributes() ?>>
</span>
<?php echo $gaji_tu_sma_edit->tj_jabatan->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($gaji_tu_sma_edit->tunjangan2->Visible) { // tunjangan2 ?>
	<div id="r_tunjangan2" class="form-group row">
		<label id="elh_gaji_tu_sma_tunjangan2" for="x_tunjangan2" class="<?php echo $gaji_tu_sma_edit->LeftColumnClass ?>"><?php echo $gaji_tu_sma_edit->tunjangan2->caption() ?><?php echo $gaji_tu_sma_edit->tunjangan2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_tu_sma_edit->RightColumnClass ?>"><div <?php echo $gaji_tu_sma_edit->tunjangan2->cellAttributes() ?>>
<span id="el_gaji_tu_sma_tunjangan2">
<input type="text" data-table="gaji_tu_sma" data-field="x_tunjangan2" name="x_tunjangan2" id="x_tunjangan2" size="30" maxlength="20" placeholder="<?php echo HtmlEncode($gaji_tu_sma_edit->tunjangan2->getPlaceHolder()) ?>" value="<?php echo $gaji_tu_sma_edit->tunjangan2->EditValue ?>"<?php echo $gaji_tu_sma_edit->tunjangan2->editAttributes() ?>>
</span>
<?php echo $gaji_tu_sma_edit->tunjangan2->CustomMsg ?></div></div>
	</div>
<?php } ?>
