...
// Page object
$PotonganSmpEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { potongan_smp: currentTable } });
var currentForm, currentPageID;
var fpotongan_smpedit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpotongan_smpedit = new ew.Form("fpotongan_smpedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fpotongan_smpedit;

    // Add fields
    var fields = currentTable.fields;
    fpotongan_smpedit.addFields([
        ...
        ["u_by", [fields.u_by.visible && fields.u_by.required ? ew.Validators.required(fields.u_by.caption) : null, ew.Validators.integer], fields.u_by.isInvalid],
    ...
    // Form_CustomValidate
    fpotongan_smpedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpotongan_smpedit.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fpotongan_smpedit" id="fpotongan_smpedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->month->Visible) { // month ?>
    <div id="r_month"<?= $Page->month->rowAttributes() ?>>
        <label id="elh_potongan_smp_month" for="x_month" class="<?= $Page->LeftColumnClass ?>"><?= $Page->month->caption() ?><?= $Page->month->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->month->cellAttributes() ?>>
<span id="el_potongan_smp_month">
<input type="<?= $Page->month->getInputTextType() ?>" name="x_month" id="x_month" data-table="potongan_smp" data-field="x_month" value="<?= $Page->month->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->month->getPlaceHolder()) ?>"<?= $Page->month->editAttributes() ?> aria-describedby="x_month_help">
...
<?php if ($Page->jenjang_id->Visible) { // jenjang_id ?>
    <div id="r_jenjang_id"<?= $Page->jenjang_id->rowAttributes() ?>>
        <label id="elh_potongan_smp_jenjang_id" for="x_jenjang_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jenjang_id->caption() ?><?= $Page->jenjang_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->jenjang_id->cellAttributes() ?>>
<span id="el_potongan_smp_jenjang_id">
<input type="<?= $Page->jenjang_id->getInputTextType() ?>" name="x_jenjang_id" id="x_jenjang_id" data-table="potongan_smp" data-field="x_jenjang_id" value="<?= $Page->jenjang_id->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->jenjang_id->getPlaceHolder()) ?>"<?= $Page->jenjang_id->editAttributes() ?> aria-describedby="x_jenjang_id_help">
...
<?php if ($Page->jabatan_id->Visible) { // jabatan_id ?>
    <div id="r_jabatan_id"<?= $Page->jabatan_id->rowAttributes() ?>>
        <label id="elh_potongan_smp_jabatan_id" for="x_jabatan_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jabatan_id->caption() ?><?= $Page->jabatan_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->jabatan_id->cellAttributes() ?>>
<span id="el_potongan_smp_jabatan_id">
<input type="<?= $Page->jabatan_id->getInputTextType() ?>" name="x_jabatan_id" id="x_jabatan_id" data-table="potongan_smp" data-field="x_jabatan_id" value="<?= $Page->jabatan_id->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->jabatan_id->getPlaceHolder()) ?>"<?= $Page->jabatan_id->editAttributes() ?> aria-describedby="x_jabatan_id_help">
...
<?php if ($Page->nama->Visible) { // nama ?>
    <div id="r_nama"<?= $Page->nama->rowAttributes() ?>>
        <label id="elh_potongan_smp_nama" for="x_nama" class="<?= $Page->LeftColumnClass ?>"><?= $Page->nama->caption() ?><?= $Page->nama->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->nama->cellAttributes() ?>>
<span id="el_potongan_smp_nama">
<input type="<?= $Page->nama->getInputTextType() ?>" name="x_nama" id="x_nama" data-table="potongan_smp" data-field="x_nama" value="<?= $Page->nama->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->nama->getPlaceHolder()) ?>"<?= $Page->nama->editAttributes() ?> aria-describedby="x_nama_help">
...
<?php if ($Page->terlambat->Visible) { // terlambat ?>
    <div id="r_terlambat"<?= $Page->terlambat->rowAttributes() ?>>
        <label id="elh_potongan_smp_terlambat" for="x_terlambat" class="<?= $Page->LeftColumnClass ?>"><?= $Page->terlambat->caption() ?><?= $Page->terlambat->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->terlambat->cellAttributes() ?>>
<span id="el_potongan_smp_terlambat">
<input type="<?= $Page->terlambat->getInputTextType() ?>" name="x_terlambat" id="x_terlambat" data-table="potongan_smp" data-field="x_terlambat" value="<?= $Page->terlambat->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->terlambat->getPlaceHolder()) ?>"<?= $Page->terlambat->editAttributes() ?> aria-describedby="x_terlambat_help">
...
<?php if ($Page->value_terlambat->Visible) { // value_terlambat ?>
    <div id="r_value_terlambat"<?= $Page->value_terlambat->rowAttributes() ?>>
        <label id="elh_potongan_smp_value_terlambat" for="x_value_terlambat" class="<?= $Page->LeftColumnClass ?>"><?= $Page->value_terlambat->caption() ?><?= $Page->value_terlambat->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->value_terlambat->cellAttributes() ?>>
<span id="el_potongan_smp_value_terlambat">
<input type="<?= $Page->value_terlambat->getInputTextType() ?>" name="x_value_terlambat" id="x_value_terlambat" data-table="potongan_smp" data-field="x_value_terlambat" value="<?= $Page->value_terlambat->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->value_terlambat->getPlaceHolder()) ?>"<?= $Page->value_terlambat->editAttributes() ?> aria-describedby="x_value_terlambat_help">
...
<?php if ($Page->izin->Visible) { // izin ?>
    <div id="r_izin"<?= $Page->izin->rowAttributes() ?>>
        <label id="elh_potongan_smp_izin" for="x_izin" class="<?= $Page->LeftColumnClass ?>"><?= $Page->izin->caption() ?><?= $Page->izin->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->izin->cellAttributes() ?>>
<span id="el_potongan_smp_izin">
<input type="<?= $Page->izin->getInputTextType() ?>" name="x_izin" id="x_izin" data-table="potongan_smp" data-field="x_izin" value="<?= $Page->izin->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->izin->getPlaceHolder()) ?>"<?= $Page->izin->editAttributes() ?> aria-describedby="x_izin_help">
...
<?php if ($Page->value_izin->Visible) { // value_izin ?>
    <div id="r_value_izin"<?= $Page->value_izin->rowAttributes() ?>>
        <label id="elh_potongan_smp_value_izin" for="x_value_izin" class="<?= $Page->LeftColumnClass ?>"><?= $Page->value_izin->caption() ?><?= $Page->value_izin->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->value_izin->cellAttributes() ?>>
<span id="el_potongan_smp_value_izin">
<input type="<?= $Page->value_izin->getInputTextType() ?>" name="x_value_izin" id="x_value_izin" data-table="potongan_smp" data-field="x_value_izin" value="<?= $Page->value_izin->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->value_izin->getPlaceHolder()) ?>"<?= $Page->value_izin->editAttributes() ?> aria-describedby="x_value_izin_help">
...
<?php if ($Page->izinperjam->Visible) { // izinperjam ?>
    <div id="r_izinperjam"<?= $Page->izinperjam->rowAttributes() ?>>
        <label id="elh_potongan_smp_izinperjam" for="x_izinperjam" class="<?= $Page->LeftColumnClass ?>"><?= $Page->izinperjam->caption() ?><?= $Page->izinperjam->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->izinperjam->cellAttributes() ?>>
<span id="el_potongan_smp_izinperjam">
<input type="<?= $Page->izinperjam->getInputTextType() ?>" name="x_izinperjam" id="x_izinperjam" data-table="potongan_smp" data-field="x_izinperjam" value="<?= $Page->izinperjam->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->izinperjam->getPlaceHolder()) ?>"<?= $Page->izinperjam->editAttributes() ?> aria-describedby="x_izinperjam_help">
...
<?php if ($Page->izinperjamvalue->Visible) { // izinperjamvalue ?>
    <div id="r_izinperjamvalue"<?= $Page->izinperjamvalue->rowAttributes() ?>>
        <label id="elh_potongan_smp_izinperjamvalue" for="x_izinperjamvalue" class="<?= $Page->LeftColumnClass ?>"><?= $Page->izinperjamvalue->caption() ?><?= $Page->izinperjamvalue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->izinperjamvalue->cellAttributes() ?>>
<span id="el_potongan_smp_izinperjamvalue">
<input type="<?= $Page->izinperjamvalue->getInputTextType() ?>" name="x_izinperjamvalue" id="x_izinperjamvalue" data-table="potongan_smp" data-field="x_izinperjamvalue" value="<?= $Page->izinperjamvalue->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->izinperjamvalue->getPlaceHolder()) ?>"<?= $Page->izinperjamvalue->editAttributes() ?> aria-describedby="x_izinperjamvalue_help">
...
<?php if ($Page->sakit->Visible) { // sakit ?>
    <div id="r_sakit"<?= $Page->sakit->rowAttributes() ?>>
        <label id="elh_potongan_smp_sakit" for="x_sakit" class="<?= $Page->LeftColumnClass ?>"><?= $Page->sakit->caption() ?><?= $Page->sakit->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->sakit->cellAttributes() ?>>
<span id="el_potongan_smp_sakit">
<input type="<?= $Page->sakit->getInputTextType() ?>" name="x_sakit" id="x_sakit" data-table="potongan_smp" data-field="x_sakit" value="<?= $Page->sakit->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->sakit->getPlaceHolder()) ?>"<?= $Page->sakit->editAttributes() ?> aria-describedby="x_sakit_help">
...
<?php if ($Page->value_sakit->Visible) { // value_sakit ?>
    <div id="r_value_sakit"<?= $Page->value_sakit->rowAttributes() ?>>
        <label id="elh_potongan_smp_value_sakit" for="x_value_sakit" class="<?= $Page->LeftColumnClass ?>"><?= $Page->value_sakit->caption() ?><?= $Page->value_sakit->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->value_sakit->cellAttributes() ?>>
<span id="el_potongan_smp_value_sakit">
<input type="<?= $Page->value_sakit->getInputTextType() ?>" name="x_value_sakit" id="x_value_sakit" data-table="potongan_smp" data-field="x_value_sakit" value="<?= $Page->value_sakit->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->value_sakit->getPlaceHolder()) ?>"<?= $Page->value_sakit->editAttributes() ?> aria-describedby="x_value_sakit_help">
...
<?php if ($Page->sakitperjam->Visible) { // sakitperjam ?>
    <div id="r_sakitperjam"<?= $Page->sakitperjam->rowAttributes() ?>>
        <label id="elh_potongan_smp_sakitperjam" for="x_sakitperjam" class="<?= $Page->LeftColumnClass ?>"><?= $Page->sakitperjam->caption() ?><?= $Page->sakitperjam->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->sakitperjam->cellAttributes() ?>>
<span id="el_potongan_smp_sakitperjam">
<input type="<?= $Page->sakitperjam->getInputTextType() ?>" name="x_sakitperjam" id="x_sakitperjam" data-table="potongan_smp" data-field="x_sakitperjam" value="<?= $Page->sakitperjam->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->sakitperjam->getPlaceHolder()) ?>"<?= $Page->sakitperjam->editAttributes() ?> aria-describedby="x_sakitperjam_help">
...
<?php if ($Page->sakitperjamvalue->Visible) { // sakitperjamvalue ?>
    <div id="r_sakitperjamvalue"<?= $Page->sakitperjamvalue->rowAttributes() ?>>
        <label id="elh_potongan_smp_sakitperjamvalue" for="x_sakitperjamvalue" class="<?= $Page->LeftColumnClass ?>"><?= $Page->sakitperjamvalue->caption() ?><?= $Page->sakitperjamvalue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->sakitperjamvalue->cellAttributes() ?>>
<span id="el_potongan_smp_sakitperjamvalue">
<input type="<?= $Page->sakitperjamvalue->getInputTextType() ?>" name="x_sakitperjamvalue" id="x_sakitperjamvalue" data-table="potongan_smp" data-field="x_sakitperjamvalue" value="<?= $Page->sakitperjamvalue->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->sakitperjamvalue->getPlaceHolder()) ?>"<?= $Page->sakitperjamvalue->editAttributes() ?> aria-describedby="x_sakitperjamvalue_help">
...
<?php if ($Page->pulcep->Visible) { // pulcep ?>
    <div id="r_pulcep"<?= $Page->pulcep->rowAttributes() ?>>
        <label id="elh_potongan_smp_pulcep" for="x_pulcep" class="<?= $Page->LeftColumnClass ?>"><?= $Page->pulcep->caption() ?><?= $Page->pulcep->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->pulcep->cellAttributes() ?>>
<span id="el_potongan_smp_pulcep">
<input type="<?= $Page->pulcep->getInputTextType() ?>" name="x_pulcep" id="x_pulcep" data-table="potongan_smp" data-field="x_pulcep" value="<?= $Page->pulcep->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->pulcep->getPlaceHolder()) ?>"<?= $Page->pulcep->editAttributes() ?> aria-describedby="x_pulcep_help">
...
<?php if ($Page->value_pulcep->Visible) { // value_pulcep ?>
    <div id="r_value_pulcep"<?= $Page->value_pulcep->rowAttributes() ?>>
        <label id="elh_potongan_smp_value_pulcep" for="x_value_pulcep" class="<?= $Page->LeftColumnClass ?>"><?= $Page->value_pulcep->caption() ?><?= $Page->value_pulcep->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->value_pulcep->cellAttributes() ?>>
<span id="el_potongan_smp_value_pulcep">
<input type="<?= $Page->value_pulcep->getInputTextType() ?>" name="x_value_pulcep" id="x_value_pulcep" data-table="potongan_smp" data-field="x_value_pulcep" value="<?= $Page->value_pulcep->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->value_pulcep->getPlaceHolder()) ?>"<?= $Page->value_pulcep->editAttributes() ?> aria-describedby="x_value_pulcep_help">
...
<?php if ($Page->tidakhadir->Visible) { // tidakhadir ?>
    <div id="r_tidakhadir"<?= $Page->tidakhadir->rowAttributes() ?>>
        <label id="elh_potongan_smp_tidakhadir" for="x_tidakhadir" class="<?= $Page->LeftColumnClass ?>"><?= $Page->tidakhadir->caption() ?><?= $Page->tidakhadir->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->tidakhadir->cellAttributes() ?>>
<span id="el_potongan_smp_tidakhadir">
<input type="<?= $Page->tidakhadir->getInputTextType() ?>" name="x_tidakhadir" id="x_tidakhadir" data-table="potongan_smp" data-field="x_tidakhadir" value="<?= $Page->tidakhadir->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->tidakhadir->getPlaceHolder()) ?>"<?= $Page->tidakhadir->editAttributes() ?> aria-describedby="x_tidakhadir_help">
...
<?php if ($Page->value_tidakhadir->Visible) { // value_tidakhadir ?>
    <div id="r_value_tidakhadir"<?= $Page->value_tidakhadir->rowAttributes() ?>>
        <label id="elh_potongan_smp_value_tidakhadir" for="x_value_tidakhadir" class="<?= $Page->LeftColumnClass ?>"><?= $Page->value_tidakhadir->caption() ?><?= $Page->value_tidakhadir->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->value_tidakhadir->cellAttributes() ?>>
<span id="el_potongan_smp_value_tidakhadir">
<input type="<?= $Page->value_tidakhadir->getInputTextType() ?>" name="x_value_tidakhadir" id="x_value_tidakhadir" data-table="potongan_smp" data-field="x_value_tidakhadir" value="<?= $Page->value_tidakhadir->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->value_tidakhadir->getPlaceHolder()) ?>"<?= $Page->value_tidakhadir->editAttributes() ?> aria-describedby="x_value_tidakhadir_help">
...
<?php if ($Page->tidakhadirjam->Visible) { // tidakhadirjam ?>
    <div id="r_tidakhadirjam"<?= $Page->tidakhadirjam->rowAttributes() ?>>
        <label id="elh_potongan_smp_tidakhadirjam" for="x_tidakhadirjam" class="<?= $Page->LeftColumnClass ?>"><?= $Page->tidakhadirjam->caption() ?><?= $Page->tidakhadirjam->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->tidakhadirjam->cellAttributes() ?>>
<span id="el_potongan_smp_tidakhadirjam">
<input type="<?= $Page->tidakhadirjam->getInputTextType() ?>" name="x_tidakhadirjam" id="x_tidakhadirjam" data-table="potongan_smp" data-field="x_tidakhadirjam" value="<?= $Page->tidakhadirjam->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->tidakhadirjam->getPlaceHolder()) ?>"<?= $Page->tidakhadirjam->editAttributes() ?> aria-describedby="x_tidakhadirjam_help">
...
<?php if ($Page->tidakhadirjamvalue->Visible) { // tidakhadirjamvalue ?>
    <div id="r_tidakhadirjamvalue"<?= $Page->tidakhadirjamvalue->rowAttributes() ?>>
        <label id="elh_potongan_smp_tidakhadirjamvalue" for="x_tidakhadirjamvalue" class="<?= $Page->LeftColumnClass ?>"><?= $Page->tidakhadirjamvalue->caption() ?><?= $Page->tidakhadirjamvalue->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->tidakhadirjamvalue->cellAttributes() ?>>
<span id="el_potongan_smp_tidakhadirjamvalue">
<input type="<?= $Page->tidakhadirjamvalue->getInputTextType() ?>" name="x_tidakhadirjamvalue" id="x_tidakhadirjamvalue" data-table="potongan_smp" data-field="x_tidakhadirjamvalue" value="<?= $Page->tidakhadirjamvalue->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->tidakhadirjamvalue->getPlaceHolder()) ?>"<?= $Page->tidakhadirjamvalue->editAttributes() ?> aria-describedby="x_tidakhadirjamvalue_help">
...
<?php if ($Page->total->Visible) { // total ?>
    <div id="r_total"<?= $Page->total->rowAttributes() ?>>
        <label id="elh_potongan_smp_total" for="x_total" class="<?= $Page->LeftColumnClass ?>"><?= $Page->total->caption() ?><?= $Page->total->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->total->cellAttributes() ?>>
<span id="el_potongan_smp_total">
<input type="<?= $Page->total->getInputTextType() ?>" name="x_total" id="x_total" data-table="potongan_smp" data-field="x_total" value="<?= $Page->total->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->total->getPlaceHolder()) ?>"<?= $Page->total->editAttributes() ?> aria-describedby="x_total_help">
...
<?php if ($Page->u_by->Visible) { // u_by ?>
    <div id="r_u_by"<?= $Page->u_by->rowAttributes() ?>>
        <label id="elh_potongan_smp_u_by" for="x_u_by" class="<?= $Page->LeftColumnClass ?>"><?= $Page->u_by->caption() ?><?= $Page->u_by->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->u_by->cellAttributes() ?>>
<span id="el_potongan_smp_u_by">
<input type="<?= $Page->u_by->getInputTextType() ?>" name="x_u_by" id="x_u_by" data-table="potongan_smp" data-field="x_u_by" value="<?= $Page->u_by->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->u_by->getPlaceHolder()) ?>"<?= $Page->u_by->editAttributes() ?> aria-describedby="x_u_by_help">
<?= $Page->u_by->getCustomMessage() ?>
<div class="invalid-feedback"><?= $Page->u_by->getErrorMessage() ?></div>
</span>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->datetime->Visible) { // datetime ?>
    <div id="r_datetime"<?= $Page->datetime->rowAttributes() ?>>
        <label id="elh_potongan_smp_datetime" for="x_datetime" class="<?= $Page->LeftColumnClass ?>"><?= $Page->datetime->caption() ?><?= $Page->datetime->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->datetime->cellAttributes() ?>>
<span id="el_potongan_smp_datetime">
<input type="<?= $Page->datetime->getInputTextType() ?>" name="x_datetime" id="x_datetime" data-table="potongan_smp" data-field="x_datetime" value="<?= $Page->datetime->EditValue ?>" placeholder="<?= HtmlEncode($Page->datetime->getPlaceHolder()) ?>"<?= $Page->datetime->editAttributes() ?> aria-describedby="x_datetime_help">
...
loadjs.ready(["fpotongan_smpedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpotongan_smpedit", "x_datetime", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<?php } ?>
    ...
    <input type="hidden" data-table="potongan_smp" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
