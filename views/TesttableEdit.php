...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    ftesttableedit = new ew.Form("ftesttableedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = ftesttableedit;

    // Add fields
    var fields = currentTable.fields;
    ftesttableedit.addFields([
    ...
    // Form_CustomValidate
    ftesttableedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    ftesttableedit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    loadjs.done("ftesttableedit");
});
</script>
<script>
...
$Page->showMessage();
?>
<form name="ftesttableedit" id="ftesttableedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_testtable_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_testtable_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
<input type="hidden" data-table="testtable" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["ftesttableedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftesttableedit", "x_date", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["ftesttableedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("ftesttableedit", "x_stuffingdate", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
