...
// Page object
$MTidakhadirDelete = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { m_tidakhadir: currentTable } });
var currentForm, currentPageID;
var fm_tidakhadirdelete;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fm_tidakhadirdelete = new ew.Form("fm_tidakhadirdelete", "delete");
    currentPageID = ew.PAGE_ID = "delete";
    currentForm = fm_tidakhadirdelete;
...
$Page->showMessage();
?>
<form name="fm_tidakhadirdelete" id="fm_tidakhadirdelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->jenjang_id->Visible) { // jenjang_id ?>
        <th class="<?= $Page->jenjang_id->headerCellClass() ?>"><span id="elh_m_tidakhadir_jenjang_id" class="m_tidakhadir_jenjang_id"><?= $Page->jenjang_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->jabatan_id->Visible) { // jabatan_id ?>
        <th class="<?= $Page->jabatan_id->headerCellClass() ?>"><span id="elh_m_tidakhadir_jabatan_id" class="m_tidakhadir_jabatan_id"><?= $Page->jabatan_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->value->Visible) { // value ?>
        <th class="<?= $Page->value->headerCellClass() ?>"><span id="elh_m_tidakhadir_value" class="m_tidakhadir_value"><?= $Page->value->caption() ?></span></th>
<?php } ?>
<?php if ($Page->perjam_value->Visible) { // perjam_value ?>
        <th class="<?= $Page->perjam_value->headerCellClass() ?>"><span id="elh_m_tidakhadir_perjam_value" class="m_tidakhadir_perjam_value"><?= $Page->perjam_value->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
...
<?php } ?>
<?php if ($Page->perjam_value->Visible) { // perjam_value ?>
        <td<?= $Page->perjam_value->cellAttributes() ?>>
