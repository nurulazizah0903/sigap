...
// Page object
$GajismkDetilAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { gajismk_detil: currentTable } });
var currentForm, currentPageID;
var fgajismk_detiladd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgajismk_detiladd = new ew.Form("fgajismk_detiladd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fgajismk_detiladd;

    // Add fields
    var fields = currentTable.fields;
    fgajismk_detiladd.addFields([
    ...
    // Form_CustomValidate
    fgajismk_detiladd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fgajismk_detiladd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fgajismk_detiladd.lists.pegawai_id = <?= $Page->pegawai_id->toClientList($Page) ?>;
    fgajismk_detiladd.lists.jabatan_id = <?= $Page->jabatan_id->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fgajismk_detiladd" id="fgajismk_detiladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_gajismk_detil_pegawai_id">
    <select
        ...
        data-select2-id="fgajismk_detiladd_x_pegawai_id"
...
loadjs.ready("fgajismk_detiladd", function() {
    var options = { name: "x_pegawai_id", selectId: "fgajismk_detiladd_x_pegawai_id" };
    if (fgajismk_detiladd.lists.pegawai_id.lookupOptions.length) {
        options.data = { id: "x_pegawai_id", form: "fgajismk_detiladd" };
    } else {
        options.ajax = { id: "x_pegawai_id", form: "fgajismk_detiladd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_gajismk_detil_jabatan_id">
    <select
        ...
        data-select2-id="fgajismk_detiladd_x_jabatan_id"
        data-table="gajismk_detil"
...
<script>
loadjs.ready("fgajismk_detiladd", function() {
    var options = { name: "x_jabatan_id", selectId: "fgajismk_detiladd_x_jabatan_id" };
    if (fgajismk_detiladd.lists.jabatan_id.lookupOptions.length) {
        options.data = { id: "x_jabatan_id", form: "fgajismk_detiladd" };
    } else {
        options.ajax = { id: "x_jabatan_id", form: "fgajismk_detiladd", limit: ew.LOOKUP_PAGE_SIZE };
    }
