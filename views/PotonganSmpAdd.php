...
var fpotongan_smpadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpotongan_smpadd = new ew.Form("fpotongan_smpadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fpotongan_smpadd;

    // Add fields
    var fields = currentTable.fields;
    fpotongan_smpadd.addFields([
    ...
    // Form_CustomValidate
    fpotongan_smpadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpotongan_smpadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fpotongan_smpadd" id="fpotongan_smpadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fpotongan_smpadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpotongan_smpadd", "x_datetime", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
