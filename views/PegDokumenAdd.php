...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpeg_dokumenadd = new ew.Form("fpeg_dokumenadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fpeg_dokumenadd;

    // Add fields
    var fields = currentTable.fields;
    fpeg_dokumenadd.addFields([
    ...
    // Form_CustomValidate
    fpeg_dokumenadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpeg_dokumenadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fpeg_dokumenadd.lists.c_by = <?= $Page->c_by->toClientList($Page) ?>;
    fpeg_dokumenadd.lists.u_by = <?= $Page->u_by->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpeg_dokumenadd" id="fpeg_dokumenadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready("fpeg_dokumenadd", function() {
    fpeg_dokumenadd.createAutoSuggest(Object.assign({"id":"x_c_by","forceSelect":false}, ew.vars.tables.peg_dokumen.fields.c_by.autoSuggestOptions));
});
</script>
