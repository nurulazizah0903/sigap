...
// Page object
$GajismaDetilEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { gajisma_detil: currentTable } });
var currentForm, currentPageID;
var fgajisma_detiledit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgajisma_detiledit = new ew.Form("fgajisma_detiledit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fgajisma_detiledit;

    // Add fields
    var fields = currentTable.fields;
    fgajisma_detiledit.addFields([
    ...
    // Form_CustomValidate
    fgajisma_detiledit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fgajisma_detiledit.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fgajisma_detiledit.lists.pegawai_id = <?= $Page->pegawai_id->toClientList($Page) ?>;
    fgajisma_detiledit.lists.jabatan_id = <?= $Page->jabatan_id->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fgajisma_detiledit" id="fgajisma_detiledit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->getCurrentMasterTable() == "gajisma") { ?>
...
<?php if ($Page->id->Visible) { // id ?>
    <div id="r_id"<?= $Page->id->rowAttributes() ?>>
        <label id="elh_gajisma_detil_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id->caption() ?><?= $Page->id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->id->cellAttributes() ?>>
<span id="el_gajisma_detil_id">
<span<?= $Page->id->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->id->getDisplayValue($Page->id->EditValue))) ?>"></span>
<input type="hidden" data-table="gajisma_detil" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
<?php if ($Page->pid->Visible) { // pid ?>
    <div id="r_pid"<?= $Page->pid->rowAttributes() ?>>
        <label id="elh_gajisma_detil_pid" for="x_pid" class="<?= $Page->LeftColumnClass ?>"><?= $Page->pid->caption() ?><?= $Page->pid->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="<?= $Page->pid->getInputTextType() ?>" name="x_pid" id="x_pid" data-table="gajisma_detil" data-field="x_pid" value="<?= $Page->pid->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->pid->getPlaceHolder()) ?>"<?= $Page->pid->editAttributes() ?> aria-describedby="x_pid_help">
...
<?php if ($Page->pegawai_id->Visible) { // pegawai_id ?>
    <div id="r_pegawai_id"<?= $Page->pegawai_id->rowAttributes() ?>>
        <label id="elh_gajisma_detil_pegawai_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->pegawai_id->caption() ?><?= $Page->pegawai_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<span id="el_gajisma_detil_pegawai_id">
    <select
        ...
        data-select2-id="fgajisma_detiledit_x_pegawai_id"
...
loadjs.ready("fgajisma_detiledit", function() {
    var options = { name: "x_pegawai_id", selectId: "fgajisma_detiledit_x_pegawai_id" };
    if (fgajisma_detiledit.lists.pegawai_id.lookupOptions.length) {
        options.data = { id: "x_pegawai_id", form: "fgajisma_detiledit" };
    } else {
        options.ajax = { id: "x_pegawai_id", form: "fgajisma_detiledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php if ($Page->jabatan_id->Visible) { // jabatan_id ?>
    <div id="r_jabatan_id"<?= $Page->jabatan_id->rowAttributes() ?>>
        <label id="elh_gajisma_detil_jabatan_id" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jabatan_id->caption() ?><?= $Page->jabatan_id->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<span id="el_gajisma_detil_jabatan_id">
    <select
        ...
        data-select2-id="fgajisma_detiledit_x_jabatan_id"
        data-table="gajisma_detil"
...
<script>
loadjs.ready("fgajisma_detiledit", function() {
    var options = { name: "x_jabatan_id", selectId: "fgajisma_detiledit_x_jabatan_id" };
    if (fgajisma_detiledit.lists.jabatan_id.lookupOptions.length) {
        options.data = { id: "x_jabatan_id", form: "fgajisma_detiledit" };
    } else {
        options.ajax = { id: "x_jabatan_id", form: "fgajisma_detiledit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php if ($Page->masakerja->Visible) { // masakerja ?>
    <div id="r_masakerja"<?= $Page->masakerja->rowAttributes() ?>>
        <label id="elh_gajisma_detil_masakerja" for="x_masakerja" class="<?= $Page->LeftColumnClass ?>"><?= $Page->masakerja->caption() ?><?= $Page->masakerja->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->masakerja->cellAttributes() ?>>
<span id="el_gajisma_detil_masakerja">
<input type="<?= $Page->masakerja->getInputTextType() ?>" name="x_masakerja" id="x_masakerja" data-table="gajisma_detil" data-field="x_masakerja" value="<?= $Page->masakerja->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->masakerja->getPlaceHolder()) ?>"<?= $Page->masakerja->editAttributes() ?> aria-describedby="x_masakerja_help">
...
<?php if ($Page->jumngajar->Visible) { // jumngajar ?>
    <div id="r_jumngajar"<?= $Page->jumngajar->rowAttributes() ?>>
        <label id="elh_gajisma_detil_jumngajar" for="x_jumngajar" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jumngajar->caption() ?><?= $Page->jumngajar->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->jumngajar->cellAttributes() ?>>
<span id="el_gajisma_detil_jumngajar">
<input type="<?= $Page->jumngajar->getInputTextType() ?>" name="x_jumngajar" id="x_jumngajar" data-table="gajisma_detil" data-field="x_jumngajar" value="<?= $Page->jumngajar->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->jumngajar->getPlaceHolder()) ?>"<?= $Page->jumngajar->editAttributes() ?> aria-describedby="x_jumngajar_help">
...
<?php if ($Page->ijin->Visible) { // ijin ?>
    <div id="r_ijin"<?= $Page->ijin->rowAttributes() ?>>
        <label id="elh_gajisma_detil_ijin" for="x_ijin" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ijin->caption() ?><?= $Page->ijin->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->ijin->cellAttributes() ?>>
<span id="el_gajisma_detil_ijin">
<input type="<?= $Page->ijin->getInputTextType() ?>" name="x_ijin" id="x_ijin" data-table="gajisma_detil" data-field="x_ijin" value="<?= $Page->ijin->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->ijin->getPlaceHolder()) ?>"<?= $Page->ijin->editAttributes() ?> aria-describedby="x_ijin_help">
...
<?php if ($Page->tunjangan_wkosis->Visible) { // tunjangan_wkosis ?>
    <div id="r_tunjangan_wkosis"<?= $Page->tunjangan_wkosis->rowAttributes() ?>>
        <label id="elh_gajisma_detil_tunjangan_wkosis" for="x_tunjangan_wkosis" class="<?= $Page->LeftColumnClass ?>"><?= $Page->tunjangan_wkosis->caption() ?><?= $Page->tunjangan_wkosis->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->tunjangan_wkosis->cellAttributes() ?>>
<span id="el_gajisma_detil_tunjangan_wkosis">
<input type="<?= $Page->tunjangan_wkosis->getInputTextType() ?>" name="x_tunjangan_wkosis" id="x_tunjangan_wkosis" data-table="gajisma_detil" data-field="x_tunjangan_wkosis" value="<?= $Page->tunjangan_wkosis->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->tunjangan_wkosis->getPlaceHolder()) ?>"<?= $Page->tunjangan_wkosis->editAttributes() ?> aria-describedby="x_tunjangan_wkosis_help">
...
<?php if ($Page->nominal_baku->Visible) { // nominal_baku ?>
    <div id="r_nominal_baku"<?= $Page->nominal_baku->rowAttributes() ?>>
        <label id="elh_gajisma_detil_nominal_baku" for="x_nominal_baku" class="<?= $Page->LeftColumnClass ?>"><?= $Page->nominal_baku->caption() ?><?= $Page->nominal_baku->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<?php if ($Page->baku->Visible) { // baku ?>
    <div id="r_baku"<?= $Page->baku->rowAttributes() ?>>
        <label id="elh_gajisma_detil_baku" for="x_baku" class="<?= $Page->LeftColumnClass ?>"><?= $Page->baku->caption() ?><?= $Page->baku->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->baku->cellAttributes() ?>>
<span id="el_gajisma_detil_baku">
<input type="<?= $Page->baku->getInputTextType() ?>" name="x_baku" id="x_baku" data-table="gajisma_detil" data-field="x_baku" value="<?= $Page->baku->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->baku->getPlaceHolder()) ?>"<?= $Page->baku->editAttributes() ?> aria-describedby="x_baku_help">
...
<?php if ($Page->kehadiran->Visible) { // kehadiran ?>
    <div id="r_kehadiran"<?= $Page->kehadiran->rowAttributes() ?>>
        <label id="elh_gajisma_detil_kehadiran" for="x_kehadiran" class="<?= $Page->LeftColumnClass ?>"><?= $Page->kehadiran->caption() ?><?= $Page->kehadiran->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->kehadiran->cellAttributes() ?>>
<span id="el_gajisma_detil_kehadiran">
<input type="<?= $Page->kehadiran->getInputTextType() ?>" name="x_kehadiran" id="x_kehadiran" data-table="gajisma_detil" data-field="x_kehadiran" value="<?= $Page->kehadiran->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->kehadiran->getPlaceHolder()) ?>"<?= $Page->kehadiran->editAttributes() ?> aria-describedby="x_kehadiran_help">
...
<?php if ($Page->prestasi->Visible) { // prestasi ?>
    <div id="r_prestasi"<?= $Page->prestasi->rowAttributes() ?>>
        <label id="elh_gajisma_detil_prestasi" for="x_prestasi" class="<?= $Page->LeftColumnClass ?>"><?= $Page->prestasi->caption() ?><?= $Page->prestasi->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->prestasi->cellAttributes() ?>>
<span id="el_gajisma_detil_prestasi">
<input type="<?= $Page->prestasi->getInputTextType() ?>" name="x_prestasi" id="x_prestasi" data-table="gajisma_detil" data-field="x_prestasi" value="<?= $Page->prestasi->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->prestasi->getPlaceHolder()) ?>"<?= $Page->prestasi->editAttributes() ?> aria-describedby="x_prestasi_help">
...
<?php if ($Page->jumlahgaji->Visible) { // jumlahgaji ?>
    <div id="r_jumlahgaji"<?= $Page->jumlahgaji->rowAttributes() ?>>
        <label id="elh_gajisma_detil_jumlahgaji" for="x_jumlahgaji" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jumlahgaji->caption() ?><?= $Page->jumlahgaji->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->jumlahgaji->cellAttributes() ?>>
<span id="el_gajisma_detil_jumlahgaji">
<input type="<?= $Page->jumlahgaji->getInputTextType() ?>" name="x_jumlahgaji" id="x_jumlahgaji" data-table="gajisma_detil" data-field="x_jumlahgaji" value="<?= $Page->jumlahgaji->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->jumlahgaji->getPlaceHolder()) ?>"<?= $Page->jumlahgaji->editAttributes() ?> aria-describedby="x_jumlahgaji_help">
...
<?php if ($Page->jumgajitotal->Visible) { // jumgajitotal ?>
    <div id="r_jumgajitotal"<?= $Page->jumgajitotal->rowAttributes() ?>>
        <label id="elh_gajisma_detil_jumgajitotal" for="x_jumgajitotal" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jumgajitotal->caption() ?><?= $Page->jumgajitotal->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->jumgajitotal->cellAttributes() ?>>
<span id="el_gajisma_detil_jumgajitotal">
<input type="<?= $Page->jumgajitotal->getInputTextType() ?>" name="x_jumgajitotal" id="x_jumgajitotal" data-table="gajisma_detil" data-field="x_jumgajitotal" value="<?= $Page->jumgajitotal->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->jumgajitotal->getPlaceHolder()) ?>"<?= $Page->jumgajitotal->editAttributes() ?> aria-describedby="x_jumgajitotal_help">
...
<?php if ($Page->potongan1->Visible) { // potongan1 ?>
    <div id="r_potongan1"<?= $Page->potongan1->rowAttributes() ?>>
        <label id="elh_gajisma_detil_potongan1" for="x_potongan1" class="<?= $Page->LeftColumnClass ?>"><?= $Page->potongan1->caption() ?><?= $Page->potongan1->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->potongan1->cellAttributes() ?>>
<span id="el_gajisma_detil_potongan1">
<input type="<?= $Page->potongan1->getInputTextType() ?>" name="x_potongan1" id="x_potongan1" data-table="gajisma_detil" data-field="x_potongan1" value="<?= $Page->potongan1->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->potongan1->getPlaceHolder()) ?>"<?= $Page->potongan1->editAttributes() ?> aria-describedby="x_potongan1_help">
...
<?php if ($Page->potongan2->Visible) { // potongan2 ?>
    <div id="r_potongan2"<?= $Page->potongan2->rowAttributes() ?>>
        <label id="elh_gajisma_detil_potongan2" for="x_potongan2" class="<?= $Page->LeftColumnClass ?>"><?= $Page->potongan2->caption() ?><?= $Page->potongan2->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->potongan2->cellAttributes() ?>>
<span id="el_gajisma_detil_potongan2">
<input type="<?= $Page->potongan2->getInputTextType() ?>" name="x_potongan2" id="x_potongan2" data-table="gajisma_detil" data-field="x_potongan2" value="<?= $Page->potongan2->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->potongan2->getPlaceHolder()) ?>"<?= $Page->potongan2->editAttributes() ?> aria-describedby="x_potongan2_help">
...
<?php if ($Page->jumlahterima->Visible) { // jumlahterima ?>
    <div id="r_jumlahterima"<?= $Page->jumlahterima->rowAttributes() ?>>
        <label id="elh_gajisma_detil_jumlahterima" for="x_jumlahterima" class="<?= $Page->LeftColumnClass ?>"><?= $Page->jumlahterima->caption() ?><?= $Page->jumlahterima->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
