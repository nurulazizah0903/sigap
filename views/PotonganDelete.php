...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpotongandelete = new ew.Form("fpotongandelete", "delete");
    currentPageID = ew.PAGE_ID = "delete";
    currentForm = fpotongandelete;
...
$Page->showMessage();
?>
<form name="fpotongandelete" id="fpotongandelete" class="ew-form ew-delete-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->month->Visible) { // month ?>
        <th class="<?= $Page->month->headerCellClass() ?>"><span id="elh_potongan_month" class="potongan_month"><?= $Page->month->caption() ?></span></th>
<?php } ?>
<?php if ($Page->nama->Visible) { // nama ?>
        <th class="<?= $Page->nama->headerCellClass() ?>"><span id="elh_potongan_nama" class="potongan_nama"><?= $Page->nama->caption() ?></span></th>
<?php } ?>
<?php if ($Page->jenjang_id->Visible) { // jenjang_id ?>
        <th class="<?= $Page->jenjang_id->headerCellClass() ?>"><span id="elh_potongan_jenjang_id" class="potongan_jenjang_id"><?= $Page->jenjang_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->jabatan_id->Visible) { // jabatan_id ?>
        <th class="<?= $Page->jabatan_id->headerCellClass() ?>"><span id="elh_potongan_jabatan_id" class="potongan_jabatan_id"><?= $Page->jabatan_id->caption() ?></span></th>
<?php } ?>
<?php if ($Page->terlambat->Visible) { // terlambat ?>
        <th class="<?= $Page->terlambat->headerCellClass() ?>"><span id="elh_potongan_terlambat" class="potongan_terlambat"><?= $Page->terlambat->caption() ?></span></th>
<?php } ?>
<?php if ($Page->value_terlambat->Visible) { // value_terlambat ?>
        <th class="<?= $Page->value_terlambat->headerCellClass() ?>"><span id="elh_potongan_value_terlambat" class="potongan_value_terlambat"><?= $Page->value_terlambat->caption() ?></span></th>
<?php } ?>
<?php if ($Page->izin->Visible) { // izin ?>
        <th class="<?= $Page->izin->headerCellClass() ?>"><span id="elh_potongan_izin" class="potongan_izin"><?= $Page->izin->caption() ?></span></th>
<?php } ?>
<?php if ($Page->value_izin->Visible) { // value_izin ?>
        <th class="<?= $Page->value_izin->headerCellClass() ?>"><span id="elh_potongan_value_izin" class="potongan_value_izin"><?= $Page->value_izin->caption() ?></span></th>
<?php } ?>
<?php if ($Page->izinperjam->Visible) { // izinperjam ?>
        <th class="<?= $Page->izinperjam->headerCellClass() ?>"><span id="elh_potongan_izinperjam" class="potongan_izinperjam"><?= $Page->izinperjam->caption() ?></span></th>
<?php } ?>
<?php if ($Page->izinperjamvalue->Visible) { // izinperjamvalue ?>
        <th class="<?= $Page->izinperjamvalue->headerCellClass() ?>"><span id="elh_potongan_izinperjamvalue" class="potongan_izinperjamvalue"><?= $Page->izinperjamvalue->caption() ?></span></th>
<?php } ?>
<?php if ($Page->sakit->Visible) { // sakit ?>
        <th class="<?= $Page->sakit->headerCellClass() ?>"><span id="elh_potongan_sakit" class="potongan_sakit"><?= $Page->sakit->caption() ?></span></th>
<?php } ?>
<?php if ($Page->value_sakit->Visible) { // value_sakit ?>
        <th class="<?= $Page->value_sakit->headerCellClass() ?>"><span id="elh_potongan_value_sakit" class="potongan_value_sakit"><?= $Page->value_sakit->caption() ?></span></th>
<?php } ?>
<?php if ($Page->sakitperjam->Visible) { // sakitperjam ?>
        <th class="<?= $Page->sakitperjam->headerCellClass() ?>"><span id="elh_potongan_sakitperjam" class="potongan_sakitperjam"><?= $Page->sakitperjam->caption() ?></span></th>
<?php } ?>
<?php if ($Page->sakitperjamvalue->Visible) { // sakitperjamvalue ?>
        <th class="<?= $Page->sakitperjamvalue->headerCellClass() ?>"><span id="elh_potongan_sakitperjamvalue" class="potongan_sakitperjamvalue"><?= $Page->sakitperjamvalue->caption() ?></span></th>
<?php } ?>
<?php if ($Page->pulcep->Visible) { // pulcep ?>
        <th class="<?= $Page->pulcep->headerCellClass() ?>"><span id="elh_potongan_pulcep" class="potongan_pulcep"><?= $Page->pulcep->caption() ?></span></th>
<?php } ?>
<?php if ($Page->value_pulcep->Visible) { // value_pulcep ?>
        <th class="<?= $Page->value_pulcep->headerCellClass() ?>"><span id="elh_potongan_value_pulcep" class="potongan_value_pulcep"><?= $Page->value_pulcep->caption() ?></span></th>
<?php } ?>
<?php if ($Page->tidakhadir->Visible) { // tidakhadir ?>
        <th class="<?= $Page->tidakhadir->headerCellClass() ?>"><span id="elh_potongan_tidakhadir" class="potongan_tidakhadir"><?= $Page->tidakhadir->caption() ?></span></th>
<?php } ?>
<?php if ($Page->value_tidakhadir->Visible) { // value_tidakhadir ?>
        <th class="<?= $Page->value_tidakhadir->headerCellClass() ?>"><span id="elh_potongan_value_tidakhadir" class="potongan_value_tidakhadir"><?= $Page->value_tidakhadir->caption() ?></span></th>
<?php } ?>
<?php if ($Page->tidakhadirjam->Visible) { // tidakhadirjam ?>
        <th class="<?= $Page->tidakhadirjam->headerCellClass() ?>"><span id="elh_potongan_tidakhadirjam" class="potongan_tidakhadirjam"><?= $Page->tidakhadirjam->caption() ?></span></th>
<?php } ?>
<?php if ($Page->tidakhadirjamvalue->Visible) { // tidakhadirjamvalue ?>
        <th class="<?= $Page->tidakhadirjamvalue->headerCellClass() ?>"><span id="elh_potongan_tidakhadirjamvalue" class="potongan_tidakhadirjamvalue"><?= $Page->tidakhadirjamvalue->caption() ?></span></th>
<?php } ?>
<?php if ($Page->total->Visible) { // total ?>
        <th class="<?= $Page->total->headerCellClass() ?>"><span id="elh_potongan_total" class="potongan_total"><?= $Page->total->caption() ?></span></th>
<?php } ?>
<?php if ($Page->u_by->Visible) { // u_by ?>
        <th class="<?= $Page->u_by->headerCellClass() ?>"><span id="elh_potongan_u_by" class="potongan_u_by"><?= $Page->u_by->caption() ?></span></th>
<?php } ?>
<?php if ($Page->datetime->Visible) { // datetime ?>
        <th class="<?= $Page->datetime->headerCellClass() ?>"><span id="elh_potongan_datetime" class="potongan_datetime"><?= $Page->datetime->caption() ?></span></th>
<?php } ?>
    </tr>
    </thead>
    <tbody>
