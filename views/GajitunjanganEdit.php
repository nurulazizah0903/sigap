...
// Page object
$GajitunjanganEdit = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { gajitunjangan: currentTable } });
var currentForm, currentPageID;
var fgajitunjanganedit;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgajitunjanganedit = new ew.Form("fgajitunjanganedit", "edit");
    currentPageID = ew.PAGE_ID = "edit";
    currentForm = fgajitunjanganedit;

    // Add fields
    var fields = currentTable.fields;
    fgajitunjanganedit.addFields([
    ...
    // Form_CustomValidate
    fgajitunjanganedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fgajitunjanganedit.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fgajitunjanganedit" id="fgajitunjanganedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php } ?>
    ...
    <input type="hidden" data-table="gajitunjangan" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
