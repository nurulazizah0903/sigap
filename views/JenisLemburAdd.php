...
var fjenis_lemburadd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fjenis_lemburadd = new ew.Form("fjenis_lemburadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fjenis_lemburadd;

    // Add fields
    var fields = currentTable.fields;
    fjenis_lemburadd.addFields([
    ...
    // Form_CustomValidate
    fjenis_lemburadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fjenis_lemburadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fjenis_lemburadd" id="fjenis_lemburadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
