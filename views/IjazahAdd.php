...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fijazahadd = new ew.Form("fijazahadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fijazahadd;

    // Add fields
    var fields = currentTable.fields;
    fijazahadd.addFields([
        ["name", [fields.name.visible && fields.name.required ? ew.Validators.required(fields.name.caption) : null], fields.name.isInvalid]
    ]);

    // Form_CustomValidate
    fijazahadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fijazahadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fijazahadd" id="fijazahadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
