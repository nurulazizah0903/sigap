...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpegawaiadd = new ew.Form("fpegawaiadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fpegawaiadd;
    ...
    fpegawaiadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fpegawaiadd.lists.jenjang_id = <?= $Page->jenjang_id->toClientList($Page) ?>;
    fpegawaiadd.lists.pendidikan = <?= $Page->pendidikan->toClientList($Page) ?>;
    fpegawaiadd.lists.agama = <?= $Page->agama->toClientList($Page) ?>;
    fpegawaiadd.lists.jabatan = <?= $Page->jabatan->toClientList($Page) ?>;
    fpegawaiadd.lists.jenkel = <?= $Page->jenkel->toClientList($Page) ?>;
...
loadjs.ready(["fpegawaiadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpegawaiadd", "x_tgllahir", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_pegawai_jenjang_id">
    <select
        ...
        data-select2-id="fpegawaiadd_x_jenjang_id"
        data-table="pegawai"
...
loadjs.ready("fpegawaiadd", function() {
    var options = { name: "x_jenjang_id", selectId: "fpegawaiadd_x_jenjang_id" };
    if (fpegawaiadd.lists.jenjang_id.lookupOptions.length) {
        options.data = { id: "x_jenjang_id", form: "fpegawaiadd" };
    } else {
        options.ajax = { id: "x_jenjang_id", form: "fpegawaiadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_pegawai_pendidikan">
    <select
        ...
        data-select2-id="fpegawaiadd_x_pendidikan"
        data-table="pegawai"
...
<script>
loadjs.ready("fpegawaiadd", function() {
    var options = { name: "x_pendidikan", selectId: "fpegawaiadd_x_pendidikan" };
    if (fpegawaiadd.lists.pendidikan.lookupOptions.length) {
        options.data = { id: "x_pendidikan", form: "fpegawaiadd" };
    } else {
        options.ajax = { id: "x_pendidikan", form: "fpegawaiadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_pegawai_agama">
    <select
        ...
        data-select2-id="fpegawaiadd_x_agama"
        data-table="pegawai"
        data-field="x_agama"
...
<script>
loadjs.ready("fpegawaiadd", function() {
    var options = { name: "x_agama", selectId: "fpegawaiadd_x_agama" };
    if (fpegawaiadd.lists.agama.lookupOptions.length) {
        options.data = { id: "x_agama", form: "fpegawaiadd" };
    } else {
        options.ajax = { id: "x_agama", form: "fpegawaiadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_pegawai_jabatan">
    <select
        ...
        data-select2-id="fpegawaiadd_x_jabatan"
        data-table="pegawai"
...
<script>
loadjs.ready("fpegawaiadd", function() {
    var options = { name: "x_jabatan", selectId: "fpegawaiadd_x_jabatan" };
    if (fpegawaiadd.lists.jabatan.lookupOptions.length) {
        options.data = { id: "x_jabatan", form: "fpegawaiadd" };
    } else {
        options.ajax = { id: "x_jabatan", form: "fpegawaiadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
loadjs.ready(["fpegawaiadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fpegawaiadd", "x_mulai_bekerja", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_pegawai_level">
    <select
        ...
        data-select2-id="fpegawaiadd_x_level"
        data-table="pegawai"
        data-field="x_level"
...
<script>
loadjs.ready("fpegawaiadd", function() {
    var options = { name: "x_level", selectId: "fpegawaiadd_x_level" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fpegawaiadd.lists.level.lookupOptions.length) {
        options.data = { id: "x_level", form: "fpegawaiadd" };
    } else {
        options.ajax = { id: "x_level", form: "fpegawaiadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php
    if (in_array("peg_dokumen", explode(",", $Page->getCurrentDetailTable())) && $peg_dokumen->DetailAdd) {
?>
...
<?php } ?>
<?php
    if (in_array("peg_keluarga", explode(",", $Page->getCurrentDetailTable())) && $peg_keluarga->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<?php } ?>
<?php
    if (in_array("peg_skill", explode(",", $Page->getCurrentDetailTable())) && $peg_skill->DetailAdd) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
