...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fuangmukaadd = new ew.Form("fuangmukaadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fuangmukaadd;

    // Add fields
    var fields = currentTable.fields;
    fuangmukaadd.addFields([
    ...
    // Form_CustomValidate
    fuangmukaadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fuangmukaadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fuangmukaadd.lists.pembayar = <?= $Page->pembayar->toClientList($Page) ?>;
    fuangmukaadd.lists.penerima = <?= $Page->penerima->toClientList($Page) ?>;
    fuangmukaadd.lists.disetujui = <?= $Page->disetujui->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fuangmukaadd" id="fuangmukaadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
loadjs.ready(["fuangmukaadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fuangmukaadd", "x_tgl", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_uangmuka_pembayar">
    <select
        ...
        data-select2-id="fuangmukaadd_x_pembayar"
        data-table="uangmuka"
...
<script>
loadjs.ready("fuangmukaadd", function() {
    var options = { name: "x_pembayar", selectId: "fuangmukaadd_x_pembayar" };
    if (fuangmukaadd.lists.pembayar.lookupOptions.length) {
        options.data = { id: "x_pembayar", form: "fuangmukaadd" };
    } else {
        options.ajax = { id: "x_pembayar", form: "fuangmukaadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_uangmuka_penerima">
    <select
        ...
        data-select2-id="fuangmukaadd_x_penerima"
        data-table="uangmuka"
...
<script>
loadjs.ready("fuangmukaadd", function() {
    var options = { name: "x_penerima", selectId: "fuangmukaadd_x_penerima" };
    if (fuangmukaadd.lists.penerima.lookupOptions.length) {
        options.data = { id: "x_penerima", form: "fuangmukaadd" };
    } else {
        options.ajax = { id: "x_penerima", form: "fuangmukaadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
loadjs.ready(["fuangmukaadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fuangmukaadd", "x_tgl_terima", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fuangmukaadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fuangmukaadd", "x_tgl_tgjb", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
