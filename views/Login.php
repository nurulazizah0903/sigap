<?php namespace PHPMaker2022\sigap; ?>
<?php
...
loadjs.ready("head", function () {
    ...
    //$('.login-box-msg').html("Login Participant")
    //$('.login-box-msg').css('font-size','large')
    $('.ew-login-card').css('margin-top','150px')
    $('.ew-login-card').css('background-color', '#ffffff94')
    $('#btn-submit').css('background-color', '#A5EAF4')
    $('#btn-submit').css('color', '#A5EAF4')
    $('#btn-submit').css('font-weight', 'bolder')
    $('#btn-submit').css('border-color', '#ffdf4c')
    $(".ew-login-card").css(`margin-top`, '100px');
    $(".login-box-msg").css(`font-size`, '21px');
    $(".login-box-msg").css(`font-weight`, 'bolder');
    $(".login-box-msg").html(`Sistem Informasi Gaji Pegawai <br> <img src="images/logo.png" style="width: 100px;margin-bottom: 10px;margin-top: 10px;">`);
});
</script>
