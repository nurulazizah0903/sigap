...
var fgajisd_detillist;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgajisd_detillist = new ew.Form("fgajisd_detillist", "list");
    currentPageID = ew.PAGE_ID = "list";
    currentForm = fgajisd_detillist;
    fgajisd_detillist.formKeyCountName = "<?= $Page->FormKeyCountName ?>";
...
<?php
if ($Page->DbMasterFilter != "" && $Page->getCurrentMasterTable() == "gajisd") {
    if ($Page->MasterRecordExists) {
        include_once "views/GajisdMaster.php";
    }
}
?>
<?php } ?>
...
<div class="card ew-card ew-grid<?php if ($Page->isAddOrEdit()) { ?> ew-grid-add-edit<?php } ?> gajisd_detil">
<?php if (!$Page->isExport()) { ?>
...
<?php } ?>
<form name="fgajisd_detillist" id="fgajisd_detillist" class="ew-form ew-list-form" action="<?= CurrentPageUrl(false) ?>" method="post">
<?php if (Config("CHECK_TOKEN")) { ?>
<input type="hidden" name="<?= $TokenNameKey ?>" value="<?= $TokenName ?>"><!-- CSRF token name -->
<input type="hidden" name="<?= $TokenValueKey ?>" value="<?= $TokenValue ?>"><!-- CSRF token value -->
<?php } ?>
<input type="hidden" name="t" value="gajisd_detil">
<?php if ($Page->getCurrentMasterTable() == "gajisd" && $Page->CurrentAction) { ?>
...
<table id="tbl_gajisd_detillist" class="table table-bordered table-hover table-sm ew-table"><!-- .ew-table -->
<thead>
...
<?php if ($Page->pegawai_id->Visible) { // pegawai_id ?>
        <th data-name="pegawai_id" class="<?= $Page->pegawai_id->headerCellClass() ?>"><div id="elh_gajisd_detil_pegawai_id" class="gajisd_detil_pegawai_id"><?= $Page->renderFieldHeader($Page->pegawai_id) ?></div></th>
<?php } ?>
<?php if ($Page->jabatan_id->Visible) { // jabatan_id ?>
        <th data-name="jabatan_id" class="<?= $Page->jabatan_id->headerCellClass() ?>"><div id="elh_gajisd_detil_jabatan_id" class="gajisd_detil_jabatan_id"><?= $Page->renderFieldHeader($Page->jabatan_id) ?></div></th>
<?php } ?>
<?php if ($Page->masakerja->Visible) { // masakerja ?>
        <th data-name="masakerja" class="<?= $Page->masakerja->headerCellClass() ?>"><div id="elh_gajisd_detil_masakerja" class="gajisd_detil_masakerja"><?= $Page->renderFieldHeader($Page->masakerja) ?></div></th>
<?php } ?>
<?php if ($Page->jumngajar->Visible) { // jumngajar ?>
        <th data-name="jumngajar" class="<?= $Page->jumngajar->headerCellClass() ?>"><div id="elh_gajisd_detil_jumngajar" class="gajisd_detil_jumngajar"><?= $Page->renderFieldHeader($Page->jumngajar) ?></div></th>
<?php } ?>
<?php if ($Page->ijin->Visible) { // ijin ?>
        <th data-name="ijin" class="<?= $Page->ijin->headerCellClass() ?>"><div id="elh_gajisd_detil_ijin" class="gajisd_detil_ijin"><?= $Page->renderFieldHeader($Page->ijin) ?></div></th>
<?php } ?>
<?php if ($Page->baku->Visible) { // baku ?>
        <th data-name="baku" class="<?= $Page->baku->headerCellClass() ?>"><div id="elh_gajisd_detil_baku" class="gajisd_detil_baku"><?= $Page->renderFieldHeader($Page->baku) ?></div></th>
<?php } ?>
<?php if ($Page->kehadiran->Visible) { // kehadiran ?>
        <th data-name="kehadiran" class="<?= $Page->kehadiran->headerCellClass() ?>"><div id="elh_gajisd_detil_kehadiran" class="gajisd_detil_kehadiran"><?= $Page->renderFieldHeader($Page->kehadiran) ?></div></th>
<?php } ?>
<?php if ($Page->prestasi->Visible) { // prestasi ?>
        <th data-name="prestasi" class="<?= $Page->prestasi->headerCellClass() ?>"><div id="elh_gajisd_detil_prestasi" class="gajisd_detil_prestasi"><?= $Page->renderFieldHeader($Page->prestasi) ?></div></th>
<?php } ?>
<?php if ($Page->nominal_baku->Visible) { // nominal_baku ?>
        <th data-name="nominal_baku" class="<?= $Page->nominal_baku->headerCellClass() ?>"><div id="elh_gajisd_detil_nominal_baku" class="gajisd_detil_nominal_baku"><?= $Page->renderFieldHeader($Page->nominal_baku) ?></div></th>
<?php } ?>
<?php if ($Page->jumlahterima->Visible) { // jumlahterima ?>
        <th data-name="jumlahterima" class="<?= $Page->jumlahterima->headerCellClass() ?>"><div id="elh_gajisd_detil_jumlahterima" class="gajisd_detil_jumlahterima"><?= $Page->renderFieldHeader($Page->jumlahterima) ?></div></th>
<?php } ?>
<?php if ($Page->tunjangan_wkosis->Visible) { // tunjangan_wkosis ?>
        <th data-name="tunjangan_wkosis" class="<?= $Page->tunjangan_wkosis->headerCellClass() ?>"><div id="elh_gajisd_detil_tunjangan_wkosis" class="gajisd_detil_tunjangan_wkosis"><?= $Page->renderFieldHeader($Page->tunjangan_wkosis) ?></div></th>
<?php } ?>
<?php if ($Page->potongan1->Visible) { // potongan1 ?>
        <th data-name="potongan1" class="<?= $Page->potongan1->headerCellClass() ?>"><div id="elh_gajisd_detil_potongan1" class="gajisd_detil_potongan1"><?= $Page->renderFieldHeader($Page->potongan1) ?></div></th>
<?php } ?>
<?php if ($Page->potongan2->Visible) { // potongan2 ?>
        <th data-name="potongan2" class="<?= $Page->potongan2->headerCellClass() ?>"><div id="elh_gajisd_detil_potongan2" class="gajisd_detil_potongan2"><?= $Page->renderFieldHeader($Page->potongan2) ?></div></th>
<?php } ?>
<?php if ($Page->jumlahgaji->Visible) { // jumlahgaji ?>
        <th data-name="jumlahgaji" class="<?= $Page->jumlahgaji->headerCellClass() ?>"><div id="elh_gajisd_detil_jumlahgaji" class="gajisd_detil_jumlahgaji"><?= $Page->renderFieldHeader($Page->jumlahgaji) ?></div></th>
<?php } ?>
<?php if ($Page->jumgajitotal->Visible) { // jumgajitotal ?>
        <th data-name="jumgajitotal" class="<?= $Page->jumgajitotal->headerCellClass() ?>"><div id="elh_gajisd_detil_jumgajitotal" class="gajisd_detil_jumgajitotal"><?= $Page->renderFieldHeader($Page->jumgajitotal) ?></div></th>
<?php } ?>
<?php
...
while ($Page->RecordCount < $Page->StopRecord) {
    ...
    if ($Page->RecordCount >= $Page->StartRecord) {
        ...
        $Page->RowAttrs->merge([
            ...
            "id" => "r" . $Page->RowCount . "_gajisd_detil",
