...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgajitkadd = new ew.Form("fgajitkadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fgajitkadd;

    // Add fields
    var fields = currentTable.fields;
    fgajitkadd.addFields([
    ...
    // Form_CustomValidate
    fgajitkadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fgajitkadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fgajitkadd" id="fgajitkadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php
    if (in_array("gajitk_detil", explode(",", $Page->getCurrentDetailTable())) && $gajitk_detil->DetailAdd) {
?>
