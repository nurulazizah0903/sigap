...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpengetahuanadd = new ew.Form("fpengetahuanadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fpengetahuanadd;

    // Add fields
    var fields = currentTable.fields;
    fpengetahuanadd.addFields([
    ...
    // Form_CustomValidate
    fpengetahuanadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpengetahuanadd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fpengetahuanadd.lists.grup = <?= $Page->grup->toClientList($Page) ?>;
    fpengetahuanadd.lists.c_by = <?= $Page->c_by->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fpengetahuanadd" id="fpengetahuanadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_pengetahuan_grup">
    <select
        ...
        data-select2-id="fpengetahuanadd_x_grup"
...
<script>
loadjs.ready("fpengetahuanadd", function() {
    var options = { name: "x_grup", selectId: "fpengetahuanadd_x_grup" };
    if (fpengetahuanadd.lists.grup.lookupOptions.length) {
        options.data = { id: "x_grup", form: "fpengetahuanadd" };
    } else {
        options.ajax = { id: "x_grup", form: "fpengetahuanadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
