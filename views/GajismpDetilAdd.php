...
// Page object
$GajismpDetilAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { gajismp_detil: currentTable } });
var currentForm, currentPageID;
var fgajismp_detiladd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgajismp_detiladd = new ew.Form("fgajismp_detiladd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fgajismp_detiladd;

    // Add fields
    var fields = currentTable.fields;
    fgajismp_detiladd.addFields([
    ...
    // Form_CustomValidate
    fgajismp_detiladd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fgajismp_detiladd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fgajismp_detiladd" id="fgajismp_detiladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
