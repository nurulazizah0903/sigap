...
var fgajisd_detilview;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgajisd_detilview = new ew.Form("fgajisd_detilview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fgajisd_detilview;
...
$Page->showMessage();
?>
<form name="fgajisd_detilview" id="fgajisd_detilview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->pid->Visible) { // pid ?>
    <tr id="r_pid"<?= $Page->pid->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_pid"><?= $Page->pid->caption() ?></span></td>
...
<?php if ($Page->pegawai_id->Visible) { // pegawai_id ?>
    <tr id="r_pegawai_id"<?= $Page->pegawai_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_pegawai_id"><?= $Page->pegawai_id->caption() ?></span></td>
...
<?php if ($Page->jabatan_id->Visible) { // jabatan_id ?>
    <tr id="r_jabatan_id"<?= $Page->jabatan_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_jabatan_id"><?= $Page->jabatan_id->caption() ?></span></td>
...
<?php if ($Page->masakerja->Visible) { // masakerja ?>
    <tr id="r_masakerja"<?= $Page->masakerja->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_masakerja"><?= $Page->masakerja->caption() ?></span></td>
...
<?php if ($Page->jumngajar->Visible) { // jumngajar ?>
    <tr id="r_jumngajar"<?= $Page->jumngajar->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_jumngajar"><?= $Page->jumngajar->caption() ?></span></td>
...
<?php if ($Page->ijin->Visible) { // ijin ?>
    <tr id="r_ijin"<?= $Page->ijin->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_ijin"><?= $Page->ijin->caption() ?></span></td>
...
<?php if ($Page->baku->Visible) { // baku ?>
    <tr id="r_baku"<?= $Page->baku->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_baku"><?= $Page->baku->caption() ?></span></td>
...
<?php if ($Page->kehadiran->Visible) { // kehadiran ?>
    <tr id="r_kehadiran"<?= $Page->kehadiran->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_kehadiran"><?= $Page->kehadiran->caption() ?></span></td>
...
<?php if ($Page->prestasi->Visible) { // prestasi ?>
    <tr id="r_prestasi"<?= $Page->prestasi->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_prestasi"><?= $Page->prestasi->caption() ?></span></td>
...
<?php if ($Page->nominal_baku->Visible) { // nominal_baku ?>
    <tr id="r_nominal_baku"<?= $Page->nominal_baku->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_nominal_baku"><?= $Page->nominal_baku->caption() ?></span></td>
...
<?php if ($Page->jumlahterima->Visible) { // jumlahterima ?>
    <tr id="r_jumlahterima"<?= $Page->jumlahterima->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_jumlahterima"><?= $Page->jumlahterima->caption() ?></span></td>
...
<?php if ($Page->tunjangan_wkosis->Visible) { // tunjangan_wkosis ?>
    <tr id="r_tunjangan_wkosis"<?= $Page->tunjangan_wkosis->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_tunjangan_wkosis"><?= $Page->tunjangan_wkosis->caption() ?></span></td>
...
<?php if ($Page->potongan1->Visible) { // potongan1 ?>
    <tr id="r_potongan1"<?= $Page->potongan1->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_potongan1"><?= $Page->potongan1->caption() ?></span></td>
...
<?php if ($Page->potongan2->Visible) { // potongan2 ?>
    <tr id="r_potongan2"<?= $Page->potongan2->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_potongan2"><?= $Page->potongan2->caption() ?></span></td>
...
<?php if ($Page->jumlahgaji->Visible) { // jumlahgaji ?>
    <tr id="r_jumlahgaji"<?= $Page->jumlahgaji->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_jumlahgaji"><?= $Page->jumlahgaji->caption() ?></span></td>
...
<?php if ($Page->jumgajitotal->Visible) { // jumgajitotal ?>
    <tr id="r_jumgajitotal"<?= $Page->jumgajitotal->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajisd_detil_jumgajitotal"><?= $Page->jumgajitotal->caption() ?></span></td>
