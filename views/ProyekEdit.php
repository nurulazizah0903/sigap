...
loadjs.ready(["fproyekedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fproyekedit", "x_tgl_awal", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fproyekedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fproyekedit", "x_tgl_akhir", ew.deepAssign({"useCurrent":false}, options));
});
</script>
<?php } ?>
</span>
...
<input type="hidden" name="fa_x_file_proyek" id= "fa_x_file_proyek" value="<?= (Post("fa_x_file_proyek") == "0") ? "0" : "1" ?>">
...
<?php } ?>
    ...
    <input type="hidden" data-table="proyek" data-field="x_id" data-hidden="1" name="x_id" id="x_id" value="<?= HtmlEncode($Page->id->CurrentValue) ?>">
<?php if (!$Page->IsModal) { ?>
