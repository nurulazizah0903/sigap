...
<span id="el_userlevels_userlevelid">
    <select
        ...
        data-select2-id="fuserlevelsadd_x_userlevelid"
...
loadjs.ready("fuserlevelsadd", function() {
    var options = { name: "x_userlevelid", selectId: "fuserlevelsadd_x_userlevelid" };
    if (fuserlevelsadd.lists.userlevelid.lookupOptions.length) {
        options.data = { id: "x_userlevelid", form: "fuserlevelsadd" };
    } else {
        options.ajax = { id: "x_userlevelid", form: "fuserlevelsadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
