...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fbulanadd = new ew.Form("fbulanadd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fbulanadd;
    ...
    // Form_CustomValidate
    fbulanadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbulanadd.validateRequired = ew.CLIENT_VALIDATE;
...
$Page->showMessage();
?>
<form name="fbulanadd" id="fbulanadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
