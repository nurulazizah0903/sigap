...
// Page object
$GajismaDetilAdd = &$Page;
?>
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { gajisma_detil: currentTable } });
var currentForm, currentPageID;
var fgajisma_detiladd;
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgajisma_detiladd = new ew.Form("fgajisma_detiladd", "add");
    currentPageID = ew.PAGE_ID = "add";
    currentForm = fgajisma_detiladd;

    // Add fields
    var fields = currentTable.fields;
    fgajisma_detiladd.addFields([
    ...
    // Form_CustomValidate
    fgajisma_detiladd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fgajisma_detiladd.validateRequired = ew.CLIENT_VALIDATE;

    // Dynamic selection lists
    fgajisma_detiladd.lists.pegawai_id = <?= $Page->pegawai_id->toClientList($Page) ?>;
    fgajisma_detiladd.lists.jabatan_id = <?= $Page->jabatan_id->toClientList($Page) ?>;
...
$Page->showMessage();
?>
<form name="fgajisma_detiladd" id="fgajisma_detiladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<span id="el_gajisma_detil_pegawai_id">
    <select
        ...
        data-select2-id="fgajisma_detiladd_x_pegawai_id"
...
loadjs.ready("fgajisma_detiladd", function() {
    var options = { name: "x_pegawai_id", selectId: "fgajisma_detiladd_x_pegawai_id" };
    if (fgajisma_detiladd.lists.pegawai_id.lookupOptions.length) {
        options.data = { id: "x_pegawai_id", form: "fgajisma_detiladd" };
    } else {
        options.ajax = { id: "x_pegawai_id", form: "fgajisma_detiladd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_gajisma_detil_jabatan_id">
    <select
        ...
        data-select2-id="fgajisma_detiladd_x_jabatan_id"
        data-table="gajisma_detil"
...
<script>
loadjs.ready("fgajisma_detiladd", function() {
    var options = { name: "x_jabatan_id", selectId: "fgajisma_detiladd_x_jabatan_id" };
    if (fgajisma_detiladd.lists.jabatan_id.lookupOptions.length) {
        options.data = { id: "x_jabatan_id", form: "fgajisma_detiladd" };
    } else {
        options.ajax = { id: "x_jabatan_id", form: "fgajisma_detiladd", limit: ew.LOOKUP_PAGE_SIZE };
    }
