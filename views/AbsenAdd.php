...
loadjs.ready(["wrapper", "head"], function () {
    ...
    fabsenadd.lists.pemeriksa = <?= $Page->pemeriksa->toClientList($Page) ?>;
...
<script>
loadjs.ready("fabsenadd", function() {
    fabsenadd.createAutoSuggest(Object.assign({"id":"x_pemeriksa","forceSelect":false}, ew.vars.tables.absen.fields.pemeriksa.autoSuggestOptions));
});
</script>
...
<?php
    if (in_array("absen_detil", explode(",", $Page->getCurrentDetailTable())) && $absen_detil->DetailAdd) {
?>
