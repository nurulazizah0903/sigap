...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fgajismpview = new ew.Form("fgajismpview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fgajismpview;
...
$Page->showMessage();
?>
<form name="fgajismpview" id="fgajismpview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajismp_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->tahun->Visible) { // tahun ?>
    <tr id="r_tahun"<?= $Page->tahun->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajismp_tahun"><?= $Page->tahun->caption() ?></span></td>
...
<?php if ($Page->bulan->Visible) { // bulan ?>
    <tr id="r_bulan"<?= $Page->bulan->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajismp_bulan"><?= $Page->bulan->caption() ?></span></td>
...
<?php if ($Page->tingkat->Visible) { // tingkat ?>
    <tr id="r_tingkat"<?= $Page->tingkat->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_gajismp_tingkat"><?= $Page->tingkat->caption() ?></span></td>
...
<?php
    if (in_array("gajismp_detil", explode(",", $Page->getCurrentDetailTable())) && $gajismp_detil->DetailView) {
?>
