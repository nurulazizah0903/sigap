...
loadjs.ready(["wrapper", "head"], function () {
    var $ = jQuery;
    // Form object
    fpotonganview = new ew.Form("fpotonganview", "view");
    currentPageID = ew.PAGE_ID = "view";
    currentForm = fpotonganview;
...
$Page->showMessage();
?>
<form name="fpotonganview" id="fpotonganview" class="ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->id->Visible) { // id ?>
    <tr id="r_id"<?= $Page->id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_id"><?= $Page->id->caption() ?></span></td>
...
<?php if ($Page->month->Visible) { // month ?>
    <tr id="r_month"<?= $Page->month->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_month"><?= $Page->month->caption() ?></span></td>
...
<?php if ($Page->nama->Visible) { // nama ?>
    <tr id="r_nama"<?= $Page->nama->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_nama"><?= $Page->nama->caption() ?></span></td>
...
<?php if ($Page->jenjang_id->Visible) { // jenjang_id ?>
    <tr id="r_jenjang_id"<?= $Page->jenjang_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_jenjang_id"><?= $Page->jenjang_id->caption() ?></span></td>
...
<?php if ($Page->jabatan_id->Visible) { // jabatan_id ?>
    <tr id="r_jabatan_id"<?= $Page->jabatan_id->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_jabatan_id"><?= $Page->jabatan_id->caption() ?></span></td>
...
<?php if ($Page->terlambat->Visible) { // terlambat ?>
    <tr id="r_terlambat"<?= $Page->terlambat->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_terlambat"><?= $Page->terlambat->caption() ?></span></td>
...
<?php if ($Page->value_terlambat->Visible) { // value_terlambat ?>
    <tr id="r_value_terlambat"<?= $Page->value_terlambat->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_value_terlambat"><?= $Page->value_terlambat->caption() ?></span></td>
...
<?php if ($Page->izin->Visible) { // izin ?>
    <tr id="r_izin"<?= $Page->izin->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_izin"><?= $Page->izin->caption() ?></span></td>
...
<?php if ($Page->value_izin->Visible) { // value_izin ?>
    <tr id="r_value_izin"<?= $Page->value_izin->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_value_izin"><?= $Page->value_izin->caption() ?></span></td>
...
<?php if ($Page->izinperjam->Visible) { // izinperjam ?>
    <tr id="r_izinperjam"<?= $Page->izinperjam->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_izinperjam"><?= $Page->izinperjam->caption() ?></span></td>
...
<?php if ($Page->izinperjamvalue->Visible) { // izinperjamvalue ?>
    <tr id="r_izinperjamvalue"<?= $Page->izinperjamvalue->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_izinperjamvalue"><?= $Page->izinperjamvalue->caption() ?></span></td>
...
<?php if ($Page->sakit->Visible) { // sakit ?>
    <tr id="r_sakit"<?= $Page->sakit->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_sakit"><?= $Page->sakit->caption() ?></span></td>
...
<?php if ($Page->value_sakit->Visible) { // value_sakit ?>
    <tr id="r_value_sakit"<?= $Page->value_sakit->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_value_sakit"><?= $Page->value_sakit->caption() ?></span></td>
...
<?php if ($Page->sakitperjam->Visible) { // sakitperjam ?>
    <tr id="r_sakitperjam"<?= $Page->sakitperjam->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_sakitperjam"><?= $Page->sakitperjam->caption() ?></span></td>
...
<?php if ($Page->sakitperjamvalue->Visible) { // sakitperjamvalue ?>
    <tr id="r_sakitperjamvalue"<?= $Page->sakitperjamvalue->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_sakitperjamvalue"><?= $Page->sakitperjamvalue->caption() ?></span></td>
...
<?php if ($Page->pulcep->Visible) { // pulcep ?>
    <tr id="r_pulcep"<?= $Page->pulcep->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_pulcep"><?= $Page->pulcep->caption() ?></span></td>
...
<?php if ($Page->value_pulcep->Visible) { // value_pulcep ?>
    <tr id="r_value_pulcep"<?= $Page->value_pulcep->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_value_pulcep"><?= $Page->value_pulcep->caption() ?></span></td>
...
<?php if ($Page->tidakhadir->Visible) { // tidakhadir ?>
    <tr id="r_tidakhadir"<?= $Page->tidakhadir->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_tidakhadir"><?= $Page->tidakhadir->caption() ?></span></td>
...
<?php if ($Page->value_tidakhadir->Visible) { // value_tidakhadir ?>
    <tr id="r_value_tidakhadir"<?= $Page->value_tidakhadir->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_value_tidakhadir"><?= $Page->value_tidakhadir->caption() ?></span></td>
...
<?php if ($Page->tidakhadirjam->Visible) { // tidakhadirjam ?>
    <tr id="r_tidakhadirjam"<?= $Page->tidakhadirjam->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_tidakhadirjam"><?= $Page->tidakhadirjam->caption() ?></span></td>
...
<?php if ($Page->tidakhadirjamvalue->Visible) { // tidakhadirjamvalue ?>
    <tr id="r_tidakhadirjamvalue"<?= $Page->tidakhadirjamvalue->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_tidakhadirjamvalue"><?= $Page->tidakhadirjamvalue->caption() ?></span></td>
...
<?php if ($Page->total->Visible) { // total ?>
    <tr id="r_total"<?= $Page->total->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_total"><?= $Page->total->caption() ?></span></td>
        <td data-name="total"<?= $Page->total->cellAttributes() ?>>
<span id="el_potongan_total">
...
<?php if ($Page->u_by->Visible) { // u_by ?>
    <tr id="r_u_by"<?= $Page->u_by->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_u_by"><?= $Page->u_by->caption() ?></span></td>
...
<?php if ($Page->datetime->Visible) { // datetime ?>
    <tr id="r_datetime"<?= $Page->datetime->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_potongan_datetime"><?= $Page->datetime->caption() ?></span></td>
