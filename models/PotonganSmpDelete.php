 ...
 * Page class
 */
class PotonganSmpDelete extends PotonganSmp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PotonganSmpDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PotonganSmpList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PotonganSmpList"); // Return to list
                return;
            }
        }
