...
class Proyek extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->klien->InputTextType = "text";
        $this->Fields['klien'] = &$this->klien;
        ...
        // tgl_awal
        $this->tgl_awal = new DbField(
            'proyek',
            'proyek',
            'x_tgl_awal',
            'tgl_awal',
            '`tgl_awal`',
            CastDateFieldForLike("`tgl_awal`", 0, "DB"),
            133,
            10,
            0,
            false,
        ...
        $this->tgl_awal->InputTextType = "text";
        ...
        // tgl_akhir
        $this->tgl_akhir = new DbField(
            'proyek',
            'proyek',
            'x_tgl_akhir',
            'tgl_akhir',
            '`tgl_akhir`',
            CastDateFieldForLike("`tgl_akhir`", 0, "DB"),
            133,
            10,
            0,
            false,
        ...
        $this->tgl_akhir->InputTextType = "text";
        ...
        $this->file_proyek->InputTextType = "text";
        $this->file_proyek->UploadPath = "file_proyek";
        $this->Fields['file_proyek'] = &$this->file_proyek;
    ...
    public function deleteUploadedFiles($row)
    {
        ...
        $oldFiles = EmptyValue($row['file_proyek']) ? [] : [$row['file_proyek']];
        foreach ($oldFiles as $oldFile) {
            if (file_exists($this->file_proyek->oldPhysicalUploadPath() . $oldFile)) {
    ...
    public function renderEditRow()
    {
        ...
        $this->klien->EditValue = $this->klien->CurrentValue;
        ...
        $this->tgl_awal->EditValue = FormatDateTime($this->tgl_awal->CurrentValue, $this->tgl_awal->formatPattern());
        ...
        $this->tgl_akhir->EditValue = FormatDateTime($this->tgl_akhir->CurrentValue, $this->tgl_akhir->formatPattern());
    ...
    public function getFileData($fldparm, $key, $resize, $width = 0, $height = 0, $plugins = [])
    {
        ...
        $fileNameFld = "";
        $fileTypeFld = "";
        if ($fldparm == 'file_proyek') {
            $fldName = "file_proyek";
            $fileNameFld = "file_proyek";
        } else {
