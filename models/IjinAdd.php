...
class IjinAdd extends Ijin
{
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "IjinView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tgl_ijin_awal
        $this->tgl_ijin_awal->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_ijin_awal->CurrentValue, $this->tgl_ijin_awal->formatPattern()), null, false);

        // tgl_ijin_akhir
        $this->tgl_ijin_akhir->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_ijin_akhir->CurrentValue, $this->tgl_ijin_akhir->formatPattern()), null, false);
