 ...
 * Page class
 */
class PenempatanDelete extends Penempatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenempatanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PenempatanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PenempatanList"); // Return to list
                return;
            }
        }
