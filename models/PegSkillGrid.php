 ...
 * Page class
 */
class PegSkillGrid extends PegSkill
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegSkillGrid";
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_keahlian") &&
            $CurrentForm->hasValue("o_keahlian") &&
            $this->keahlian->CurrentValue != $this->keahlian->DefaultValue &&
            !($this->keahlian->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->keahlian->CurrentValue == $this->keahlian->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_tingkat") &&
            $CurrentForm->hasValue("o_tingkat") &&
            $this->tingkat->CurrentValue != $this->tingkat->DefaultValue &&
            !($this->tingkat->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->tingkat->CurrentValue == $this->tingkat->getSessionValue())
        ) {
            return false;
        }
        if (
        ...
        if (!EmptyValue($this->bukti->Upload->Value)) {
            return false;
        }
        return true;
    }
    ...
    public function resetFormError()
    {
        ...
        $this->keahlian->clearErrorMessage();
        $this->tingkat->clearErrorMessage();
        $this->keterangan->clearErrorMessage();
        $this->bukti->clearErrorMessage();
    ...
    {
        $this->bukti->Upload->Index = $this->RowIndex;
    }
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!EmptyValue($this->bukti->CurrentValue)) {
                if ($this->RowIndex == '$rowindex$') {
                    $this->bukti->Upload->FileName = "";
                } else {
                    $this->bukti->Upload->FileName = $this->bukti->CurrentValue;
                }
            }
            if (is_numeric($this->RowIndex)) {
                RenderUploadField($this->bukti, $this->RowIndex);
            }
