 ...
 * Page class
 */
class MSakitView extends MSakit
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MSakitList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "MSakitList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "MSakitList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
