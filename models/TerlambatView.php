 ...
 * Page class
 */
class TerlambatView extends Terlambat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TerlambatView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TerlambatList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "TerlambatList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "TerlambatList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TerlambatList"), "", $this->TableVar, true);
        $pageId = "view";
