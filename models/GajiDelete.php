...
class GajiDelete extends Gaji
{
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GajiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("GajiList"); // Return to list
                return;
            }
        }
