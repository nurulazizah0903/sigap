 ...
 * Page class
 */
class PotonganSdView extends PotonganSd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PotonganSdView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PotonganSdList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PotonganSdList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PotonganSdList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
