...
class Bulan extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->nourut->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BulanList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "BulanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BulanAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BulanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BulanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BulanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BulanAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("BulanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BulanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BulanDelete", $this->getUrlParm());
    }
