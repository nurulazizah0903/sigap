 ...
 * Page class
 */
class GajismaDetilPreview extends GajismaDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismaDetilPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "gajisma") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=gajisma&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
