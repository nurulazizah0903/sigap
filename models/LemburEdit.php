 ...
 * Page class
 */
class LemburEdit extends Lembur
{
    use MessagesTrait;
    ...
    protected function editRow()
    {
        ...
        // tgl_awal_lembur
        $this->tgl_awal_lembur->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_awal_lembur->CurrentValue, $this->tgl_awal_lembur->formatPattern()), null, $this->tgl_awal_lembur->ReadOnly);

        // tgl_akhir_lembur
        $this->tgl_akhir_lembur->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_akhir_lembur->CurrentValue, $this->tgl_akhir_lembur->formatPattern()), null, $this->tgl_akhir_lembur->ReadOnly);
