 ...
 * Page class
 */
class GajisdDetilView extends GajisdDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajisdDetilView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "GajisdDetilList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "GajisdDetilList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "GajisdDetilList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
