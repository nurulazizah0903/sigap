 ...
 * Page class
 */
class JenisDinasluarView extends JenisDinasluar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisDinasluarView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "JenisDinasluarList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "JenisDinasluarList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "JenisDinasluarList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("JenisDinasluarList"), "", $this->TableVar, true);
        $pageId = "view";
