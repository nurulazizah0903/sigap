 ...
 * Page class
 */
class GajitunjanganPreview extends Gajitunjangan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajitunjanganPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "jabatan") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=jabatan&" . GetForeignKeyUrl("fk_id", $this->pidjabatan->QueryStringValue) . "";
        }
        return $url;
    }
