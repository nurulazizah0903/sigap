 ...
 * Page class
 */
class AbsenDetilDelete extends AbsenDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AbsenDetilDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AbsenDetilList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("AbsenDetilList"); // Return to list
                return;
            }
        }
