...
class Komentar extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->komentar->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("KomentarList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "KomentarEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "KomentarAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("KomentarView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("KomentarView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "KomentarAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "KomentarAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("KomentarEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("KomentarAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("KomentarDelete", $this->getUrlParm());
    }
