 ...
 * Page class
 */
class GajismaAdd extends Gajisma
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "GajismaView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("gajisma_detil", $detailTblVar) && $detailPage->DetailAdd) {
