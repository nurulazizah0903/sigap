 ...
 */
class GajismaDetil extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GajismaDetilList");
    }
    ...
    {
        global $Language;
        if ($pageName == "GajismaDetilView") {
            return $Language->phrase("View");
        } elseif ($pageName == "GajismaDetilEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GajismaDetilAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "GajismaDetilView";
            case Config("API_ADD_ACTION"):
                return "GajismaDetilAdd";
            case Config("API_EDIT_ACTION"):
                return "GajismaDetilEdit";
            case Config("API_DELETE_ACTION"):
                return "GajismaDetilDelete";
            case Config("API_LIST_ACTION"):
                return "GajismaDetilList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajismaDetilView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajismaDetilView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GajismaDetilAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GajismaDetilAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("GajismaDetilEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GajismaDetilAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GajismaDetilDelete", $this->getUrlParm());
    }
