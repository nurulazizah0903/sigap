 ...
 */
class GajitkDetil extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->pegawai_id->Lookup = new Lookup('pegawai_id', 'pegawai', false, 'id', ["nama","","",""], [], [], [], [], ["jabatan"], ["x_jabatan_id"], '', '', "`nama`");
                break;
            default:
                $this->pegawai_id->Lookup = new Lookup('pegawai_id', 'pegawai', false, 'id', ["nama","","",""], [], [], [], [], ["jabatan"], ["x_jabatan_id"], '', '', "`nama`");
                break;
        ...
        $this->voucher->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GajitkDetilList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "GajitkDetilEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GajitkDetilAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "GajitkDetilView";
            case Config("API_ADD_ACTION"):
                return "GajitkDetilAdd";
            case Config("API_EDIT_ACTION"):
                return "GajitkDetilEdit";
            case Config("API_DELETE_ACTION"):
                return "GajitkDetilDelete";
            case Config("API_LIST_ACTION"):
                return "GajitkDetilList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajitkDetilView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajitkDetilView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GajitkDetilAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GajitkDetilAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("GajitkDetilEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GajitkDetilAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GajitkDetilDelete", $this->getUrlParm());
    }
