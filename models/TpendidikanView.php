 ...
 * Page class
 */
class TpendidikanView extends Tpendidikan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TpendidikanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TpendidikanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "TpendidikanList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "TpendidikanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("TpendidikanList"), "", $this->TableVar, true);
        $pageId = "view";
