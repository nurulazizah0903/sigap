...
class Dinasluar extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // tgl_dl_awal
        $this->tgl_dl_awal = new DbField(
            'dinasluar',
            'dinasluar',
            'x_tgl_dl_awal',
            'tgl_dl_awal',
            '`tgl_dl_awal`',
            CastDateFieldForLike("`tgl_dl_awal`", 0, "DB"),
            133,
            10,
            0,
            false,
        ...
        $this->tgl_dl_awal->InputTextType = "text";
        ...
        // tgl_dl_akhir
        $this->tgl_dl_akhir = new DbField(
            'dinasluar',
            'dinasluar',
            'x_tgl_dl_akhir',
            'tgl_dl_akhir',
            '`tgl_dl_akhir`',
            CastDateFieldForLike("`tgl_dl_akhir`", 0, "DB"),
            133,
            10,
            0,
            false,
        ...
        $this->tgl_dl_akhir->InputTextType = "text";
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->jenis->Lookup = new Lookup('jenis', 'jenis_dinasluar', false, 'nama', ["nama","","",""], [], [], [], [], [], [], '', '', "`nama`");
                break;
            default:
                $this->jenis->Lookup = new Lookup('jenis', 'jenis_dinasluar', false, 'nama', ["nama","","",""], [], [], [], [], [], [], '', '', "`nama`");
                break;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DinasluarList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "DinasluarEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DinasluarAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DinasluarView";
            case Config("API_ADD_ACTION"):
                return "DinasluarAdd";
            case Config("API_EDIT_ACTION"):
                return "DinasluarEdit";
            case Config("API_DELETE_ACTION"):
                return "DinasluarDelete";
            case Config("API_LIST_ACTION"):
                return "DinasluarList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DinasluarView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DinasluarView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DinasluarAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DinasluarAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("DinasluarEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DinasluarAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DinasluarDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->tgl_dl_awal->EditValue = FormatDateTime($this->tgl_dl_awal->CurrentValue, $this->tgl_dl_awal->formatPattern());
        ...
        $this->tgl_dl_akhir->EditValue = FormatDateTime($this->tgl_dl_akhir->CurrentValue, $this->tgl_dl_akhir->formatPattern());
