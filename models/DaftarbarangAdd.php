 ...
 * Page class
 */
class DaftarbarangAdd extends Daftarbarang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DaftarbarangAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "DaftarbarangView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tgl_terima
        $this->tgl_terima->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_terima->CurrentValue, $this->tgl_terima->formatPattern()), null, false);

        // tgl_beli
        $this->tgl_beli->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_beli->CurrentValue, $this->tgl_beli->formatPattern()), null, false);
