 ...
 * Page class
 */
class PenempatanAdd extends Penempatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenempatanAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PenempatanView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tgl_mulai
        $this->tgl_mulai->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_mulai->CurrentValue, $this->tgl_mulai->formatPattern()), null, false);
