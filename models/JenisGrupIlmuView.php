 ...
 * Page class
 */
class JenisGrupIlmuView extends JenisGrupIlmu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisGrupIlmuView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "JenisGrupIlmuList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "JenisGrupIlmuList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "JenisGrupIlmuList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("JenisGrupIlmuList"), "", $this->TableVar, true);
        $pageId = "view";
