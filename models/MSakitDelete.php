 ...
 * Page class
 */
class MSakitDelete extends MSakit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MSakitDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MSakitList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MSakitList"); // Return to list
                return;
            }
        }
