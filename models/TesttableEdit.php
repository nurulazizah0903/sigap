 ...
 * Page class
 */
class TesttableEdit extends Testtable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesttableEdit";
    ...
    protected function editRow()
    {
        ...
        // nojob
        $this->nojob->setDbValueDef($rsnew, $this->nojob->CurrentValue, null, $this->nojob->ReadOnly);

        // stuffingdate
        $this->stuffingdate->setDbValueDef($rsnew, UnFormatDateTime($this->stuffingdate->CurrentValue, $this->stuffingdate->formatPattern()), null, $this->stuffingdate->ReadOnly);

        // shipper
        $this->shipper->setDbValueDef($rsnew, $this->shipper->CurrentValue, null, $this->shipper->ReadOnly);

        // stuffingloc
        $this->stuffingloc->setDbValueDef($rsnew, $this->stuffingloc->CurrentValue, null, $this->stuffingloc->ReadOnly);

        // party
        $this->party->setDbValueDef($rsnew, $this->party->CurrentValue, null, $this->party->ReadOnly);

        // typeparty
        $this->typeparty->setDbValueDef($rsnew, $this->typeparty->CurrentValue, null, $this->typeparty->ReadOnly);

        // jumlahparty
        $this->jumlahparty->setDbValueDef($rsnew, $this->jumlahparty->CurrentValue, null, $this->jumlahparty->ReadOnly);

        // shipping
        $this->shipping->setDbValueDef($rsnew, $this->shipping->CurrentValue, null, $this->shipping->ReadOnly);

        // bookingnumer
        $this->bookingnumer->setDbValueDef($rsnew, $this->bookingnumer->CurrentValue, null, $this->bookingnumer->ReadOnly);

        // shippingline
        $this->shippingline->setDbValueDef($rsnew, $this->shippingline->CurrentValue, null, $this->shippingline->ReadOnly);

        // port
        $this->port->setDbValueDef($rsnew, $this->port->CurrentValue, null, $this->port->ReadOnly);

        // surjal
        $this->surjal->setDbValueDef($rsnew, $this->surjal->CurrentValue, null, $this->surjal->ReadOnly);
