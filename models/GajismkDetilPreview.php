 ...
 * Page class
 */
class GajismkDetilPreview extends GajismkDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismkDetilPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "gajismk") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=gajismk&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
