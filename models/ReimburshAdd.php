 ...
 * Page class
 */
class ReimburshAdd extends Reimbursh
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReimburshAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ReimburshView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tgl_pengajuan
        $this->tgl_pengajuan->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_pengajuan->CurrentValue, $this->tgl_pengajuan->formatPattern()), null, false);
        ...
        // tgl_pembayaran
        $this->tgl_pembayaran->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_pembayaran->CurrentValue, $this->tgl_pembayaran->formatPattern()), null, false);
