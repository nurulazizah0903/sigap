 ...
 * Page class
 */
class GajismaDetilView extends GajismaDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismaDetilView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "GajismaDetilList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "GajismaDetilList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "GajismaDetilList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
