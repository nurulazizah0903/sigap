 ...
 * Page class
 */
class GajismpDetilGrid extends GajismpDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismpDetilGrid";
    ...
    public function emptyRow()
    {
        global $CurrentForm;
        if (
            $CurrentForm->hasValue("x_pid") &&
            $CurrentForm->hasValue("o_pid") &&
            $this->pid->CurrentValue != $this->pid->DefaultValue &&
            !($this->pid->IsForeignKey && $this->getCurrentMasterTable() != "" &&
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if ($this->pid->getSessionValue() != "") {
                ...
                if (strval($this->pid->EditValue) != "" && is_numeric($this->pid->EditValue)) {
                    ...
                    $this->pid->OldValue = $this->pid->EditValue;
                }
            }
            ...
            if (strval($this->pegawai_id->EditValue) != "" && is_numeric($this->pegawai_id->EditValue)) {
                ...
                $this->pegawai_id->OldValue = $this->pegawai_id->EditValue;
            }
            ...
            if (strval($this->jabatan_id->EditValue) != "" && is_numeric($this->jabatan_id->EditValue)) {
                ...
                $this->jabatan_id->OldValue = $this->jabatan_id->EditValue;
            }
