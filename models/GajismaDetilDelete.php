 ...
 * Page class
 */
class GajismaDetilDelete extends GajismaDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismaDetilDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GajismaDetilList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("GajismaDetilList"); // Return to list
                return;
            }
        }
