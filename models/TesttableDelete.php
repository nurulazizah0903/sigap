 ...
 * Page class
 */
class TesttableDelete extends Testtable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesttableDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TesttableList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TesttableList"); // Return to list
                return;
            }
        }
