 ...
 * Page class
 */
class ReimburshView extends Reimbursh
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReimburshView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ReimburshList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "ReimburshList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "ReimburshList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
