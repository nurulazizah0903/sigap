 ...
 * Page class
 */
class GajismkDetilDelete extends GajismkDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismkDetilDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GajismkDetilList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("GajismkDetilList"); // Return to list
                return;
            }
        }
