 ...
 * Page class
 */
class PegKeluargaGrid extends PegKeluarga
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegKeluargaGrid";
    ...
    public function emptyRow()
    {
        global $CurrentForm;
        if (
            $CurrentForm->hasValue("x_nama") &&
            $CurrentForm->hasValue("o_nama") &&
            $this->nama->CurrentValue != $this->nama->DefaultValue &&
            !($this->nama->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->nama->CurrentValue == $this->nama->getSessionValue())
        ) {
            return false;
        }
        if (
            ...
            !($this->hp->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->hp->CurrentValue == $this->hp->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_hubungan") &&
            $CurrentForm->hasValue("o_hubungan") &&
            $this->hubungan->CurrentValue != $this->hubungan->DefaultValue &&
            !($this->hubungan->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->hubungan->CurrentValue == $this->hubungan->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_tgl_lahir") &&
            $CurrentForm->hasValue("o_tgl_lahir") &&
            $this->tgl_lahir->CurrentValue != $this->tgl_lahir->DefaultValue &&
            !($this->tgl_lahir->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->tgl_lahir->CurrentValue == $this->tgl_lahir->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_jen_kel") &&
            $CurrentForm->hasValue("o_jen_kel") &&
            $this->jen_kel->CurrentValue != $this->jen_kel->DefaultValue &&
            !($this->jen_kel->IsForeignKey && $this->getCurrentMasterTable() != "" &&
            $this->jen_kel->CurrentValue == $this->jen_kel->getSessionValue())
        ) {
            return false;
        }
        if (
    ...
    public function resetFormError()
    {
        ...
        $this->hubungan->clearErrorMessage();
        $this->tgl_lahir->clearErrorMessage();
        $this->jen_kel->clearErrorMessage();
    ...
    protected function editRow()
    {
        ...
        // tgl_lahir
        $this->tgl_lahir->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_lahir->CurrentValue, $this->tgl_lahir->formatPattern()), null, $this->tgl_lahir->ReadOnly);
