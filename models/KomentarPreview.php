 ...
 * Page class
 */
class KomentarPreview extends Komentar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KomentarPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "berita") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=berita&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
