 ...
 * Page class
 */
class JenisLemburView extends JenisLembur
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisLemburView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "JenisLemburList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "JenisLemburList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "JenisLemburList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("JenisLemburList"), "", $this->TableVar, true);
        $pageId = "view";
