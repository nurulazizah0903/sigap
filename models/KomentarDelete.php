 ...
 * Page class
 */
class KomentarDelete extends Komentar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KomentarDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("KomentarList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("KomentarList"); // Return to list
                return;
            }
        }
