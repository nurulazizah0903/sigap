 ...
 * Page class
 */
class UangmukaDelete extends Uangmuka
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UangmukaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("UangmukaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("UangmukaList"); // Return to list
                return;
            }
        }
