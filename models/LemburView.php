 ...
 * Page class
 */
class LemburView extends Lembur
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "LemburList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "LemburList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "LemburList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
