 ...
 * Page class
 */
class LemburDelete extends Lembur
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LemburDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LemburList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LemburList"); // Return to list
                return;
            }
        }
