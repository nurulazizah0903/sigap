 ...
 * Page class
 */
class UangmukaAdd extends Uangmuka
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UangmukaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "UangmukaView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tgl
        $this->tgl->setDbValueDef($rsnew, UnFormatDateTime($this->tgl->CurrentValue, $this->tgl->formatPattern()), null, false);
        ...
        // tgl_tgjb
        $this->tgl_tgjb->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_tgjb->CurrentValue, $this->tgl_tgjb->formatPattern()), null, false);
