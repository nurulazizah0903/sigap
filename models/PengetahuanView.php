 ...
 * Page class
 */
class PengetahuanView extends Pengetahuan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengetahuanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PengetahuanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PengetahuanList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PengetahuanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
