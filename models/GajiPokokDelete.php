 ...
 * Page class
 */
class GajiPokokDelete extends GajiPokok
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajiPokokDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GajiPokokList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("GajiPokokList"); // Return to list
                return;
            }
        }
