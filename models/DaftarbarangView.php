 ...
 * Page class
 */
class DaftarbarangView extends Daftarbarang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DaftarbarangView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "DaftarbarangList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "DaftarbarangList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "DaftarbarangList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
