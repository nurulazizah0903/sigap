 ...
 * Page class
 */
class GajiPokokEdit extends GajiPokok
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajiPokokEdit";
    ...
    protected function editRow()
    {
        ...
        // ijazah_id
        $this->ijazah_id->setDbValueDef($rsnew, $this->ijazah_id->CurrentValue, null, $this->ijazah_id->ReadOnly);
