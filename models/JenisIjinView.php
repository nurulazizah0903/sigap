 ...
 * Page class
 */
class JenisIjinView extends JenisIjin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisIjinView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "JenisIjinList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "JenisIjinList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "JenisIjinList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
