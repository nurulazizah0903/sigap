 ...
 * Page class
 */
class JenisGrupIlmuAdd extends JenisGrupIlmu
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisGrupIlmuAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("JenisGrupIlmuList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "JenisGrupIlmuList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "JenisGrupIlmuView") {
