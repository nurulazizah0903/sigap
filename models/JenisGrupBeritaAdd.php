 ...
 * Page class
 */
class JenisGrupBeritaAdd extends JenisGrupBerita
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisGrupBeritaAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("JenisGrupBeritaList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "JenisGrupBeritaList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "JenisGrupBeritaView") {
