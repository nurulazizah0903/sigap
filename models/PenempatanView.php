 ...
 * Page class
 */
class PenempatanView extends Penempatan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PenempatanView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PenempatanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PenempatanList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PenempatanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
