 ...
 * Page class
 */
class GajismkAdd extends Gajismk
{
    use MessagesTrait;
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("GajismkList"); // No matching record, return to list
                    return;
                }
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "GajismkList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "GajismkView") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->bulan->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->bulan->setFormValue($val, true, $validate);
            }
        }
            ...
            if ($curVal != "") {
                ...
                if ($this->bulan->EditValue === null) { // Lookup from database
                    ...
                    if ($ari > 0) { // Lookup values found
                        ...
                        $this->bulan->EditValue = HtmlEncode(FormatNumber($this->bulan->CurrentValue, $this->bulan->formatPattern()));
                    }
                }
            } else {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("gajismk_detil", $detailTblVar) && $detailPage->DetailAdd) {
