 ...
 * Page class
 */
class PegDokumenDelete extends PegDokumen
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegDokumenDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PegDokumenList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PegDokumenList"); // Return to list
                return;
            }
        }
