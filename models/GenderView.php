 ...
 * Page class
 */
class GenderView extends Gender
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "GenderList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "GenderList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "GenderList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
