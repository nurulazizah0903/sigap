 ...
 * Page class
 */
class GajismpDetilPreview extends GajismpDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismpDetilPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "gajismp") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=gajismp&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
