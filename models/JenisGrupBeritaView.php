 ...
 * Page class
 */
class JenisGrupBeritaView extends JenisGrupBerita
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisGrupBeritaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "JenisGrupBeritaList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "JenisGrupBeritaList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "JenisGrupBeritaList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("JenisGrupBeritaList"), "", $this->TableVar, true);
        $pageId = "view";
