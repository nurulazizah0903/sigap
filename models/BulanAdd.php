...
class BulanAdd extends Bulan
{
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("BulanList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "BulanList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "BulanView") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->nourut->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->nourut->setFormValue($val, true, $validate);
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            // nourut
            $this->nourut->setupEditAttributes();
            ...
            if (strval($this->nourut->EditValue) != "" && is_numeric($this->nourut->EditValue)) {
                $this->nourut->EditValue = FormatNumber($this->nourut->EditValue, null);
            }
    ...
    protected function validateForm()
    {
        ...
        if ($this->nourut->Required) {
            if (!$this->nourut->IsDetailKey && EmptyValue($this->nourut->FormValue)) {
                $this->nourut->addErrorMessage(str_replace("%s", $this->nourut->caption(), $this->nourut->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->nourut->FormValue)) {
            $this->nourut->addErrorMessage($this->nourut->getErrorMessage(false));
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // nourut
        $this->nourut->setDbValueDef($rsnew, $this->nourut->CurrentValue, null, false);
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("BulanList"), "", $this->TableVar, true);
