 ...
 * Page class
 */
class MTidakhadirDelete extends MTidakhadir
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MTidakhadirDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MTidakhadirList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MTidakhadirList"); // Return to list
                return;
            }
        }
