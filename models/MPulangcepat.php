 ...
 */
class MPulangcepat extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->perhari->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MPulangcepatList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "MPulangcepatEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MPulangcepatAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MPulangcepatView";
            case Config("API_ADD_ACTION"):
                return "MPulangcepatAdd";
            case Config("API_EDIT_ACTION"):
                return "MPulangcepatEdit";
            case Config("API_DELETE_ACTION"):
                return "MPulangcepatDelete";
            case Config("API_LIST_ACTION"):
                return "MPulangcepatList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MPulangcepatView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MPulangcepatView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MPulangcepatAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MPulangcepatAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MPulangcepatEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MPulangcepatAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MPulangcepatDelete", $this->getUrlParm());
    }
