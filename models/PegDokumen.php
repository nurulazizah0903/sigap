 ...
 */
class PegDokumen extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->nama_dokumen->InputTextType = "text";
        $this->Fields['nama_dokumen'] = &$this->nama_dokumen;

        // file_dokumen
        $this->file_dokumen = new DbField(
            'peg_dokumen',
            'peg_dokumen',
            'x_file_dokumen',
            'file_dokumen',
        ...
        $this->file_dokumen->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PegDokumenList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PegDokumenView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PegDokumenEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PegDokumenAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PegDokumenView";
            case Config("API_ADD_ACTION"):
                return "PegDokumenAdd";
            case Config("API_EDIT_ACTION"):
                return "PegDokumenEdit";
            case Config("API_DELETE_ACTION"):
                return "PegDokumenDelete";
            case Config("API_LIST_ACTION"):
                return "PegDokumenList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PegDokumenView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PegDokumenView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PegDokumenAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PegDokumenAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("PegDokumenEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PegDokumenAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PegDokumenDelete", $this->getUrlParm());
    }
