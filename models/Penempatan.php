...
class Penempatan extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->project->InputTextType = "text";
        switch ($CurrentLanguage) {
            case "en-US":
                $this->project->Lookup = new Lookup('project', 'proyek', false, 'proyek', ["proyek","","",""], [], [], [], [], [], [], '', '', "`proyek`");
                break;
            default:
                $this->project->Lookup = new Lookup('project', 'proyek', false, 'proyek', ["proyek","","",""], [], [], [], [], [], [], '', '', "`proyek`");
                break;
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->jabatan->Lookup = new Lookup('jabatan', 'jabatan', false, 'nama_jabatan', ["nama_jabatan","","",""], [], [], [], [], [], [], '', '', "`nama_jabatan`");
                break;
            default:
                $this->jabatan->Lookup = new Lookup('jabatan', 'jabatan', false, 'nama_jabatan', ["nama_jabatan","","",""], [], [], [], [], [], [], '', '', "`nama_jabatan`");
                break;
        ...
        // tgl_mulai
        $this->tgl_mulai = new DbField(
            'penempatan',
            'penempatan',
            'x_tgl_mulai',
            'tgl_mulai',
            '`tgl_mulai`',
            CastDateFieldForLike("`tgl_mulai`", 0, "DB"),
            133,
            10,
            0,
            false,
        ...
        $this->tgl_mulai->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PenempatanList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PenempatanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PenempatanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PenempatanView";
            case Config("API_ADD_ACTION"):
                return "PenempatanAdd";
            case Config("API_EDIT_ACTION"):
                return "PenempatanEdit";
            case Config("API_DELETE_ACTION"):
                return "PenempatanDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PenempatanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PenempatanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PenempatanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PenempatanAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("PenempatanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PenempatanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PenempatanDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->tgl_mulai->EditValue = FormatDateTime($this->tgl_mulai->CurrentValue, $this->tgl_mulai->formatPattern());
