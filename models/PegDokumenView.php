 ...
 * Page class
 */
class PegDokumenView extends PegDokumen
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegDokumenView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PegDokumenList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PegDokumenList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PegDokumenList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
