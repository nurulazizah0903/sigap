 ...
 * Page class
 */
class TerlambatDelete extends Terlambat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TerlambatDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TerlambatList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TerlambatList"); // Return to list
                return;
            }
        }
