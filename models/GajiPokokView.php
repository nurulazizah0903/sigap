 ...
 * Page class
 */
class GajiPokokView extends GajiPokok
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajiPokokView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "GajiPokokList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "GajiPokokList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "GajiPokokList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
