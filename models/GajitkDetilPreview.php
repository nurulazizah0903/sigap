 ...
 * Page class
 */
class GajitkDetilPreview extends GajitkDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajitkDetilPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "gajitk") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=gajitk&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
