...
class Pengetahuan extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->grup->InputTextType = "text";
        switch ($CurrentLanguage) {
            case "en-US":
                $this->grup->Lookup = new Lookup('grup', 'jenis_grup_ilmu', false, 'nama', ["nama","","",""], [], [], [], [], [], [], '', '', "`nama`");
                break;
            default:
                $this->grup->Lookup = new Lookup('grup', 'jenis_grup_ilmu', false, 'nama', ["nama","","",""], [], [], [], [], [], [], '', '', "`nama`");
                break;
        ...
        $this->isi->InputTextType = "text";
        $this->Fields['isi'] = &$this->isi;

        // sumber_url
        $this->sumber_url = new DbField(
            'pengetahuan',
            'pengetahuan',
            'x_sumber_url',
            'sumber_url',
        ...
        $this->sumber_url->InputTextType = "text";
        $this->Fields['sumber_url'] = &$this->sumber_url;

        // visual
        $this->visual = new DbField(
            'pengetahuan',
            'pengetahuan',
            'x_visual',
            'visual',
        ...
        $this->visual->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PengetahuanList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "PengetahuanEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PengetahuanAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PengetahuanView";
            case Config("API_ADD_ACTION"):
                return "PengetahuanAdd";
            case Config("API_EDIT_ACTION"):
                return "PengetahuanEdit";
            case Config("API_DELETE_ACTION"):
                return "PengetahuanDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PengetahuanView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PengetahuanView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PengetahuanAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PengetahuanAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("PengetahuanEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PengetahuanAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PengetahuanDelete", $this->getUrlParm());
    }
