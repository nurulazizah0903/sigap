 ...
 */
class MTidakhadir extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->perjam_value->InputTextType = "text";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MTidakhadirList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "MTidakhadirEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MTidakhadirAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MTidakhadirView";
            case Config("API_ADD_ACTION"):
                return "MTidakhadirAdd";
            case Config("API_EDIT_ACTION"):
                return "MTidakhadirEdit";
            case Config("API_DELETE_ACTION"):
                return "MTidakhadirDelete";
            case Config("API_LIST_ACTION"):
                return "MTidakhadirList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MTidakhadirView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MTidakhadirView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MTidakhadirAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MTidakhadirAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MTidakhadirEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MTidakhadirAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MTidakhadirDelete", $this->getUrlParm());
    }
