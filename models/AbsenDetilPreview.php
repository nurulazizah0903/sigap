 ...
 * Page class
 */
class AbsenDetilPreview extends AbsenDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AbsenDetilPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "absen") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=absen&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
