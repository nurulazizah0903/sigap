 ...
 * Page class
 */
class GajitunjanganList extends Gajitunjangan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajitunjanganList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "GajitunjanganDelete";
        $this->MultiUpdateUrl = "GajitunjanganUpdate";
        ...
        if ($opt && !$this->isExport() && !$this->CurrentAction) {
            ...
            foreach ($this->ListActions->Items as $listaction) {
                ...
                if ($listaction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    $link = "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fgajitunjanganlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button></li>";
                    if ($link != "") {
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" data-ew-action=\"submit\" form=\"fgajitunjanganlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listaction->toDataAttrs() . ">" . $icon . $listaction->Caption . "</button>";
                        }
                    }
                }
            }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("value_kehadiran", $this->createColumnOption("value_kehadiran"));
            ...
            $option->add("reward", $this->createColumnOption("reward"));
            $option->add("lembur", $this->createColumnOption("lembur"));
            $option->add("piket", $this->createColumnOption("piket"));
            $option->add("inval", $this->createColumnOption("inval"));
            $option->add("jam_lebih", $this->createColumnOption("jam_lebih"));
            $option->add("ekstrakuri", $this->createColumnOption("ekstrakuri"));
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fgajitunjangansrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fgajitunjangansrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fgajitunjanganlist"' . $listaction->toDataAttrs() . '>' . $icon . '</button>';
