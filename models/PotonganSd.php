 ...
 */
class PotonganSd extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PotonganSdList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PotonganSdView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PotonganSdEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PotonganSdAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PotonganSdView";
            case Config("API_ADD_ACTION"):
                return "PotonganSdAdd";
            case Config("API_EDIT_ACTION"):
                return "PotonganSdEdit";
            case Config("API_DELETE_ACTION"):
                return "PotonganSdDelete";
            case Config("API_LIST_ACTION"):
                return "PotonganSdList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PotonganSdView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PotonganSdView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PotonganSdAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PotonganSdAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("PotonganSdEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PotonganSdAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PotonganSdDelete", $this->getUrlParm());
    }
