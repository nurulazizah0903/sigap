 ...
 * Page class
 */
class TesttableView extends Testtable
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TesttableView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "TesttableList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "TesttableList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "TesttableList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
