...
class Gajismk extends DbTable
{
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "gajismk_detil") {
            $detailUrl = Container("gajismk_detil")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "GajismkList";
        }
        return $detailUrl;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("gajismk_detil")->loadRs("`pid` = " . QuotedValue($rsold['id'], DATATYPE_NUMBER, 'DB'))->fetchAllAssociative();
            foreach ($rswrk as $rsdtlold) {
                ...
                $success = Container("gajismk_detil")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("gajismk_detil")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("gajismk_detil")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GajismkList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "GajismkEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GajismkAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajismkView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajismkView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GajismkAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GajismkAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajismkEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajismkEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajismkAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajismkAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GajismkDelete", $this->getUrlParm());
    }
