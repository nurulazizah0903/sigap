 ...
 * Page class
 */
class PotonganDelete extends Potongan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PotonganDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PotonganList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PotonganList"); // Return to list
                return;
            }
        }
