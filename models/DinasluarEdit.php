 ...
 * Page class
 */
class DinasluarEdit extends Dinasluar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DinasluarEdit";
    ...
    protected function editRow()
    {
        ...
        // tgl_dl_awal
        $this->tgl_dl_awal->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_dl_awal->CurrentValue, $this->tgl_dl_awal->formatPattern()), null, $this->tgl_dl_awal->ReadOnly);

        // tgl_dl_akhir
        $this->tgl_dl_akhir->setDbValueDef($rsnew, UnFormatDateTime($this->tgl_dl_akhir->CurrentValue, $this->tgl_dl_akhir->formatPattern()), null, $this->tgl_dl_akhir->ReadOnly);
