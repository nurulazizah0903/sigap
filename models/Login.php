...
class Login extends Pegawai
{
    ...
    public function run()
    {
        ...
        $this->Username = new DbField("pegawai", "pegawai", "username", "username", "username", "", 202, 255, -1, false, "", false, false, false);
        $this->Username->EditAttrs->appendClass("form-control ew-form-control");
        $this->Password = new DbField("pegawai", "pegawai", "password", "password", "password", "", 202, 255, -1, false, "", false, false, false);
        $this->Password->EditAttrs->appendClass("form-control ew-form-control");
        if (Config("ENCRYPTED_PASSWORD")) {
            $this->Password->Raw = true;
        }
        $this->LoginType = new DbField("pegawai", "pegawai", "type", "logintype", "logintype", "", 202, 255, -1, false, "", false, false, false);
    ...
    {
        //Log("User Logged In");`
        $_SESSION[EW_SESSION_LANGUAGE_ID] = "id";
    }
