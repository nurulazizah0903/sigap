 ...
 */
class GajisdDetil extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GajisdDetilList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "GajisdDetilEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GajisdDetilAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "GajisdDetilView";
            case Config("API_ADD_ACTION"):
                return "GajisdDetilAdd";
            case Config("API_EDIT_ACTION"):
                return "GajisdDetilEdit";
            case Config("API_DELETE_ACTION"):
                return "GajisdDetilDelete";
            case Config("API_LIST_ACTION"):
                return "GajisdDetilList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajisdDetilView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajisdDetilView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GajisdDetilAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GajisdDetilAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("GajisdDetilEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GajisdDetilAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GajisdDetilDelete", $this->getUrlParm());
    }
