 ...
 * Page class
 */
class GajismpDetilView extends GajismpDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismpDetilView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "GajismpDetilList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "GajismpDetilList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "GajismpDetilList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
