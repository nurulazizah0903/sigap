 ...
 * Page class
 */
class JenisIjinDelete extends JenisIjin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisIjinDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("JenisIjinList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("JenisIjinList"); // Return to list
                return;
            }
        }
