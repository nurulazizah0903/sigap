 ...
 * Page class
 */
class PotonganSmpView extends PotonganSmp
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PotonganSmpView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PotonganSmpList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PotonganSmpList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PotonganSmpList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
