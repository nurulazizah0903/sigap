 ...
 * Page class
 */
class DinasluarView extends Dinasluar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DinasluarView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "DinasluarList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "DinasluarList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "DinasluarList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
