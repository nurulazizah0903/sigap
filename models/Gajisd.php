...
class Gajisd extends DbTable
{
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "gajisd_detil") {
            $detailUrl = Container("gajisd_detil")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "GajisdList";
        }
        return $detailUrl;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("gajisd_detil")->loadRs("`pid` = " . QuotedValue($rsold['id'], DATATYPE_NUMBER, 'DB'))->fetchAllAssociative();
            foreach ($rswrk as $rsdtlold) {
                ...
                $success = Container("gajisd_detil")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("gajisd_detil")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("gajisd_detil")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GajisdList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "GajisdEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GajisdAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajisdView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajisdView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GajisdAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GajisdAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajisdEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajisdEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajisdAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajisdAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GajisdDelete", $this->getUrlParm());
    }
