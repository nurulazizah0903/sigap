 ...
 * Page class
 */
class PegSkillDelete extends PegSkill
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegSkillDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PegSkillList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PegSkillList"); // Return to list
                return;
            }
        }
