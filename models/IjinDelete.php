...
class IjinDelete extends Ijin
{
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IjinList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("IjinList"); // Return to list
                return;
            }
        }
