...
class Gajisma extends DbTable
{
    ...
    public function getDetailUrl()
    {
        ...
        if ($this->getCurrentDetailTable() == "gajisma_detil") {
            $detailUrl = Container("gajisma_detil")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_id", $this->id->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "GajismaList";
        }
        return $detailUrl;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($cascadeUpdate) {
            $rswrk = Container("gajisma_detil")->loadRs("`pid` = " . QuotedValue($rsold['id'], DATATYPE_NUMBER, 'DB'))->fetchAllAssociative();
            foreach ($rswrk as $rsdtlold) {
                ...
                $success = Container("gajisma_detil")->rowUpdating($rsdtlold, $rsdtlnew);
                if ($success) {
                    $success = Container("gajisma_detil")->update($rscascade, $rskey, $rsdtlold);
                }
                if (!$success) {
                    return false;
                }
                // Call Row_Updated event
                Container("gajisma_detil")->rowUpdated($rsdtlold, $rsdtlnew);
            }
        }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GajismaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "GajismaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GajismaAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajismaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajismaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GajismaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GajismaAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajismaEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajismaEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajismaAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajismaAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GajismaDelete", $this->getUrlParm());
    }
