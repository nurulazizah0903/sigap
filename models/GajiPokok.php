 ...
 */
class GajiPokok extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ijazah_id->InputTextType = "text";
        switch ($CurrentLanguage) {
            case "en-US":
                $this->ijazah_id->Lookup = new Lookup('ijazah_id', 'ijazah', false, 'id', ["name","","",""], [], [], [], [], [], [], '', '', "`name`");
                break;
            default:
                $this->ijazah_id->Lookup = new Lookup('ijazah_id', 'ijazah', false, 'id', ["name","","",""], [], [], [], [], [], [], '', '', "`name`");
                break;
        }
        $this->ijazah_id->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Fields['ijazah_id'] = &$this->ijazah_id;

        // lama_kerja
        $this->lama_kerja = new DbField(
            'gaji_pokok',
            'gaji_pokok',
            'x_lama_kerja',
            'lama_kerja',
        ...
        $this->lama_kerja->InputTextType = "text";
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->jenis->Lookup = new Lookup('jenis', 'gaji_pokok', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
            default:
                $this->jenis->Lookup = new Lookup('jenis', 'gaji_pokok', false, '', ["","","",""], [], [], [], [], [], [], '', '', "");
                break;
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->ijazah_id->DbValue = $row['ijazah_id'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GajiPokokList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "GajiPokokEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GajiPokokAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "GajiPokokView";
            case Config("API_ADD_ACTION"):
                return "GajiPokokAdd";
            case Config("API_EDIT_ACTION"):
                return "GajiPokokEdit";
            case Config("API_DELETE_ACTION"):
                return "GajiPokokDelete";
            case Config("API_LIST_ACTION"):
                return "GajiPokokList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajiPokokView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajiPokokView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GajiPokokAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GajiPokokAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("GajiPokokEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GajiPokokAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GajiPokokDelete", $this->getUrlParm());
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->ijazah_id->EditValue = $this->ijazah_id->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->ijazah_id);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->ijazah_id);
