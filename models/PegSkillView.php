 ...
 * Page class
 */
class PegSkillView extends PegSkill
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegSkillView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PegSkillList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PegSkillList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PegSkillList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
