 ...
 * Page class
 */
class GajismpDetilDelete extends GajismpDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismpDetilDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GajismpDetilList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("GajismpDetilList"); // Return to list
                return;
            }
        }
