 ...
 * Page class
 */
class DaftarbarangDelete extends Daftarbarang
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DaftarbarangDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DaftarbarangList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DaftarbarangList"); // Return to list
                return;
            }
        }
