 ...
 * Page class
 */
class GajismaEdit extends Gajisma
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismaEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("GajismaList"); // No matching record, return to list
                        return;
                    }
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "GajismaList") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("gajisma_detil", $detailTblVar) && $detailPage->DetailEdit) {
