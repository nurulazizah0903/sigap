 ...
 * Page class
 */
class GajisdDetilPreview extends GajisdDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajisdDetilPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "gajisd") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=gajisd&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
