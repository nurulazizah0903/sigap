 ...
 * Page class
 */
class PegDokumenAdd extends PegDokumen
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegDokumenAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("PegDokumenList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "PegDokumenList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "PegDokumenView") {
    ...
    public function renderRow()
    {
        ...
        // nama_dokumen
        $this->nama_dokumen->RowCssClass = "row";

        // file_dokumen
        $this->file_dokumen->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("PegDokumenList"), "", $this->TableVar, true);
