 ...
 * Page class
 */
class DinasluarDelete extends Dinasluar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DinasluarDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DinasluarList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DinasluarList"); // Return to list
                return;
            }
        }
