...
class MSakit extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MSakitList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "MSakitEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MSakitAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MSakitView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MSakitView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MSakitAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MSakitAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MSakitEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MSakitAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MSakitDelete", $this->getUrlParm());
    }
