 ...
 */
class GajismkDetil extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        switch ($CurrentLanguage) {
            case "en-US":
                $this->pegawai_id->Lookup = new Lookup('pegawai_id', 'pegawai', false, 'id', ["nama","","",""], [], [], [], [], [], [], '', '', "`nama`");
                break;
            default:
                $this->pegawai_id->Lookup = new Lookup('pegawai_id', 'pegawai', false, 'id', ["nama","","",""], [], [], [], [], [], [], '', '', "`nama`");
                break;
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GajismkDetilList");
    }
    ...
    {
        global $Language;
        if ($pageName == "GajismkDetilView") {
            return $Language->phrase("View");
        } elseif ($pageName == "GajismkDetilEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GajismkDetilAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "GajismkDetilView";
            case Config("API_ADD_ACTION"):
                return "GajismkDetilAdd";
            case Config("API_EDIT_ACTION"):
                return "GajismkDetilEdit";
            case Config("API_DELETE_ACTION"):
                return "GajismkDetilDelete";
            case Config("API_LIST_ACTION"):
                return "GajismkDetilList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GajismkDetilView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GajismkDetilView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GajismkDetilAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GajismkDetilAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("GajismkDetilEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GajismkDetilAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GajismkDetilDelete", $this->getUrlParm());
    }
