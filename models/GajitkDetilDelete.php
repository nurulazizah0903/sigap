 ...
 * Page class
 */
class GajitkDetilDelete extends GajitkDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajitkDetilDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GajitkDetilList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("GajitkDetilList"); // Return to list
                return;
            }
        }
