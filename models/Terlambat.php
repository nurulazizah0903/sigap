...
class Terlambat extends DbTable
{
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TerlambatList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TerlambatView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TerlambatEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TerlambatAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_EDIT_ACTION"):
                return "TerlambatEdit";
            case Config("API_DELETE_ACTION"):
                return "TerlambatDelete";
            case Config("API_LIST_ACTION"):
                return "TerlambatList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TerlambatView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TerlambatView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TerlambatAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TerlambatAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TerlambatEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TerlambatAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TerlambatDelete", $this->getUrlParm());
    }
