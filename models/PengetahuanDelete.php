 ...
 * Page class
 */
class PengetahuanDelete extends Pengetahuan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PengetahuanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PengetahuanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PengetahuanList"); // Return to list
                return;
            }
        }
