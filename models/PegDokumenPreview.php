 ...
 * Page class
 */
class PegDokumenPreview extends PegDokumen
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegDokumenPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "pegawai") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=pegawai&" . GetForeignKeyUrl("fk_id", $this->pid->QueryStringValue) . "";
        }
        return $url;
    }
