...
class PegawaiAdd extends Pegawai
{
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->aktif->DefaultValue = 1;
        $this->aktif->OldValue = $this->aktif->DefaultValue;
    }
    ...
    protected function validateForm()
    {
        ...
        if (in_array("peg_dokumen", $detailTblVar) && $detailPage->DetailAdd) {
            $validateForm = $validateForm && $detailPage->validateGridForm();
        }
        $detailPage = Container("PegKeluargaGrid");
        if (in_array("peg_keluarga", $detailTblVar) && $detailPage->DetailAdd) {
            $validateForm = $validateForm && $detailPage->validateGridForm();
        }
        $detailPage = Container("PegSkillGrid");
        if (in_array("peg_skill", $detailTblVar) && $detailPage->DetailAdd) {
            $validateForm = $validateForm && $detailPage->validateGridForm();
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // tgllahir
        $this->tgllahir->setDbValueDef($rsnew, UnFormatDateTime($this->tgllahir->CurrentValue, $this->tgllahir->formatPattern()), null, false);
        ...
        // mulai_bekerja
        $this->mulai_bekerja->setDbValueDef($rsnew, UnFormatDateTime($this->mulai_bekerja->CurrentValue, $this->mulai_bekerja->formatPattern()), null, false);
