 ...
 * Page class
 */
class GajitkDetilView extends GajitkDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajitkDetilView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "GajitkDetilList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "GajitkDetilList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "GajitkDetilList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
