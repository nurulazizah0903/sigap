 ...
 * Page class
 */
class PegKeluargaView extends PegKeluarga
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegKeluargaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "PegKeluargaList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "PegKeluargaList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "PegKeluargaList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
