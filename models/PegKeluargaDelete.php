 ...
 * Page class
 */
class PegKeluargaDelete extends PegKeluarga
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PegKeluargaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PegKeluargaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PegKeluargaList"); // Return to list
                return;
            }
        }
