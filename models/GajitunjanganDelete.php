 ...
 * Page class
 */
class GajitunjanganDelete extends Gajitunjangan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajitunjanganDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GajitunjanganList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("GajitunjanganList"); // Return to list
                return;
            }
        }
