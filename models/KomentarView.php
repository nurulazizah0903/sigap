 ...
 * Page class
 */
class KomentarView extends Komentar
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "KomentarView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "KomentarList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "KomentarList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "KomentarList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
