...
class ProyekList extends Proyek
{
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fproyeksrch", $filters);
    ...
    protected function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->klien;
        $searchFlds[] = &$this->proyek;
        $searchFlds[] = &$this->file_proyek;
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $option->add("klien", $this->createColumnOption("klien"));
            $option->add("proyek", $this->createColumnOption("proyek"));
            $option->add("tgl_awal", $this->createColumnOption("tgl_awal"));
            $option->add("tgl_akhir", $this->createColumnOption("tgl_akhir"));
            $option->add("file_proyek", $this->createColumnOption("file_proyek"));
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fproyeksrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
