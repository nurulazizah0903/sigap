 ...
 * Page class
 */
class UangmukaView extends Uangmuka
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "UangmukaView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "UangmukaList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "UangmukaList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "UangmukaList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
