 ...
 * Page class
 */
class GajismkDetilView extends GajismkDetil
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GajismkDetilView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "GajismkDetilList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "GajismkDetilList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "GajismkDetilList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
