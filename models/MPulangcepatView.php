 ...
 * Page class
 */
class MPulangcepatView extends MPulangcepat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MPulangcepatView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "MPulangcepatList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                        ...
                        if (!$res) { // Load record based on key
                            ...
                            $returnUrl = "MPulangcepatList"; // No matching record, return to list
                        }
                    break;
            }
        } else {
            $returnUrl = "MPulangcepatList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
