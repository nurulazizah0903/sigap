 ...
 * Page class
 */
class JenisIjinAdd extends JenisIjin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "JenisIjinAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$loaded) { // Record not loaded
                    ...
                    $this->terminate("JenisIjinList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "JenisIjinList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "JenisIjinView") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->valueperjam->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->valueperjam->setFormValue($val, true, $validate);
            }
        }
    ...
    public function renderRow()
    {
        ...
        // valueperjam
        $this->valueperjam->RowCssClass = "row";
    ...
    protected function validateForm()
    {
        ...
        if ($this->valueperjam->Required) {
            if (!$this->valueperjam->IsDetailKey && EmptyValue($this->valueperjam->FormValue)) {
                $this->valueperjam->addErrorMessage(str_replace("%s", $this->valueperjam->caption(), $this->valueperjam->RequiredErrorMessage));
            }
        }
        if (!CheckInteger($this->valueperjam->FormValue)) {
            $this->valueperjam->addErrorMessage($this->valueperjam->getErrorMessage(false));
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("JenisIjinList"), "", $this->TableVar, true);
