 ...
 * Page class
 */
class MPulangcepatDelete extends MPulangcepat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MPulangcepatDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MPulangcepatList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MPulangcepatList"); // Return to list
                return;
            }
        }
