...
<?php } ?>
<?php if ($gaji_tu_sma_view->by->Visible) { // by ?>
	<tr id="r_by">
		<td class="<?php echo $gaji_tu_sma_view->TableLeftColumnClass ?>"><span id="elh_gaji_tu_sma_by"><?php echo $gaji_tu_sma_view->by->caption() ?></span></td>
		<td data-name="by" <?php echo $gaji_tu_sma_view->by->cellAttributes() ?>>
<span id="el_gaji_tu_sma_by">
<span<?php echo $gaji_tu_sma_view->by->viewAttributes() ?>><?php echo $gaji_tu_sma_view->by->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_tu_sma_view->value_inval->Visible) { // value_inval ?>
	<tr id="r_value_inval">
		<td class="<?php echo $gaji_tu_sma_view->TableLeftColumnClass ?>"><span id="elh_gaji_tu_sma_value_inval"><?php echo $gaji_tu_sma_view->value_inval->caption() ?></span></td>
		<td data-name="value_inval" <?php echo $gaji_tu_sma_view->value_inval->cellAttributes() ?>>
<span id="el_gaji_tu_sma_value_inval">
<span<?php echo $gaji_tu_sma_view->value_inval->viewAttributes() ?>><?php echo $gaji_tu_sma_view->value_inval->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
