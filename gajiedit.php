...
<?php if ($gaji_edit->type->Visible) { // type ?>
	<div id="r_type" class="form-group row">
		<label id="elh_gaji_type" for="x_type" class="<?php echo $gaji_edit->LeftColumnClass ?>"><?php echo $gaji_edit->type->caption() ?><?php echo $gaji_edit->type->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_edit->RightColumnClass ?>"><div <?php echo $gaji_edit->type->cellAttributes() ?>>
<span id="el_gaji_type">
<input type="text" data-table="gaji" data-field="x_type" name="x_type" id="x_type" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_edit->type->getPlaceHolder()) ?>" value="<?php echo $gaji_edit->type->EditValue ?>"<?php echo $gaji_edit->type->editAttributes() ?>>
</span>
...
<?php if ($gaji_edit->jenis_guru->Visible) { // jenis_guru ?>
	<div id="r_jenis_guru" class="form-group row">
		<label id="elh_gaji_jenis_guru" for="x_jenis_guru" class="<?php echo $gaji_edit->LeftColumnClass ?>"><?php echo $gaji_edit->jenis_guru->caption() ?><?php echo $gaji_edit->jenis_guru->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_edit->RightColumnClass ?>"><div <?php echo $gaji_edit->jenis_guru->cellAttributes() ?>>
<span id="el_gaji_jenis_guru">
<input type="text" data-table="gaji" data-field="x_jenis_guru" name="x_jenis_guru" id="x_jenis_guru" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_edit->jenis_guru->getPlaceHolder()) ?>" value="<?php echo $gaji_edit->jenis_guru->EditValue ?>"<?php echo $gaji_edit->jenis_guru->editAttributes() ?>>
</span>
...
<?php if ($gaji_edit->tambahan->Visible) { // tambahan ?>
	<div id="r_tambahan" class="form-group row">
		<label id="elh_gaji_tambahan" for="x_tambahan" class="<?php echo $gaji_edit->LeftColumnClass ?>"><?php echo $gaji_edit->tambahan->caption() ?><?php echo $gaji_edit->tambahan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $gaji_edit->RightColumnClass ?>"><div <?php echo $gaji_edit->tambahan->cellAttributes() ?>>
<span id="el_gaji_tambahan">
<input type="text" data-table="gaji" data-field="x_tambahan" name="x_tambahan" id="x_tambahan" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_edit->tambahan->getPlaceHolder()) ?>" value="<?php echo $gaji_edit->tambahan->EditValue ?>"<?php echo $gaji_edit->tambahan->editAttributes() ?>>
</span>
