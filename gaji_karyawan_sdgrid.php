...
loadjs.ready("head", function() {
	...
	fgaji_karyawan_sdgrid.validate = function() {
		...
		for (var i = startcnt; i <= rowcnt; i++) {
			...
			if (checkrow) {
				addcnt++;
			<?php if ($gaji_karyawan_sd_grid->jp->Required) { ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sd_grid->jp->caption(), $gaji_karyawan_sd_grid->jp->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_jp");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sd_grid->jp->errorMessage()) ?>");
			...
			<?php if ($gaji_karyawan_sd_grid->jabatan_id->Required) { ?>
				elm = this.getElements("x" + infix + "_jabatan_id");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sd_grid->jabatan_id->caption(), $gaji_karyawan_sd_grid->jabatan_id->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_jabatan_id");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sd_grid->jabatan_id->errorMessage()) ?>");
			<?php if ($gaji_karyawan_sd_grid->kehadiran->Required) { ?>
				elm = this.getElements("x" + infix + "_kehadiran");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sd_grid->kehadiran->caption(), $gaji_karyawan_sd_grid->kehadiran->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_kehadiran");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sd_grid->kehadiran->errorMessage()) ?>");
			<?php if ($gaji_karyawan_sd_grid->gapok->Required) { ?>
				elm = this.getElements("x" + infix + "_gapok");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sd_grid->gapok->caption(), $gaji_karyawan_sd_grid->gapok->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_gapok");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sd_grid->gapok->errorMessage()) ?>");
			<?php if ($gaji_karyawan_sd_grid->value_reward->Required) { ?>
				elm = this.getElements("x" + infix + "_value_reward");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sd_grid->value_reward->caption(), $gaji_karyawan_sd_grid->value_reward->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_value_reward");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sd_grid->value_reward->errorMessage()) ?>");
			<?php if ($gaji_karyawan_sd_grid->value_inval->Required) { ?>
				elm = this.getElements("x" + infix + "_value_inval");
				if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
					return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $gaji_karyawan_sd_grid->value_inval->caption(), $gaji_karyawan_sd_grid->value_inval->RequiredErrorMessage)) ?>");
			<?php } ?>
				elm = this.getElements("x" + infix + "_value_inval");
				if (elm && !ew.checkInteger(elm.value))
					return this.onError(elm, "<?php echo JsEncode($gaji_karyawan_sd_grid->value_inval->errorMessage()) ?>");
	...
	fgaji_karyawan_sdgrid.lists["x_jabatan_id"] = <?php echo $gaji_karyawan_sd_grid->jabatan_id->Lookup->toClientList($gaji_karyawan_sd_grid) ?>;
	fgaji_karyawan_sdgrid.lists["x_jabatan_id"].options = <?php echo JsonEncode($gaji_karyawan_sd_grid->jabatan_id->lookupOptions()) ?>;
	fgaji_karyawan_sdgrid.autoSuggests["x_jabatan_id"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
...
?>
<?php if ($gaji_karyawan_sd_grid->jp->Visible) { // jp ?>
	<?php if ($gaji_karyawan_sd_grid->SortUrl($gaji_karyawan_sd_grid->jp) == "") { ?>
		<th data-name="jp" class="<?php echo $gaji_karyawan_sd_grid->jp->headerCellClass() ?>"><div id="elh_gaji_karyawan_sd_jp" class="gaji_karyawan_sd_jp"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->jp->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jp" class="<?php echo $gaji_karyawan_sd_grid->jp->headerCellClass() ?>"><div><div id="elh_gaji_karyawan_sd_jp" class="gaji_karyawan_sd_jp">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_grid->jp->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_grid->jp->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($gaji_karyawan_sd_grid->jenjang_id->Visible) { // jenjang_id ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_grid->jabatan_id->Visible) { // jabatan_id ?>
	<?php if ($gaji_karyawan_sd_grid->SortUrl($gaji_karyawan_sd_grid->jabatan_id) == "") { ?>
		<th data-name="jabatan_id" class="<?php echo $gaji_karyawan_sd_grid->jabatan_id->headerCellClass() ?>"><div id="elh_gaji_karyawan_sd_jabatan_id" class="gaji_karyawan_sd_jabatan_id"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->jabatan_id->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="jabatan_id" class="<?php echo $gaji_karyawan_sd_grid->jabatan_id->headerCellClass() ?>"><div><div id="elh_gaji_karyawan_sd_jabatan_id" class="gaji_karyawan_sd_jabatan_id">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->jabatan_id->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_grid->jabatan_id->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_grid->jabatan_id->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_grid->kehadiran->Visible) { // kehadiran ?>
	<?php if ($gaji_karyawan_sd_grid->SortUrl($gaji_karyawan_sd_grid->kehadiran) == "") { ?>
		<th data-name="kehadiran" class="<?php echo $gaji_karyawan_sd_grid->kehadiran->headerCellClass() ?>"><div id="elh_gaji_karyawan_sd_kehadiran" class="gaji_karyawan_sd_kehadiran"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->kehadiran->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="kehadiran" class="<?php echo $gaji_karyawan_sd_grid->kehadiran->headerCellClass() ?>"><div><div id="elh_gaji_karyawan_sd_kehadiran" class="gaji_karyawan_sd_kehadiran">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->kehadiran->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_grid->kehadiran->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_grid->kehadiran->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_grid->gapok->Visible) { // gapok ?>
	<?php if ($gaji_karyawan_sd_grid->SortUrl($gaji_karyawan_sd_grid->gapok) == "") { ?>
		<th data-name="gapok" class="<?php echo $gaji_karyawan_sd_grid->gapok->headerCellClass() ?>"><div id="elh_gaji_karyawan_sd_gapok" class="gaji_karyawan_sd_gapok"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->gapok->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="gapok" class="<?php echo $gaji_karyawan_sd_grid->gapok->headerCellClass() ?>"><div><div id="elh_gaji_karyawan_sd_gapok" class="gaji_karyawan_sd_gapok">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->gapok->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_grid->gapok->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_grid->gapok->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_grid->value_reward->Visible) { // value_reward ?>
	<?php if ($gaji_karyawan_sd_grid->SortUrl($gaji_karyawan_sd_grid->value_reward) == "") { ?>
		<th data-name="value_reward" class="<?php echo $gaji_karyawan_sd_grid->value_reward->headerCellClass() ?>"><div id="elh_gaji_karyawan_sd_value_reward" class="gaji_karyawan_sd_value_reward"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->value_reward->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="value_reward" class="<?php echo $gaji_karyawan_sd_grid->value_reward->headerCellClass() ?>"><div><div id="elh_gaji_karyawan_sd_value_reward" class="gaji_karyawan_sd_value_reward">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->value_reward->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_grid->value_reward->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_grid->value_reward->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_grid->value_inval->Visible) { // value_inval ?>
	<?php if ($gaji_karyawan_sd_grid->SortUrl($gaji_karyawan_sd_grid->value_inval) == "") { ?>
		<th data-name="value_inval" class="<?php echo $gaji_karyawan_sd_grid->value_inval->headerCellClass() ?>"><div id="elh_gaji_karyawan_sd_value_inval" class="gaji_karyawan_sd_value_inval"><div class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->value_inval->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="value_inval" class="<?php echo $gaji_karyawan_sd_grid->value_inval->headerCellClass() ?>"><div><div id="elh_gaji_karyawan_sd_value_inval" class="gaji_karyawan_sd_value_inval">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_grid->value_inval->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_grid->value_inval->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_grid->value_inval->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
?>
	<?php if ($gaji_karyawan_sd_grid->jp->Visible) { // jp ?>
		<td data-name="jp" <?php echo $gaji_karyawan_sd_grid->jp->cellAttributes() ?>>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_jp" class="form-group">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_jp" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->jp->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->jp->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jp" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jp->OldValue) ?>">
<?php } ?>
...
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_jp">
<span<?php echo $gaji_karyawan_sd_grid->jp->viewAttributes() ?>><?php echo $gaji_karyawan_sd_grid->jp->getViewValue() ?></span>
</span>
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jp" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jp" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jp->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jp" name="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" id="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jp->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jp" name="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" id="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jp->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
<?php } ?>
	...
	<?php } ?>
	<?php if ($gaji_karyawan_sd_grid->jabatan_id->Visible) { // jabatan_id ?>
		<td data-name="jabatan_id" <?php echo $gaji_karyawan_sd_grid->jabatan_id->cellAttributes() ?>>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_jabatan_id" class="form-group">
<?php
$onchange = $gaji_karyawan_sd_grid->jabatan_id->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_karyawan_sd_grid->jabatan_id->EditAttrs["onchange"] = "";
?>
<span id="as_x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id">
	<input type="text" class="form-control" name="sv_x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" id="sv_x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" value="<?php echo RemoveHtml($gaji_karyawan_sd_grid->jabatan_id->EditValue) ?>" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->getPlaceHolder()) ?>" data-placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->getPlaceHolder()) ?>"<?php echo $gaji_karyawan_sd_grid->jabatan_id->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jabatan_id" data-value-separator="<?php echo $gaji_karyawan_sd_grid->jabatan_id->displayValueSeparatorAttribute() ?>" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->CurrentValue) ?>"<?php echo $onchange ?>>
<script>
loadjs.ready(["fgaji_karyawan_sdgrid"], function() {
	fgaji_karyawan_sdgrid.createAutoSuggest({"id":"x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id","forceSelect":false});
});
</script>
<?php echo $gaji_karyawan_sd_grid->jabatan_id->Lookup->getParamTag($gaji_karyawan_sd_grid, "p_x" . $gaji_karyawan_sd_grid->RowIndex . "_jabatan_id") ?>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jabatan_id" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->OldValue) ?>">
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_jabatan_id" class="form-group">
<?php
...
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_jabatan_id">
<span<?php echo $gaji_karyawan_sd_grid->jabatan_id->viewAttributes() ?>><?php echo $gaji_karyawan_sd_grid->jabatan_id->getViewValue() ?></span>
</span>
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jabatan_id" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jabatan_id" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jabatan_id" name="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" id="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jabatan_id" name="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" id="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_sd_grid->kehadiran->Visible) { // kehadiran ?>
		<td data-name="kehadiran" <?php echo $gaji_karyawan_sd_grid->kehadiran->cellAttributes() ?>>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_kehadiran" class="form-group">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->kehadiran->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->kehadiran->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->OldValue) ?>">
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_kehadiran" class="form-group">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->kehadiran->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->kehadiran->editAttributes() ?>>
...
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_kehadiran">
<span<?php echo $gaji_karyawan_sd_grid->kehadiran->viewAttributes() ?>><?php echo $gaji_karyawan_sd_grid->kehadiran->getViewValue() ?></span>
</span>
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_sd_grid->gapok->Visible) { // gapok ?>
		<td data-name="gapok" <?php echo $gaji_karyawan_sd_grid->gapok->cellAttributes() ?>>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_gapok" class="form-group">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_gapok" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->gapok->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->gapok->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_gapok" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->OldValue) ?>">
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_gapok" class="form-group">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_gapok" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->gapok->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->gapok->editAttributes() ?>>
...
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_gapok">
<span<?php echo $gaji_karyawan_sd_grid->gapok->viewAttributes() ?>><?php echo $gaji_karyawan_sd_grid->gapok->getViewValue() ?></span>
</span>
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_gapok" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_gapok" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_gapok" name="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_gapok" name="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_sd_grid->value_reward->Visible) { // value_reward ?>
		<td data-name="value_reward" <?php echo $gaji_karyawan_sd_grid->value_reward->cellAttributes() ?>>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_value_reward" class="form-group">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->value_reward->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->value_reward->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->OldValue) ?>">
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_value_reward" class="form-group">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->value_reward->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->value_reward->editAttributes() ?>>
...
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_value_reward">
<span<?php echo $gaji_karyawan_sd_grid->value_reward->viewAttributes() ?>><?php echo $gaji_karyawan_sd_grid->value_reward->getViewValue() ?></span>
</span>
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
	<?php if ($gaji_karyawan_sd_grid->value_inval->Visible) { // value_inval ?>
		<td data-name="value_inval" <?php echo $gaji_karyawan_sd_grid->value_inval->cellAttributes() ?>>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_ADD) { // Add record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_value_inval" class="form-group">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->value_inval->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->value_inval->editAttributes() ?>>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->OldValue) ?>">
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_EDIT) { // Edit record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_value_inval" class="form-group">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->value_inval->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->value_inval->editAttributes() ?>>
...
<?php } ?>
<?php if ($gaji_karyawan_sd->RowType == ROWTYPE_VIEW) { // View record ?>
<span id="el<?php echo $gaji_karyawan_sd_grid->RowCount ?>_gaji_karyawan_sd_value_inval">
<span<?php echo $gaji_karyawan_sd_grid->value_inval->viewAttributes() ?>><?php echo $gaji_karyawan_sd_grid->value_inval->getViewValue() ?></span>
</span>
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->OldValue) ?>">
<?php } else { ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="fgaji_karyawan_sdgrid$x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->FormValue) ?>">
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="fgaji_karyawan_sdgrid$o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->OldValue) ?>">
<?php } ?>
<?php } ?>
</td>
	<?php } ?>
...
?>
	<?php if ($gaji_karyawan_sd_grid->jp->Visible) { // jp ?>
		<td data-name="jp">
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<span id="el$rowindex$_gaji_karyawan_sd_jp" class="form-group gaji_karyawan_sd_jp">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_jp" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" size="30" maxlength="11" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jp->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->jp->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->jp->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gaji_karyawan_sd_jp" class="form-group gaji_karyawan_sd_jp">
<span<?php echo $gaji_karyawan_sd_grid->jp->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sd_grid->jp->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jp" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jp->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jp" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jp" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jp->OldValue) ?>">
...
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<span id="el$rowindex$_gaji_karyawan_sd_jabatan_id" class="form-group gaji_karyawan_sd_jabatan_id">
<?php
$onchange = $gaji_karyawan_sd_grid->jabatan_id->EditAttrs->prepend("onchange", "");
$onchange = ($onchange) ? ' onchange="' . JsEncode($onchange) . '"' : '';
$gaji_karyawan_sd_grid->jabatan_id->EditAttrs["onchange"] = "";
...
<?php } else { ?>
<span id="el$rowindex$_gaji_karyawan_sd_jabatan_id" class="form-group gaji_karyawan_sd_jabatan_id">
<span<?php echo $gaji_karyawan_sd_grid->jabatan_id->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sd_grid->jabatan_id->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jabatan_id" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_jabatan_id" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_jabatan_id" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->jabatan_id->OldValue) ?>">
...
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<span id="el$rowindex$_gaji_karyawan_sd_kehadiran" class="form-group gaji_karyawan_sd_kehadiran">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" size="30" maxlength="10" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->kehadiran->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->kehadiran->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gaji_karyawan_sd_kehadiran" class="form-group gaji_karyawan_sd_kehadiran">
<span<?php echo $gaji_karyawan_sd_grid->kehadiran->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sd_grid->kehadiran->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_kehadiran" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_kehadiran" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->kehadiran->OldValue) ?>">
	...
	<?php if ($gaji_karyawan_sd_grid->gapok->Visible) { // gapok ?>
		<td data-name="gapok">
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<span id="el$rowindex$_gaji_karyawan_sd_gapok" class="form-group gaji_karyawan_sd_gapok">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_gapok" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->gapok->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->gapok->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gaji_karyawan_sd_gapok" class="form-group gaji_karyawan_sd_gapok">
<span<?php echo $gaji_karyawan_sd_grid->gapok->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sd_grid->gapok->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_gapok" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_gapok" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_gapok" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->gapok->OldValue) ?>">
...
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<span id="el$rowindex$_gaji_karyawan_sd_value_reward" class="form-group gaji_karyawan_sd_value_reward">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->value_reward->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->value_reward->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gaji_karyawan_sd_value_reward" class="form-group gaji_karyawan_sd_value_reward">
<span<?php echo $gaji_karyawan_sd_grid->value_reward->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sd_grid->value_reward->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_reward" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_reward" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_reward->OldValue) ?>">
...
<?php if (!$gaji_karyawan_sd->isConfirm()) { ?>
<span id="el$rowindex$_gaji_karyawan_sd_value_inval" class="form-group gaji_karyawan_sd_value_inval">
<input type="text" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" size="30" maxlength="19" placeholder="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->getPlaceHolder()) ?>" value="<?php echo $gaji_karyawan_sd_grid->value_inval->EditValue ?>"<?php echo $gaji_karyawan_sd_grid->value_inval->editAttributes() ?>>
</span>
<?php } else { ?>
<span id="el$rowindex$_gaji_karyawan_sd_value_inval" class="form-group gaji_karyawan_sd_value_inval">
<span<?php echo $gaji_karyawan_sd_grid->value_inval->viewAttributes() ?>><input type="text" readonly class="form-control-plaintext" value="<?php echo HtmlEncode(RemoveHtml($gaji_karyawan_sd_grid->value_inval->ViewValue)) ?>"></span>
</span>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="x<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->FormValue) ?>">
<?php } ?>
<input type="hidden" data-table="gaji_karyawan_sd" data-field="x_value_inval" name="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" id="o<?php echo $gaji_karyawan_sd_grid->RowIndex ?>_value_inval" value="<?php echo HtmlEncode($gaji_karyawan_sd_grid->value_inval->OldValue) ?>">
