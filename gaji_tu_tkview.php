...
<?php } ?>
<?php if ($gaji_tu_tk_view->by->Visible) { // by ?>
	<tr id="r_by">
		<td class="<?php echo $gaji_tu_tk_view->TableLeftColumnClass ?>"><span id="elh_gaji_tu_tk_by"><?php echo $gaji_tu_tk_view->by->caption() ?></span></td>
		<td data-name="by" <?php echo $gaji_tu_tk_view->by->cellAttributes() ?>>
<span id="el_gaji_tu_tk_by">
<span<?php echo $gaji_tu_tk_view->by->viewAttributes() ?>><?php echo $gaji_tu_tk_view->by->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
