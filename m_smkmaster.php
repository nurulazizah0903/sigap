...
<table id="tbl_m_smkmaster" class="table ew-view-table ew-master-table ew-vertical">
	<tbody>
<?php if ($m_smk->createby->Visible) { // createby ?>
		<tr id="r_createby">
			<td class="<?php echo $m_smk->TableLeftColumnClass ?>"><?php echo $m_smk->createby->caption() ?></td>
			<td <?php echo $m_smk->createby->cellAttributes() ?>>
<span id="el_m_smk_createby">
<span<?php echo $m_smk->createby->viewAttributes() ?>><?php echo $m_smk->createby->getViewValue() ?></span>
</span>
</td>
		</tr>
<?php } ?>
