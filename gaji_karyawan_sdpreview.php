...
?>
<?php if ($gaji_karyawan_sd_preview->jp->Visible) { // jp ?>
	<?php if ($gaji_karyawan_sd->SortUrl($gaji_karyawan_sd_preview->jp) == "") { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->jp->headerCellClass() ?>"><?php echo $gaji_karyawan_sd_preview->jp->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->jp->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_karyawan_sd_preview->jp->Name) ?>" data-sort-order="<?php echo $gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->jp->Name && $gaji_karyawan_sd_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_preview->jp->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->jp->Name) { ?><?php if ($gaji_karyawan_sd_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($gaji_karyawan_sd_preview->jenjang_id->Visible) { // jenjang_id ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->jabatan_id->Visible) { // jabatan_id ?>
	<?php if ($gaji_karyawan_sd->SortUrl($gaji_karyawan_sd_preview->jabatan_id) == "") { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->jabatan_id->headerCellClass() ?>"><?php echo $gaji_karyawan_sd_preview->jabatan_id->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->jabatan_id->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_karyawan_sd_preview->jabatan_id->Name) ?>" data-sort-order="<?php echo $gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->jabatan_id->Name && $gaji_karyawan_sd_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_preview->jabatan_id->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->jabatan_id->Name) { ?><?php if ($gaji_karyawan_sd_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->kehadiran->Visible) { // kehadiran ?>
	<?php if ($gaji_karyawan_sd->SortUrl($gaji_karyawan_sd_preview->kehadiran) == "") { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->kehadiran->headerCellClass() ?>"><?php echo $gaji_karyawan_sd_preview->kehadiran->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->kehadiran->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_karyawan_sd_preview->kehadiran->Name) ?>" data-sort-order="<?php echo $gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->kehadiran->Name && $gaji_karyawan_sd_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_preview->kehadiran->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->kehadiran->Name) { ?><?php if ($gaji_karyawan_sd_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->gapok->Visible) { // gapok ?>
	<?php if ($gaji_karyawan_sd->SortUrl($gaji_karyawan_sd_preview->gapok) == "") { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->gapok->headerCellClass() ?>"><?php echo $gaji_karyawan_sd_preview->gapok->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->gapok->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_karyawan_sd_preview->gapok->Name) ?>" data-sort-order="<?php echo $gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->gapok->Name && $gaji_karyawan_sd_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_preview->gapok->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->gapok->Name) { ?><?php if ($gaji_karyawan_sd_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->value_reward->Visible) { // value_reward ?>
	<?php if ($gaji_karyawan_sd->SortUrl($gaji_karyawan_sd_preview->value_reward) == "") { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->value_reward->headerCellClass() ?>"><?php echo $gaji_karyawan_sd_preview->value_reward->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->value_reward->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_karyawan_sd_preview->value_reward->Name) ?>" data-sort-order="<?php echo $gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->value_reward->Name && $gaji_karyawan_sd_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_preview->value_reward->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->value_reward->Name) { ?><?php if ($gaji_karyawan_sd_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->value_inval->Visible) { // value_inval ?>
	<?php if ($gaji_karyawan_sd->SortUrl($gaji_karyawan_sd_preview->value_inval) == "") { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->value_inval->headerCellClass() ?>"><?php echo $gaji_karyawan_sd_preview->value_inval->caption() ?></th>
	<?php } else { ?>
		<th class="<?php echo $gaji_karyawan_sd_preview->value_inval->headerCellClass() ?>"><div class="ew-pointer" data-sort="<?php echo HtmlEncode($gaji_karyawan_sd_preview->value_inval->Name) ?>" data-sort-order="<?php echo $gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->value_inval->Name && $gaji_karyawan_sd_preview->SortOrder == "ASC" ? "DESC" : "ASC" ?>">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $gaji_karyawan_sd_preview->value_inval->caption() ?></span><span class="ew-table-header-sort"><?php if ($gaji_karyawan_sd_preview->SortField == $gaji_karyawan_sd_preview->value_inval->Name) { ?><?php if ($gaji_karyawan_sd_preview->SortOrder == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($gaji_karyawan_sd_preview->SortOrder == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?><?php } ?></span>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($gaji_karyawan_sd_preview->jp->Visible) { // jp ?>
		<!-- jp -->
		<td<?php echo $gaji_karyawan_sd_preview->jp->cellAttributes() ?>>
<span<?php echo $gaji_karyawan_sd_preview->jp->viewAttributes() ?>><?php echo $gaji_karyawan_sd_preview->jp->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->pegawai->Visible) { // pegawai ?>
		<!-- pegawai -->
...
<?php if ($gaji_karyawan_sd_preview->jabatan_id->Visible) { // jabatan_id ?>
		<!-- jabatan_id -->
		<td<?php echo $gaji_karyawan_sd_preview->jabatan_id->cellAttributes() ?>>
<span<?php echo $gaji_karyawan_sd_preview->jabatan_id->viewAttributes() ?>><?php echo $gaji_karyawan_sd_preview->jabatan_id->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->kehadiran->Visible) { // kehadiran ?>
		<!-- kehadiran -->
		<td<?php echo $gaji_karyawan_sd_preview->kehadiran->cellAttributes() ?>>
<span<?php echo $gaji_karyawan_sd_preview->kehadiran->viewAttributes() ?>><?php echo $gaji_karyawan_sd_preview->kehadiran->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->gapok->Visible) { // gapok ?>
		<!-- gapok -->
		<td<?php echo $gaji_karyawan_sd_preview->gapok->cellAttributes() ?>>
<span<?php echo $gaji_karyawan_sd_preview->gapok->viewAttributes() ?>><?php echo $gaji_karyawan_sd_preview->gapok->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->value_reward->Visible) { // value_reward ?>
		<!-- value_reward -->
		<td<?php echo $gaji_karyawan_sd_preview->value_reward->cellAttributes() ?>>
<span<?php echo $gaji_karyawan_sd_preview->value_reward->viewAttributes() ?>><?php echo $gaji_karyawan_sd_preview->value_reward->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->value_inval->Visible) { // value_inval ?>
		<!-- value_inval -->
		<td<?php echo $gaji_karyawan_sd_preview->value_inval->cellAttributes() ?>>
<span<?php echo $gaji_karyawan_sd_preview->value_inval->viewAttributes() ?>><?php echo $gaji_karyawan_sd_preview->value_inval->getViewValue() ?></span>
</td>
<?php } ?>
<?php if ($gaji_karyawan_sd_preview->sub_total->Visible) { // sub_total ?>
		<!-- sub_total -->
