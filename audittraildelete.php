...
<?php } ?>
<?php if ($audittrail_delete->keyvalue->Visible) { // keyvalue ?>
		<th class="<?php echo $audittrail_delete->keyvalue->headerCellClass() ?>"><span id="elh_audittrail_keyvalue" class="audittrail_keyvalue"><?php echo $audittrail_delete->keyvalue->caption() ?></span></th>
<?php } ?>
<?php if ($audittrail_delete->oldvalue->Visible) { // oldvalue ?>
		<th class="<?php echo $audittrail_delete->oldvalue->headerCellClass() ?>"><span id="elh_audittrail_oldvalue" class="audittrail_oldvalue"><?php echo $audittrail_delete->oldvalue->caption() ?></span></th>
<?php } ?>
<?php if ($audittrail_delete->newvalue->Visible) { // newvalue ?>
		<th class="<?php echo $audittrail_delete->newvalue->headerCellClass() ?>"><span id="elh_audittrail_newvalue" class="audittrail_newvalue"><?php echo $audittrail_delete->newvalue->caption() ?></span></th>
<?php } ?>
	</tr>
	</thead>
	<tbody>
...
<?php } ?>
<?php if ($audittrail_delete->keyvalue->Visible) { // keyvalue ?>
		<td <?php echo $audittrail_delete->keyvalue->cellAttributes() ?>>
<span id="el<?php echo $audittrail_delete->RowCount ?>_audittrail_keyvalue" class="audittrail_keyvalue">
<span<?php echo $audittrail_delete->keyvalue->viewAttributes() ?>><?php echo $audittrail_delete->keyvalue->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($audittrail_delete->oldvalue->Visible) { // oldvalue ?>
		<td <?php echo $audittrail_delete->oldvalue->cellAttributes() ?>>
<span id="el<?php echo $audittrail_delete->RowCount ?>_audittrail_oldvalue" class="audittrail_oldvalue">
<span<?php echo $audittrail_delete->oldvalue->viewAttributes() ?>><?php echo $audittrail_delete->oldvalue->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($audittrail_delete->newvalue->Visible) { // newvalue ?>
		<td <?php echo $audittrail_delete->newvalue->cellAttributes() ?>>
<span id="el<?php echo $audittrail_delete->RowCount ?>_audittrail_newvalue" class="audittrail_newvalue">
<span<?php echo $audittrail_delete->newvalue->viewAttributes() ?>><?php echo $audittrail_delete->newvalue->getViewValue() ?></span>
</span>
</td>
<?php } ?>
	</tr>
