...
<?php if ($m_karyawan_tk_delete->createby->Visible) { // createby ?>
		<th class="<?php echo $m_karyawan_tk_delete->createby->headerCellClass() ?>"><span id="elh_m_karyawan_tk_createby" class="m_karyawan_tk_createby"><?php echo $m_karyawan_tk_delete->createby->caption() ?></span></th>
<?php } ?>
...
<?php if ($m_karyawan_tk_delete->createby->Visible) { // createby ?>
		<td <?php echo $m_karyawan_tk_delete->createby->cellAttributes() ?>>
<span id="el<?php echo $m_karyawan_tk_delete->RowCount ?>_m_karyawan_tk_createby" class="m_karyawan_tk_createby">
<span<?php echo $m_karyawan_tk_delete->createby->viewAttributes() ?>><?php echo $m_karyawan_tk_delete->createby->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($m_karyawan_tk_delete->tahun->Visible) { // tahun ?>
