...
<?php if ($potongan_tk_list->u_by->Visible) { // u_by ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($potongan_tk_list->month->Visible) { // month ?>
	<?php if ($potongan_tk_list->SortUrl($potongan_tk_list->month) == "") { ?>
		<th data-name="month" class="<?php echo $potongan_tk_list->month->headerCellClass() ?>"><div id="elh_potongan_tk_month" class="potongan_tk_month"><div class="ew-table-header-caption"><?php echo $potongan_tk_list->month->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="month" class="<?php echo $potongan_tk_list->month->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_tk_list->SortUrl($potongan_tk_list->month) ?>', 1);"><div id="elh_potongan_tk_month" class="potongan_tk_month">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_tk_list->month->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($potongan_tk_list->month->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_tk_list->month->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($potongan_tk_list->nama->Visible) { // nama ?>
	...
	<?php } else { ?>
		<th data-name="nama" class="<?php echo $potongan_tk_list->nama->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_tk_list->SortUrl($potongan_tk_list->nama) ?>', 1);"><div id="elh_potongan_tk_nama" class="potongan_tk_nama">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_tk_list->nama->caption() ?><?php echo $Language->phrase("SrchLegend") ?></span><span class="ew-table-header-sort"><?php if ($potongan_tk_list->nama->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_tk_list->nama->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($potongan_tk_list->izinperjamvalue->Visible) { // izinperjamvalue ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($potongan_tk_list->sakit->Visible) { // sakit ?>
	<?php if ($potongan_tk_list->SortUrl($potongan_tk_list->sakit) == "") { ?>
		<th data-name="sakit" class="<?php echo $potongan_tk_list->sakit->headerCellClass() ?>"><div id="elh_potongan_tk_sakit" class="potongan_tk_sakit"><div class="ew-table-header-caption"><?php echo $potongan_tk_list->sakit->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="sakit" class="<?php echo $potongan_tk_list->sakit->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_tk_list->SortUrl($potongan_tk_list->sakit) ?>', 1);"><div id="elh_potongan_tk_sakit" class="potongan_tk_sakit">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_tk_list->sakit->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_tk_list->sakit->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_tk_list->sakit->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($potongan_tk_list->value_sakit->Visible) { // value_sakit ?>
	<?php if ($potongan_tk_list->SortUrl($potongan_tk_list->value_sakit) == "") { ?>
		<th data-name="value_sakit" class="<?php echo $potongan_tk_list->value_sakit->headerCellClass() ?>"><div id="elh_potongan_tk_value_sakit" class="potongan_tk_value_sakit"><div class="ew-table-header-caption"><?php echo $potongan_tk_list->value_sakit->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="value_sakit" class="<?php echo $potongan_tk_list->value_sakit->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_tk_list->SortUrl($potongan_tk_list->value_sakit) ?>', 1);"><div id="elh_potongan_tk_value_sakit" class="potongan_tk_value_sakit">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_tk_list->value_sakit->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_tk_list->value_sakit->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_tk_list->value_sakit->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<?php if ($potongan_tk_list->value_pulcep->Visible) { // value_pulcep ?>
	...
	<?php } ?>
<?php } ?>
<?php if ($potongan_tk_list->tidakhadir->Visible) { // tidakhadir ?>
	<?php if ($potongan_tk_list->SortUrl($potongan_tk_list->tidakhadir) == "") { ?>
		<th data-name="tidakhadir" class="<?php echo $potongan_tk_list->tidakhadir->headerCellClass() ?>"><div id="elh_potongan_tk_tidakhadir" class="potongan_tk_tidakhadir"><div class="ew-table-header-caption"><?php echo $potongan_tk_list->tidakhadir->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="tidakhadir" class="<?php echo $potongan_tk_list->tidakhadir->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_tk_list->SortUrl($potongan_tk_list->tidakhadir) ?>', 1);"><div id="elh_potongan_tk_tidakhadir" class="potongan_tk_tidakhadir">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_tk_list->tidakhadir->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_tk_list->tidakhadir->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_tk_list->tidakhadir->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
<?php if ($potongan_tk_list->value_tidakhadir->Visible) { // value_tidakhadir ?>
	<?php if ($potongan_tk_list->SortUrl($potongan_tk_list->value_tidakhadir) == "") { ?>
		<th data-name="value_tidakhadir" class="<?php echo $potongan_tk_list->value_tidakhadir->headerCellClass() ?>"><div id="elh_potongan_tk_value_tidakhadir" class="potongan_tk_value_tidakhadir"><div class="ew-table-header-caption"><?php echo $potongan_tk_list->value_tidakhadir->caption() ?></div></div></th>
	<?php } else { ?>
		<th data-name="value_tidakhadir" class="<?php echo $potongan_tk_list->value_tidakhadir->headerCellClass() ?>"><div class="ew-pointer" onclick="ew.sort(event, '<?php echo $potongan_tk_list->SortUrl($potongan_tk_list->value_tidakhadir) ?>', 1);"><div id="elh_potongan_tk_value_tidakhadir" class="potongan_tk_value_tidakhadir">
			<div class="ew-table-header-btn"><span class="ew-table-header-caption"><?php echo $potongan_tk_list->value_tidakhadir->caption() ?></span><span class="ew-table-header-sort"><?php if ($potongan_tk_list->value_tidakhadir->getSort() == "ASC") { ?><i class="fas fa-sort-up"></i><?php } elseif ($potongan_tk_list->value_tidakhadir->getSort() == "DESC") { ?><i class="fas fa-sort-down"></i><?php } ?></span></div>
		</div></div></th>
	<?php } ?>
<?php } ?>
...
<span<?php echo $potongan_tk_list->u_by->viewAttributes() ?>><?php echo $potongan_tk_list->u_by->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($potongan_tk_list->month->Visible) { // month ?>
		<td data-name="month" <?php echo $potongan_tk_list->month->cellAttributes() ?>>
<span id="el<?php echo $potongan_tk_list->RowCount ?>_potongan_tk_month">
<span<?php echo $potongan_tk_list->month->viewAttributes() ?>><?php echo $potongan_tk_list->month->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_tk_list->nama->Visible) { // nama ?>
...
<span<?php echo $potongan_tk_list->izinperjamvalue->viewAttributes() ?>><?php echo $potongan_tk_list->izinperjamvalue->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($potongan_tk_list->sakit->Visible) { // sakit ?>
		<td data-name="sakit" <?php echo $potongan_tk_list->sakit->cellAttributes() ?>>
<span id="el<?php echo $potongan_tk_list->RowCount ?>_potongan_tk_sakit">
<span<?php echo $potongan_tk_list->sakit->viewAttributes() ?>><?php echo $potongan_tk_list->sakit->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_tk_list->value_sakit->Visible) { // value_sakit ?>
		<td data-name="value_sakit" <?php echo $potongan_tk_list->value_sakit->cellAttributes() ?>>
<span id="el<?php echo $potongan_tk_list->RowCount ?>_potongan_tk_value_sakit">
<span<?php echo $potongan_tk_list->value_sakit->viewAttributes() ?>><?php echo $potongan_tk_list->value_sakit->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_tk_list->sakitperjam->Visible) { // sakitperjam ?>
...
<span<?php echo $potongan_tk_list->value_pulcep->viewAttributes() ?>><?php echo $potongan_tk_list->value_pulcep->getViewValue() ?></span>
	...
	<?php } ?>
	<?php if ($potongan_tk_list->tidakhadir->Visible) { // tidakhadir ?>
		<td data-name="tidakhadir" <?php echo $potongan_tk_list->tidakhadir->cellAttributes() ?>>
<span id="el<?php echo $potongan_tk_list->RowCount ?>_potongan_tk_tidakhadir">
<span<?php echo $potongan_tk_list->tidakhadir->viewAttributes() ?>><?php echo $potongan_tk_list->tidakhadir->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_tk_list->value_tidakhadir->Visible) { // value_tidakhadir ?>
		<td data-name="value_tidakhadir" <?php echo $potongan_tk_list->value_tidakhadir->cellAttributes() ?>>
<span id="el<?php echo $potongan_tk_list->RowCount ?>_potongan_tk_value_tidakhadir">
<span<?php echo $potongan_tk_list->value_tidakhadir->viewAttributes() ?>><?php echo $potongan_tk_list->value_tidakhadir->getViewValue() ?></span>
</span>
</td>
	<?php } ?>
	<?php if ($potongan_tk_list->tidakhadirjam->Visible) { // tidakhadirjam ?>
