...
<?php } ?>
<?php if ($potongan_sd_delete->month->Visible) { // month ?>
		<th class="<?php echo $potongan_sd_delete->month->headerCellClass() ?>"><span id="elh_potongan_sd_month" class="potongan_sd_month"><?php echo $potongan_sd_delete->month->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($potongan_sd_delete->sakit->Visible) { // sakit ?>
		<th class="<?php echo $potongan_sd_delete->sakit->headerCellClass() ?>"><span id="elh_potongan_sd_sakit" class="potongan_sd_sakit"><?php echo $potongan_sd_delete->sakit->caption() ?></span></th>
<?php } ?>
<?php if ($potongan_sd_delete->value_sakit->Visible) { // value_sakit ?>
		<th class="<?php echo $potongan_sd_delete->value_sakit->headerCellClass() ?>"><span id="elh_potongan_sd_value_sakit" class="potongan_sd_value_sakit"><?php echo $potongan_sd_delete->value_sakit->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($potongan_sd_delete->tidakhadir->Visible) { // tidakhadir ?>
		<th class="<?php echo $potongan_sd_delete->tidakhadir->headerCellClass() ?>"><span id="elh_potongan_sd_tidakhadir" class="potongan_sd_tidakhadir"><?php echo $potongan_sd_delete->tidakhadir->caption() ?></span></th>
<?php } ?>
<?php if ($potongan_sd_delete->value_tidakhadir->Visible) { // value_tidakhadir ?>
		<th class="<?php echo $potongan_sd_delete->value_tidakhadir->headerCellClass() ?>"><span id="elh_potongan_sd_value_tidakhadir" class="potongan_sd_value_tidakhadir"><?php echo $potongan_sd_delete->value_tidakhadir->caption() ?></span></th>
<?php } ?>
...
<?php } ?>
<?php if ($potongan_sd_delete->month->Visible) { // month ?>
		<td <?php echo $potongan_sd_delete->month->cellAttributes() ?>>
<span id="el<?php echo $potongan_sd_delete->RowCount ?>_potongan_sd_month" class="potongan_sd_month">
<span<?php echo $potongan_sd_delete->month->viewAttributes() ?>><?php echo $potongan_sd_delete->month->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_sd_delete->nama->Visible) { // nama ?>
...
<?php } ?>
<?php if ($potongan_sd_delete->sakit->Visible) { // sakit ?>
		<td <?php echo $potongan_sd_delete->sakit->cellAttributes() ?>>
<span id="el<?php echo $potongan_sd_delete->RowCount ?>_potongan_sd_sakit" class="potongan_sd_sakit">
<span<?php echo $potongan_sd_delete->sakit->viewAttributes() ?>><?php echo $potongan_sd_delete->sakit->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_sd_delete->value_sakit->Visible) { // value_sakit ?>
		<td <?php echo $potongan_sd_delete->value_sakit->cellAttributes() ?>>
<span id="el<?php echo $potongan_sd_delete->RowCount ?>_potongan_sd_value_sakit" class="potongan_sd_value_sakit">
<span<?php echo $potongan_sd_delete->value_sakit->viewAttributes() ?>><?php echo $potongan_sd_delete->value_sakit->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_sd_delete->sakitperjam->Visible) { // sakitperjam ?>
...
<?php } ?>
<?php if ($potongan_sd_delete->tidakhadir->Visible) { // tidakhadir ?>
		<td <?php echo $potongan_sd_delete->tidakhadir->cellAttributes() ?>>
<span id="el<?php echo $potongan_sd_delete->RowCount ?>_potongan_sd_tidakhadir" class="potongan_sd_tidakhadir">
<span<?php echo $potongan_sd_delete->tidakhadir->viewAttributes() ?>><?php echo $potongan_sd_delete->tidakhadir->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_sd_delete->value_tidakhadir->Visible) { // value_tidakhadir ?>
		<td <?php echo $potongan_sd_delete->value_tidakhadir->cellAttributes() ?>>
<span id="el<?php echo $potongan_sd_delete->RowCount ?>_potongan_sd_value_tidakhadir" class="potongan_sd_value_tidakhadir">
<span<?php echo $potongan_sd_delete->value_tidakhadir->viewAttributes() ?>><?php echo $potongan_sd_delete->value_tidakhadir->getViewValue() ?></span>
</span>
</td>
<?php } ?>
<?php if ($potongan_sd_delete->tidakhadirjam->Visible) { // tidakhadirjam ?>
