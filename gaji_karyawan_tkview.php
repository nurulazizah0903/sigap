...
<?php } ?>
<?php if ($gaji_karyawan_tk_view->datetime->Visible) { // datetime ?>
	<tr id="r_datetime">
		<td class="<?php echo $gaji_karyawan_tk_view->TableLeftColumnClass ?>"><span id="elh_gaji_karyawan_tk_datetime"><?php echo $gaji_karyawan_tk_view->datetime->caption() ?></span></td>
		<td data-name="datetime" <?php echo $gaji_karyawan_tk_view->datetime->cellAttributes() ?>>
<span id="el_gaji_karyawan_tk_datetime">
<span<?php echo $gaji_karyawan_tk_view->datetime->viewAttributes() ?>><?php echo $gaji_karyawan_tk_view->datetime->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gaji_karyawan_tk_view->by->Visible) { // by ?>
	<tr id="r_by">
		<td class="<?php echo $gaji_karyawan_tk_view->TableLeftColumnClass ?>"><span id="elh_gaji_karyawan_tk_by"><?php echo $gaji_karyawan_tk_view->by->caption() ?></span></td>
		<td data-name="by" <?php echo $gaji_karyawan_tk_view->by->cellAttributes() ?>>
<span id="el_gaji_karyawan_tk_by">
<span<?php echo $gaji_karyawan_tk_view->by->viewAttributes() ?>><?php echo $gaji_karyawan_tk_view->by->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
<?php if ($gaji_karyawan_tk_view->month->Visible) { // month ?>
	<tr id="r_month">
		<td class="<?php echo $gaji_karyawan_tk_view->TableLeftColumnClass ?>"><span id="elh_gaji_karyawan_tk_month"><?php echo $gaji_karyawan_tk_view->month->caption() ?></span></td>
		<td data-name="month" <?php echo $gaji_karyawan_tk_view->month->cellAttributes() ?>>
<span id="el_gaji_karyawan_tk_month">
<span<?php echo $gaji_karyawan_tk_view->month->viewAttributes() ?>><?php echo $gaji_karyawan_tk_view->month->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
...
<?php } ?>
<?php if ($gaji_karyawan_tk_view->jp->Visible) { // jp ?>
	<tr id="r_jp">
		<td class="<?php echo $gaji_karyawan_tk_view->TableLeftColumnClass ?>"><span id="elh_gaji_karyawan_tk_jp"><?php echo $gaji_karyawan_tk_view->jp->caption() ?></span></td>
		<td data-name="jp" <?php echo $gaji_karyawan_tk_view->jp->cellAttributes() ?>>
<span id="el_gaji_karyawan_tk_jp">
<span<?php echo $gaji_karyawan_tk_view->jp->viewAttributes() ?>><?php echo $gaji_karyawan_tk_view->jp->getViewValue() ?></span>
</span>
</td>
	</tr>
<?php } ?>
